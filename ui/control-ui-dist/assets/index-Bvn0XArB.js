const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./agents-CLsdAw43.js","./format-DeRVtGzv.js","./lit-BZwq2xLD.js","./channel-config-extras-ClZgd1ad.js","./skills-shared-DMlqIU2G.js","./activity-feed-BaoReQDN.js","./graph-DTRnS38Y.js","./connections-n_12KK8F.js","./channels-DrRZofew.js","./cron-B5UNOAvC.js","./debug-Dy2-V_uL.js","./instances-AQtzXgL_.js","./logs-Cqf1DrUQ.js","./nodes-DoWLg7bI.js","./sessions-BETn6DGH.js","./skills-DVgscwN4.js"])))=>i.map(i=>d[i]);
    ...
    >
      ...
      <div class="agent-chat__input">
        ...
        <textarea
          ...
          @keydown=${n=>{if(Y.slashMenuOpen&&Y.slashMenuMode===`args`&&Y.slashMenuArgItems.length>0){let t=Y.slashMenuArgItems.length;switch(n.key){case`ArrowDown`:n.preventDefault(),Y.slashMenuIndex=(Y.slashMenuIndex+1)%t,g();return;case`ArrowUp`:n.preventDefault(),Y.slashMenuIndex=(Y.slashMenuIndex-1+t)%t,g();return;case`Tab`:n.preventDefault(),vp(Y.slashMenuArgItems[Y.slashMenuIndex],e,g,!1);return;case`Enter`:n.preventDefault(),vp(Y.slashMenuArgItems[Y.slashMenuIndex],e,g,!0);return;case`Escape`:n.preventDefault(),Y.slashMenuOpen=!1,mp(),g();return}}if(Y.slashMenuOpen&&Y.slashMenuItems.length>0){let t=Y.slashMenuItems.length;switch(n.key){case`ArrowDown`:n.preventDefault(),Y.slashMenuIndex=(Y.slashMenuIndex+1)%t,g();return;case`ArrowUp`:n.preventDefault(),Y.slashMenuIndex=(Y.slashMenuIndex-1+t)%t,g();return;case`Tab`:n.preventDefault(),_p(Y.slashMenuItems[Y.slashMenuIndex],e,g);return;case`Enter`:n.preventDefault(),gp(Y.slashMenuItems[Y.slashMenuIndex],e,g);return;case`Escape`:n.preventDefault(),Y.slashMenuOpen=!1,mp(),g();return}}if(!e.draft.trim()){if(n.key===`ArrowUp`){let t=f.up();t!==null&&(n.preventDefault(),e.onDraftChange(t));return}if(n.key===`ArrowDown`){let t=f.down();n.preventDefault(),e.onDraftChange(t??``);return}}if((n.metaKey||n.ctrlKey)&&!n.shiftKey&&n.key===`f`){n.preventDefault(),Y.searchOpen=!Y.searchOpen,Y.searchOpen||(Y.searchQuery=``),g();return}if(n.key===`Enter`&&!n.shiftKey){if(n.isComposing||n.keyCode===229||!e.connected)return;n.preventDefault(),t&&(e.draft.trim()&&f.push(e.draft),e.onSend())}}}
...
//# sourceMappingURL=index-Bvn0XArB.js.map