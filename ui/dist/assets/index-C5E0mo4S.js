...
`):``}function Ho(e,t){let n=Uo(e,t);if(!n)return;let r=new Blob([n],{type:`text/markdown`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`chat-${t}-${Date.now()}.md`,a.click(),URL.revokeObjectURL(i)}function Uo(e,t){let n=Array.isArray(e)?e:[];if(n.length===0)return null;let r=[`# Chat with ${t}`,``];for(let e of n){let n=e,i=n.role===`user`?`You`:n.role===`assistant`?t:`Tool`,a=Lo(e)??``,o=typeof n.timestamp==`number`?new Date(n.timestamp).toISOString():``;r.push(`## ${i}${o?` (${o})`:``}`,``,a,``)}return r.join(`
`)}var Wo=class extends ao{constructor(e){if(super(e),this.it=i,e.type!==ro.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===i||e==null)return this._t=void 0,this.it=e;if(e===o)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};Wo.directiveName=`unsafeHTML`,Wo.resultType=1;var Go=io(Wo),W={messageSquare:n`
  ...
  `},{entries:Ko,setPrototypeOf:qo,isFrozen:Jo,getPrototypeOf:Yo,getOwnPropertyDescriptor:Xo}=Object,{freeze:Zo,seal:Qo,create:$o}=Object,{apply:es,construct:ts}=typeof Reflect<`u`&&Reflect;Zo||=function(e){return e},Qo||=function(e){return e},es||=function(e,t){var n=[...arguments].slice(2);return e.apply(t,n)},ts||=function(e){return new e(...[...arguments].slice(1))};var ns=gs(Array.prototype.forEach),rs=gs(Array.prototype.lastIndexOf),is=gs(Array.prototype.pop),as=gs(Array.prototype.push),os=gs(Array.prototype.splice),ss=gs(String.prototype.toLowerCase),cs=gs(String.prototype.toString),ls=gs(String.prototype.match),us=gs(String.prototype.replace),ds=gs(String.prototype.indexOf),fs=gs(String.prototype.trim),ps=gs(Object.prototype.hasOwnProperty),ms=gs(RegExp.prototype.test),hs=_s(TypeError);function gs(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);var n=[...arguments].slice(1);return es(e,t,n)}}function _s(e){return function(){return ts(e,[...arguments])}}function G(e,t){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:ss;qo&&qo(e,null);let r=t.length;for(;r--;){let i=t[r];if(typeof i==`string`){let e=n(i);e!==i&&(Jo(t)||(t[r]=e),i=e)}e[i]=!0}return e}function vs(e){for(let t=0;t<e.length;t++)ps(e,t)||(e[t]=null);return e}function ys(e){let t=$o(null);for(let[n,r]of Ko(e))ps(e,n)&&(Array.isArray(r)?t[n]=vs(r):r&&typeof r==`object`&&r.constructor===Object?t[n]=ys(r):t[n]=r);return t}function bs(e,t){for(;e!==null;){let n=Xo(e,t);if(n){if(n.get)return gs(n.get);if(typeof n.value==`function`)return gs(n.value)}e=Yo(e)}function n(){return null}return n}var xs=Zo(`a.abbr.acronym.address.area.article.aside.audio.b.bdi.bdo.big.blink.blockquote.body.br.button.canvas.caption.center.cite.code.col.colgroup.content.data.datalist.dd.decorator.del.details.dfn.dialog.dir.div.dl.dt.element.em.fieldset.figcaption.figure.font.footer.form.h1.h2.h3.h4.h5.h6.head.header.hgroup.hr.html.i.img.input.ins.kbd.label.legend.li.main.map.mark.marquee.menu.menuitem.meter.nav.nobr.ol.optgroup.option.output.p.picture.pre.progress.q.rp.rt.ruby.s.samp.search.section.select.shadow.slot.small.source.spacer.span.strike.strong.style.sub.summary.sup.table.tbody.td.template.textarea.tfoot.th.thead.time.tr.track.tt.u.ul.var.video.wbr`.split(`.`)),Ss=Zo(`svg.a.altglyph.altglyphdef.altglyphitem.animatecolor.animatemotion.animatetransform.circle.clippath.defs.desc.ellipse.enterkeyhint.exportparts.filter.font.g.glyph.glyphref.hkern.image.inputmode.line.lineargradient.marker.mask.metadata.mpath.part.path.pattern.polygon.polyline.radialgradient.rect.stop.style.switch.symbol.text.textpath.title.tref.tspan.view.vkern`.split(`.`)),Cs=Zo([`feBlend`,`feColorMatrix`,`feComponentTransfer`,`feComposite`,`feConvolveMatrix`,`feDiffuseLighting`,`feDisplacementMap`,`feDistantLight`,`feDropShadow`,`feFlood`,`feFuncA`,`feFuncB`,`feFuncG`,`feFuncR`,`feGaussianBlur`,`feImage`,`feMerge`,`feMergeNode`,`feMorphology`,`feOffset`,`fePointLight`,`feSpecularLighting`,`feSpotLight`,`feTile`,`feTurbulence`]),ws=Zo([`animate`,`color-profile`,`cursor`,`discard`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`foreignobject`,`hatch`,`hatchpath`,`mesh`,`meshgradient`,`meshpatch`,`meshrow`,`missing-glyph`,`script`,`set`,`solidcolor`,`unknown`,`use`]),Ts=Zo(`math.menclose.merror.mfenced.mfrac.mglyph.mi.mlabeledtr.mmultiscripts.mn.mo.mover.mpadded.mphantom.mroot.mrow.ms.mspace.msqrt.mstyle.msub.msup.msubsup.mtable.mtd.mtext.mtr.munder.munderover.mprescripts`.split(`.`)),Es=Zo([`maction`,`maligngroup`,`malignmark`,`mlongdiv`,`mscarries`,`mscarry`,`msgroup`,`mstack`,`msline`,`msrow`,`semantics`,`annotation`,`annotation-xml`,`mprescripts`,`none`]),Ds=Zo([`#text`]),Os=Zo(`accept.action.align.alt.autocapitalize.autocomplete.autopictureinpicture.autoplay.background.bgcolor.border.capture.cellpadding.cellspacing.checked.cite.class.clear.color.cols.colspan.controls.controlslist.coords.crossorigin.datetime.decoding.default.dir.disabled.disablepictureinpicture.disableremoteplayback.download.draggable.enctype.enterkeyhint.exportparts.face.for.headers.height.hidden.high.href.hreflang.id.inert.inputmode.integrity.ismap.kind.label.lang.list.loading.loop.low.max.maxlength.media.method.min.minlength.multiple.muted.name.nonce.noshade.novalidate.nowrap.open.optimum.part.pattern.placeholder.playsinline.popover.popovertarget.popovertargetaction.poster.preload.pubdate.radiogroup.readonly.rel.required.rev.reversed.role.rows.rowspan.spellcheck.scope.selected.shape.size.sizes.slot.span.srclang.start.src.srcset.step.style.summary.tabindex.title.translate.type.usemap.valign.value.width.wrap.xmlns.slot`.split(`.`)),ks=Zo(`accent-height.accumulate.additive.alignment-baseline.amplitude.ascent.attributename.attributetype.azimuth.basefrequency.baseline-shift.begin.bias.by.class.clip.clippathunits.clip-path.clip-rule.color.color-interpolation.color-interpolation-filters.color-profile.color-rendering.cx.cy.d.dx.dy.diffuseconstant.direction.display.divisor.dur.edgemode.elevation.end.exponent.fill.fill-opacity.fill-rule.filter.filterunits.flood-color.flood-opacity.font-family.font-size.font-size-adjust.font-stretch.font-style.font-variant.font-weight.fx.fy.g1.g2.glyph-name.glyphref.gradientunits.gradienttransform.height.href.id.image-rendering.in.in2.intercept.k.k1.k2.k3.k4.kerning.keypoints.keysplines.keytimes.lang.lengthadjust.letter-spacing.kernelmatrix.kernelunitlength.lighting-color.local.marker-end.marker-mid.marker-start.markerheight.markerunits.markerwidth.maskcontentunits.maskunits.max.mask.mask-type.media.method.mode.min.name.numoctaves.offset.operator.opacity.order.orient.orientation.origin.overflow.paint-order.path.pathlength.patterncontentunits.patterntransform.patternunits.points.preservealpha.preserveaspectratio.primitiveunits.r.rx.ry.radius.refx.refy.repeatcount.repeatdur.restart.result.rotate.scale.seed.shape-rendering.slope.specularconstant.specularexponent.spreadmethod.startoffset.stddeviation.stitchtiles.stop-color.stop-opacity.stroke-dasharray.stroke-dashoffset.stroke-linecap.stroke-linejoin.stroke-miterlimit.stroke-opacity.stroke.stroke-width.style.surfacescale.systemlanguage.tabindex.tablevalues.targetx.targety.transform.transform-origin.text-anchor.text-decoration.text-rendering.textlength.type.u1.u2.unicode.values.viewbox.visibility.version.vert-adv-y.vert-origin-x.vert-origin-y.width.word-spacing.wrap.writing-mode.xchannelselector.ychannelselector.x.x1.x2.xmlns.y.y1.y2.z.zoomandpan`.split(`.`)),As=Zo(`accent.accentunder.align.bevelled.close.columnsalign.columnlines.columnspan.denomalign.depth.dir.display.displaystyle.encoding.fence.frame.height.href.id.largeop.length.linethickness.lspace.lquote.mathbackground.mathcolor.mathsize.mathvariant.maxsize.minsize.movablelimits.notation.numalign.open.rowalign.rowlines.rowspacing.rowspan.rspace.rquote.scriptlevel.scriptminsize.scriptsizemultiplier.selection.separator.separators.stretchy.subscriptshift.supscriptshift.symmetric.voffset.width.xmlns`.split(`.`)),js=Zo([`xlink:href`,`xml:id`,`xlink:title`,`xml:space`,`xmlns:xlink`]),Ms=Qo(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Ns=Qo(/<%[\w\W]*|[\w\W]*%>/gm),Ps=Qo(/\$\{[\w\W]*/gm),Fs=Qo(/^data-[\-\w.\u00B7-\uFFFF]+$/),Is=Qo(/^aria-[\-\w]+$/),Ls=Qo(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Rs=Qo(/^(?:\w+script|data):/i),zs=Qo(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Bs=Qo(/^html$/i),Vs=Qo(/^[a-z][.\w]*(-[.\w]+)+$/i),Hs=Object.freeze({__proto__:null,ARIA_ATTR:Is,ATTR_WHITESPACE:zs,CUSTOM_ELEMENT:Vs,DATA_ATTR:Fs,DOCTYPE_NAME:Bs,ERB_EXPR:Ns,IS_ALLOWED_URI:Ls,IS_SCRIPT_OR_DATA:Rs,MUSTACHE_EXPR:Ms,TMPLIT_EXPR:Ps}),Us={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},Ws=function(){return typeof window>`u`?null:window},Gs=function(e,t){if(typeof e!=`object`||typeof e.createPolicy!=`function`)return null;let n=null,r=`data-tt-policy-suffix`;t&&t.hasAttribute(r)&&(n=t.getAttribute(r));let i=`dompurify`+(n?`#`+n:``);try{return e.createPolicy(i,{createHTML(e){return e},createScriptURL(e){return e}})}catch{return console.warn(`TrustedTypes policy `+i+` could not be created.`),null}},Ks=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function qs(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Ws(),t=e=>qs(e);if(t.version=`3.3.3`,t.removed=[],!e||!e.document||e.document.nodeType!==Us.document||!e.Element)return t.isSupported=!1,t;let{document:n}=e,r=n,i=r.currentScript,{DocumentFragment:a,HTMLTemplateElement:o,Node:s,Element:c,NodeFilter:l,NamedNodeMap:u=e.NamedNodeMap||e.MozNamedAttrMap,HTMLFormElement:d,DOMParser:f,trustedTypes:p}=e,m=c.prototype,h=bs(m,`cloneNode`),g=bs(m,`remove`),_=bs(m,`nextSibling`),v=bs(m,`childNodes`),y=bs(m,`parentNode`);if(typeof o==`function`){let e=n.createElement(`template`);e.content&&e.content.ownerDocument&&(n=e.content.ownerDocument)}let b,x=``,{implementation:S,createNodeIterator:C,createDocumentFragment:w,getElementsByTagName:T}=n,{importNode:E}=r,D=Ks();t.isSupported=typeof Ko==`function`&&typeof y==`function`&&S&&S.createHTMLDocument!==void 0;let{MUSTACHE_EXPR:ee,ERB_EXPR:te,TMPLIT_EXPR:O,DATA_ATTR:k,ARIA_ATTR:A,IS_SCRIPT_OR_DATA:ne,ATTR_WHITESPACE:j,CUSTOM_ELEMENT:re}=Hs,{IS_ALLOWED_URI:ie}=Hs,M=null,ae=G({},[...xs,...Ss,...Cs,...Ts,...Ds]),N=null,P=G({},[...Os,...ks,...As,...js]),F=Object.seal($o(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),I=null,oe=null,L=Object.seal($o(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),se=!0,R=!0,ce=!1,le=!0,ue=!1,de=!0,fe=!1,pe=!1,me=!1,he=!1,ge=!1,_e=!1,ve=!0,ye=!1,be=!0,xe=!1,Se={},Ce=null,we=G({},[`annotation-xml`,`audio`,`colgroup`,`desc`,`foreignobject`,`head`,`iframe`,`math`,`mi`,`mn`,`mo`,`ms`,`mtext`,`noembed`,`noframes`,`noscript`,`plaintext`,`script`,`style`,`svg`,`template`,`thead`,`title`,`video`,`xmp`]),Te=null,Ee=G({},[`audio`,`video`,`img`,`source`,`image`,`track`]),De=null,Oe=G({},[`alt`,`class`,`for`,`id`,`label`,`name`,`pattern`,`placeholder`,`role`,`summary`,`title`,`value`,`style`,`xmlns`]),ke=`http://www.w3.org/1998/Math/MathML`,Ae=`http://www.w3.org/2000/svg`,z=`http://www.w3.org/1999/xhtml`,je=z,Me=!1,Ne=null,Pe=G({},[ke,Ae,z],cs),Fe=G({},[`mi`,`mo`,`mn`,`ms`,`mtext`]),Ie=G({},[`annotation-xml`]),Le=G({},[`title`,`style`,`font`,`a`,`script`]),Re=null,B=[`application/xhtml+xml`,`text/html`],V=null,ze=null,Be=n.createElement(`form`),Ve=function(e){return e instanceof RegExp||e instanceof Function},He=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(ze&&ze===e)){if((!e||typeof e!=`object`)&&(e={}),e=ys(e),Re=B.indexOf(e.PARSER_MEDIA_TYPE)===-1?`text/html`:e.PARSER_MEDIA_TYPE,V=Re===`application/xhtml+xml`?cs:ss,M=ps(e,`ALLOWED_TAGS`)?G({},e.ALLOWED_TAGS,V):ae,N=ps(e,`ALLOWED_ATTR`)?G({},e.ALLOWED_ATTR,V):P,Ne=ps(e,`ALLOWED_NAMESPACES`)?G({},e.ALLOWED_NAMESPACES,cs):Pe,De=ps(e,`ADD_URI_SAFE_ATTR`)?G(ys(Oe),e.ADD_URI_SAFE_ATTR,V):Oe,Te=ps(e,`ADD_DATA_URI_TAGS`)?G(ys(Ee),e.ADD_DATA_URI_TAGS,V):Ee,Ce=ps(e,`FORBID_CONTENTS`)?G({},e.FORBID_CONTENTS,V):we,I=ps(e,`FORBID_TAGS`)?G({},e.FORBID_TAGS,V):ys({}),oe=ps(e,`FORBID_ATTR`)?G({},e.FORBID_ATTR,V):ys({}),Se=ps(e,`USE_PROFILES`)?e.USE_PROFILES:!1,se=e.ALLOW_ARIA_ATTR!==!1,R=e.ALLOW_DATA_ATTR!==!1,ce=e.ALLOW_UNKNOWN_PROTOCOLS||!1,le=e.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ue=e.SAFE_FOR_TEMPLATES||!1,de=e.SAFE_FOR_XML!==!1,fe=e.WHOLE_DOCUMENT||!1,he=e.RETURN_DOM||!1,ge=e.RETURN_DOM_FRAGMENT||!1,_e=e.RETURN_TRUSTED_TYPE||!1,me=e.FORCE_BODY||!1,ve=e.SANITIZE_DOM!==!1,ye=e.SANITIZE_NAMED_PROPS||!1,be=e.KEEP_CONTENT!==!1,xe=e.IN_PLACE||!1,ie=e.ALLOWED_URI_REGEXP||Ls,je=e.NAMESPACE||z,Fe=e.MATHML_TEXT_INTEGRATION_POINTS||Fe,Ie=e.HTML_INTEGRATION_POINTS||Ie,F=e.CUSTOM_ELEMENT_HANDLING||{},e.CUSTOM_ELEMENT_HANDLING&&Ve(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(F.tagNameCheck=e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),e.CUSTOM_ELEMENT_HANDLING&&Ve(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(F.attributeNameCheck=e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),e.CUSTOM_ELEMENT_HANDLING&&typeof e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements==`boolean`&&(F.allowCustomizedBuiltInElements=e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),ue&&(R=!1),ge&&(he=!0),Se&&(M=G({},Ds),N=$o(null),Se.html===!0&&(G(M,xs),G(N,Os)),Se.svg===!0&&(G(M,Ss),G(N,ks),G(N,js)),Se.svgFilters===!0&&(G(M,Cs),G(N,ks),G(N,js)),Se.mathMl===!0&&(G(M,Ts),G(N,As),G(N,js))),ps(e,`ADD_TAGS`)||(L.tagCheck=null),ps(e,`ADD_ATTR`)||(L.attributeCheck=null),e.ADD_TAGS&&(typeof e.ADD_TAGS==`function`?L.tagCheck=e.ADD_TAGS:(M===ae&&(M=ys(M)),G(M,e.ADD_TAGS,V))),e.ADD_ATTR&&(typeof e.ADD_ATTR==`function`?L.attributeCheck=e.ADD_ATTR:(N===P&&(N=ys(N)),G(N,e.ADD_ATTR,V))),e.ADD_URI_SAFE_ATTR&&G(De,e.ADD_URI_SAFE_ATTR,V),e.FORBID_CONTENTS&&(Ce===we&&(Ce=ys(Ce)),G(Ce,e.FORBID_CONTENTS,V)),e.ADD_FORBID_CONTENTS&&(Ce===we&&(Ce=ys(Ce)),G(Ce,e.ADD_FORBID_CONTENTS,V)),be&&(M[`#text`]=!0),fe&&G(M,[`html`,`head`,`body`]),M.table&&(G(M,[`tbody`]),delete I.tbody),e.TRUSTED_TYPES_POLICY){if(typeof e.TRUSTED_TYPES_POLICY.createHTML!=`function`)throw hs(`TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.`);if(typeof e.TRUSTED_TYPES_POLICY.createScriptURL!=`function`)throw hs(`TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.`);b=e.TRUSTED_TYPES_POLICY,x=b.createHTML(``)}else b===void 0&&(b=Gs(p,i)),b!==null&&typeof x==`string`&&(x=b.createHTML(``));Zo&&Zo(e),ze=e}},Ue=G({},[...Ss,...Cs,...ws]),We=G({},[...Ts,...Es]),Ge=function(e){let t=y(e);(!t||!t.tagName)&&(t={namespaceURI:je,tagName:`template`});let n=ss(e.tagName),r=ss(t.tagName);return Ne[e.namespaceURI]?e.namespaceURI===Ae?t.namespaceURI===z?n===`svg`:t.namespaceURI===ke?n===`svg`&&(r===`annotation-xml`||Fe[r]):!!Ue[n]:e.namespaceURI===ke?t.namespaceURI===z?n===`math`:t.namespaceURI===Ae?n===`math`&&Ie[r]:!!We[n]:e.namespaceURI===z?t.namespaceURI===Ae&&!Ie[r]||t.namespaceURI===ke&&!Fe[r]?!1:!We[n]&&(Le[n]||!Ue[n]):!!(Re===`application/xhtml+xml`&&Ne[e.namespaceURI]):!1},Ke=function(e){as(t.removed,{element:e});try{y(e).removeChild(e)}catch{g(e)}},qe=function(e,n){try{as(t.removed,{attribute:n.getAttributeNode(e),from:n})}catch{as(t.removed,{attribute:null,from:n})}if(n.removeAttribute(e),e===`is`)if(he||ge)try{Ke(n)}catch{}else try{n.setAttribute(e,``)}catch{}},Je=function(e){let t=null,r=null;if(me)e=`<remove></remove>`+e;else{let t=ls(e,/^[\r\n\t ]+/);r=t&&t[0]}Re===`application/xhtml+xml`&&je===z&&(e=`<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>`+e+`</body></html>`);let i=b?b.createHTML(e):e;if(je===z)try{t=new f().parseFromString(i,Re)}catch{}if(!t||!t.documentElement){t=S.createDocument(je,`template`,null);try{t.documentElement.innerHTML=Me?x:i}catch{}}let a=t.body||t.documentElement;return e&&r&&a.insertBefore(n.createTextNode(r),a.childNodes[0]||null),je===z?T.call(t,fe?`html`:`body`)[0]:fe?t.documentElement:a},Ye=function(e){return C.call(e.ownerDocument||e,e,l.SHOW_ELEMENT|l.SHOW_COMMENT|l.SHOW_TEXT|l.SHOW_PROCESSING_INSTRUCTION|l.SHOW_CDATA_SECTION,null)},Xe=function(e){return e instanceof d&&(typeof e.nodeName!=`string`||typeof e.textContent!=`string`||typeof e.removeChild!=`function`||!(e.attributes instanceof u)||typeof e.removeAttribute!=`function`||typeof e.setAttribute!=`function`||typeof e.namespaceURI!=`string`||typeof e.insertBefore!=`function`||typeof e.hasChildNodes!=`function`)},Ze=function(e){return typeof s==`function`&&e instanceof s};function Qe(e,n,r){ns(e,e=>{e.call(t,n,r,ze)})}let $e=function(e){let n=null;if(Qe(D.beforeSanitizeElements,e,null),Xe(e))return Ke(e),!0;let r=V(e.nodeName);if(Qe(D.uponSanitizeElement,e,{tagName:r,allowedTags:M}),de&&e.hasChildNodes()&&!Ze(e.firstElementChild)&&ms(/<[/\w!]/g,e.innerHTML)&&ms(/<[/\w!]/g,e.textContent)||e.nodeType===Us.progressingInstruction||de&&e.nodeType===Us.comment&&ms(/<[/\w]/g,e.data))return Ke(e),!0;if(!(L.tagCheck instanceof Function&&L.tagCheck(r))&&(!M[r]||I[r])){if(!I[r]&&tt(r)&&(F.tagNameCheck instanceof RegExp&&ms(F.tagNameCheck,r)||F.tagNameCheck instanceof Function&&F.tagNameCheck(r)))return!1;if(be&&!Ce[r]){let t=y(e)||e.parentNode,n=v(e)||e.childNodes;if(n&&t){let r=n.length;for(let i=r-1;i>=0;--i){let r=h(n[i],!0);r.__removalCount=(e.__removalCount||0)+1,t.insertBefore(r,_(e))}}}return Ke(e),!0}return e instanceof c&&!Ge(e)||(r===`noscript`||r===`noembed`||r===`noframes`)&&ms(/<\/no(script|embed|frames)/i,e.innerHTML)?(Ke(e),!0):(ue&&e.nodeType===Us.text&&(n=e.textContent,ns([ee,te,O],e=>{n=us(n,e,` `)}),e.textContent!==n&&(as(t.removed,{element:e.cloneNode()}),e.textContent=n)),Qe(D.afterSanitizeElements,e,null),!1)},et=function(e,t,r){if(oe[t]||ve&&(t===`id`||t===`name`)&&(r in n||r in Be))return!1;if(!(R&&!oe[t]&&ms(k,t))&&!(se&&ms(A,t))&&!(L.attributeCheck instanceof Function&&L.attributeCheck(t,e))){if(!N[t]||oe[t]){if(!(tt(e)&&(F.tagNameCheck instanceof RegExp&&ms(F.tagNameCheck,e)||F.tagNameCheck instanceof Function&&F.tagNameCheck(e))&&(F.attributeNameCheck instanceof RegExp&&ms(F.attributeNameCheck,t)||F.attributeNameCheck instanceof Function&&F.attributeNameCheck(t,e))||t===`is`&&F.allowCustomizedBuiltInElements&&(F.tagNameCheck instanceof RegExp&&ms(F.tagNameCheck,r)||F.tagNameCheck instanceof Function&&F.tagNameCheck(r))))return!1}else if(!De[t]&&!ms(ie,us(r,j,``))&&!((t===`src`||t===`xlink:href`||t===`href`)&&e!==`script`&&ds(r,`data:`)===0&&Te[e])&&!(ce&&!ms(ne,us(r,j,``)))&&r)return!1}return!0},tt=function(e){return e!==`annotation-xml`&&ls(e,re)},nt=function(e){Qe(D.beforeSanitizeAttributes,e,null);let{attributes:n}=e;if(!n||Xe(e))return;let r={attrName:``,attrValue:``,keepAttr:!0,allowedAttributes:N,forceKeepAttr:void 0},i=n.length;for(;i--;){let{name:a,namespaceURI:o,value:s}=n[i],c=V(a),l=s,u=a===`value`?l:fs(l);if(r.attrName=c,r.attrValue=u,r.keepAttr=!0,r.forceKeepAttr=void 0,Qe(D.uponSanitizeAttribute,e,r),u=r.attrValue,ye&&(c===`id`||c===`name`)&&(qe(a,e),u=`user-content-`+u),de&&ms(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,u)){qe(a,e);continue}if(c===`attributename`&&ls(u,`href`)){qe(a,e);continue}if(r.forceKeepAttr)continue;if(!r.keepAttr){qe(a,e);continue}if(!le&&ms(/\/>/i,u)){qe(a,e);continue}ue&&ns([ee,te,O],e=>{u=us(u,e,` `)});let d=V(e.nodeName);if(!et(d,c,u)){qe(a,e);continue}if(b&&typeof p==`object`&&typeof p.getAttributeType==`function`&&!o)switch(p.getAttributeType(d,c)){case`TrustedHTML`:u=b.createHTML(u);break;case`TrustedScriptURL`:u=b.createScriptURL(u);break}if(u!==l)try{o?e.setAttributeNS(o,a,u):e.setAttribute(a,u),Xe(e)?Ke(e):is(t.removed)}catch{qe(a,e)}}Qe(D.afterSanitizeAttributes,e,null)},rt=function e(t){let n=null,r=Ye(t);for(Qe(D.beforeSanitizeShadowDOM,t,null);n=r.nextNode();)Qe(D.uponSanitizeShadowNode,n,null),$e(n),nt(n),n.content instanceof a&&e(n.content);Qe(D.afterSanitizeShadowDOM,t,null)};return t.sanitize=function(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},i=null,o=null,c=null,l=null;if(Me=!e,Me&&(e=`<!-->`),typeof e!=`string`&&!Ze(e))if(typeof e.toString==`function`){if(e=e.toString(),typeof e!=`string`)throw hs(`dirty is not a string, aborting`)}else throw hs(`toString is not a function`);if(!t.isSupported)return e;if(pe||He(n),t.removed=[],typeof e==`string`&&(xe=!1),xe){if(e.nodeName){let t=V(e.nodeName);if(!M[t]||I[t])throw hs(`root node is forbidden and cannot be sanitized in-place`)}}else if(e instanceof s)i=Je(`<!---->`),o=i.ownerDocument.importNode(e,!0),o.nodeType===Us.element&&o.nodeName===`BODY`||o.nodeName===`HTML`?i=o:i.appendChild(o);else{if(!he&&!ue&&!fe&&e.indexOf(`<`)===-1)return b&&_e?b.createHTML(e):e;if(i=Je(e),!i)return he?null:_e?x:``}i&&me&&Ke(i.firstChild);let u=Ye(xe?e:i);for(;c=u.nextNode();)$e(c),nt(c),c.content instanceof a&&rt(c.content);if(xe)return e;if(he){if(ge)for(l=w.call(i.ownerDocument);i.firstChild;)l.appendChild(i.firstChild);else l=i;return(N.shadowroot||N.shadowrootmode)&&(l=E.call(r,l,!0)),l}let d=fe?i.outerHTML:i.innerHTML;return fe&&M[`!doctype`]&&i.ownerDocument&&i.ownerDocument.doctype&&i.ownerDocument.doctype.name&&ms(Bs,i.ownerDocument.doctype.name)&&(d=`<!DOCTYPE `+i.ownerDocument.doctype.name+`>
`+d),ue&&ns([ee,te,O],e=>{d=us(d,e,` `)}),b&&_e?b.createHTML(d):d},t.setConfig=function(){He(arguments.length>0&&arguments[0]!==void 0?arguments[0]:{}),pe=!0},t.clearConfig=function(){ze=null,pe=!1},t.isValidAttribute=function(e,t,n){return ze||He({}),et(V(e),V(t),n)},t.addHook=function(e,t){typeof t==`function`&&as(D[e],t)},t.removeHook=function(e,t){if(t!==void 0){let n=rs(D[e],t);return n===-1?void 0:os(D[e],n,1)[0]}return is(D[e])},t.removeHooks=function(e){D[e]=[]},t.removeAllHooks=function(){D=Ks()},t}var Js=qs();function Ys(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Xs=Ys();function Zs(e){Xs=e}var Qs={exec:()=>null};function K(e,t=``){let n=typeof e==`string`?e:e.source,r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(ec.caret,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}var $s=(()=>{try{return!0}catch{return!1}})(),ec={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,`i`),blockquoteBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}>`)},tc=/^(?:[ \t]*(?:\n|$))+/,nc=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,rc=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ic=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ac=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,oc=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,sc=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,cc=K(sc).replace(/bull/g,oc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,``).getRegex(),lc=K(sc).replace(/bull/g,oc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),uc=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,dc=/^[^\n]+/,fc=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,pc=K(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace(`label`,fc).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),mc=K(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,oc).getRegex(),hc=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,gc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,_c=K(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))`,`i`).replace(`comment`,gc).replace(`tag`,hc).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),vc=K(uc).replace(`hr`,ic).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)])[ \\t]`).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,hc).getRegex(),yc={blockquote:K(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,vc).getRegex(),code:nc,def:pc,fences:rc,heading:ac,hr:ic,html:_c,lheading:cc,list:mc,newline:tc,paragraph:vc,table:Qs,text:dc},bc=K(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,ic).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,`(?: {4}| {0,3}	)[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)])[ \\t]`).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,hc).getRegex(),xc={...yc,lheading:lc,table:bc,paragraph:K(uc).replace(`hr`,ic).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,bc).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)])[ \\t]`).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,hc).getRegex()},Sc={...yc,html:K(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,gc).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Qs,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:K(uc).replace(`hr`,ic).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,cc).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},Cc=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,wc=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Tc=/^( {2,}|\\)\n(?!\s*$)/,Ec=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Dc=/[\p{P}\p{S}]/u,Oc=/[\s\p{P}\p{S}]/u,kc=/[^\s\p{P}\p{S}]/u,Ac=K(/^((?![*_])punctSpace)/,`u`).replace(/punctSpace/g,Oc).getRegex(),jc=/(?!~)[\p{P}\p{S}]/u,Mc=/(?!~)[\s\p{P}\p{S}]/u,Nc=/(?:[^\s\p{P}\p{S}]|~)/u,Pc=K(/link|precode-code|html/,`g`).replace(`link`,/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace(`precode-`,$s?"(?<!`)()":"(^^|[^`])").replace(`code`,/(?<b>`+)[^`]+\k<b>(?!`)/).replace(`html`,/<(?! )[^<>]*?>/).getRegex(),Fc=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,Ic=K(Fc,`u`).replace(/punct/g,Dc).getRegex(),Lc=K(Fc,`u`).replace(/punct/g,jc).getRegex(),Rc=`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,zc=K(Rc,`gu`).replace(/notPunctSpace/g,kc).replace(/punctSpace/g,Oc).replace(/punct/g,Dc).getRegex(),Bc=K(Rc,`gu`).replace(/notPunctSpace/g,Nc).replace(/punctSpace/g,Mc).replace(/punct/g,jc).getRegex(),Vc=K(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)`,`gu`).replace(/notPunctSpace/g,kc).replace(/punctSpace/g,Oc).replace(/punct/g,Dc).getRegex(),Hc=K(/^~~?(?:((?!~)punct)|[^\s~])/,`u`).replace(/punct/g,Dc).getRegex(),Uc=K(`^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)`,`gu`).replace(/notPunctSpace/g,kc).replace(/punctSpace/g,Oc).replace(/punct/g,Dc).getRegex(),Wc=K(/\\(punct)/,`gu`).replace(/punct/g,Dc).getRegex(),Gc=K(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Kc=K(gc).replace(`(?:-->|$)`,`-->`).getRegex(),qc=K(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,Kc).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Jc=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,Yc=K(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace(`label`,Jc).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Xc=K(/^!?\[(label)\]\[(ref)\]/).replace(`label`,Jc).replace(`ref`,fc).getRegex(),Zc=K(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,fc).getRegex(),Qc=K(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,Xc).replace(`nolink`,Zc).getRegex(),$c=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,el={_backpedal:Qs,anyPunctuation:Wc,autolink:Gc,blockSkip:Pc,br:Tc,code:wc,del:Qs,delLDelim:Qs,delRDelim:Qs,emStrongLDelim:Ic,emStrongRDelimAst:zc,emStrongRDelimUnd:Vc,escape:Cc,link:Yc,nolink:Zc,punctuation:Ac,reflink:Xc,reflinkSearch:Qc,tag:qc,text:Ec,url:Qs},tl={...el,link:K(/^!?\[(label)\]\((.*?)\)/).replace(`label`,Jc).getRegex(),reflink:K(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,Jc).getRegex()},nl={...el,emStrongRDelimAst:Bc,emStrongLDelim:Lc,delLDelim:Hc,delRDelim:Uc,url:K(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace(`protocol`,$c).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:K(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace(`protocol`,$c).getRegex()},rl={...nl,br:K(Tc).replace(`{2,}`,`*`).getRegex(),text:K(nl.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},il={normal:yc,gfm:xc,pedantic:Sc},al={normal:el,gfm:nl,breaks:rl,pedantic:tl},ol={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},sl=e=>ol[e];function cl(e,t){if(t){if(ec.escapeTest.test(e))return e.replace(ec.escapeReplace,sl)}else if(ec.escapeTestNoEncode.test(e))return e.replace(ec.escapeReplaceNoEncode,sl);return e}function ll(e){try{e=encodeURI(e).replace(ec.percentDecode,`%`)}catch{return null}return e}function ul(e,t){let n=e.replace(ec.findPipe,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(ec.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(ec.slashPipe,`|`);return n}function dl(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function fl(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return n>0?-2:-1}function pl(e,t=0){let n=t,r=``;for(let t of e)if(t===`	`){let e=4-n%4;r+=` `.repeat(e),n+=e}else r+=t,n++;return r}function ml(e,t,n,r,i){let a=t.href,o=t.title||null,s=e[1].replace(i.other.outputLinkReplace,`$1`);r.state.inLink=!0;let c={type:e[0].charAt(0)===`!`?`image`:`link`,raw:n,href:a,title:o,text:s,tokens:r.inlineTokens(s)};return r.state.inLink=!1,c}function hl(e,t,n){let r=e.match(n.other.indentCodeCompensation);if(r===null)return t;let i=r[1];return t.split(`
`).map(e=>{let t=e.match(n.other.beginningSpace);if(t===null)return e;let[r]=t;return r.length>=i.length?e.slice(i.length):e}).join(`
`)}var gl=class{options;rules;lexer;constructor(e){this.options=e||Xs}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:`space`,raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let e=t[0].replace(this.rules.other.codeRemoveIndent,``);return{type:`code`,raw:t[0],codeBlockStyle:`indented`,text:this.options.pedantic?e:dl(e,`
`)}}}fences(e){let t=this.rules.block.fences.exec(e);if(t){let e=t[0],n=hl(e,t[3]||``,this.rules);return{type:`code`,raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,`$1`):t[2],text:n}}}heading(e){let t=this.rules.block.heading.exec(e);if(t){let e=t[2].trim();if(this.rules.other.endingHash.test(e)){let t=dl(e,`#`);(this.options.pedantic||!t||this.rules.other.endingSpaceChar.test(t))&&(e=t.trim())}return{type:`heading`,raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(e){let t=this.rules.block.hr.exec(e);if(t)return{type:`hr`,raw:dl(t[0],`
`)}}blockquote(e){let t=this.rules.block.blockquote.exec(e);if(t){let e=dl(t[0],`
`).split(`
...
`?t[1].slice(0,-1):t[1];return{type:`paragraph`,raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(e){let t=this.rules.block.text.exec(e);if(t)return{type:`text`,raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){let t=this.rules.inline.escape.exec(e);if(t)return{type:`escape`,raw:t[0],text:t[1]}}tag(e){let t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&this.rules.other.startATag.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:`html`,raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(e){let t=this.rules.inline.link.exec(e);if(t){let e=t[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(e)){if(!this.rules.other.endAngleBracket.test(e))return;let t=dl(e.slice(0,-1),`\\`);if((e.length-t.length)%2==0)return}else{let e=fl(t[2],`()`);if(e===-2)return;if(e>-1){let n=(t[0].indexOf(`!`)===0?5:4)+t[1].length+e;t[2]=t[2].substring(0,e),t[0]=t[0].substring(0,n).trim(),t[3]=``}}let n=t[2],r=``;if(this.options.pedantic){let e=this.rules.other.pedanticHrefTitle.exec(n);e&&(n=e[1],r=e[3])}else r=t[3]?t[3].slice(1,-1):``;return n=n.trim(),this.rules.other.startAngleBracket.test(n)&&(n=this.options.pedantic&&!this.rules.other.endAngleBracket.test(e)?n.slice(1):n.slice(1,-1)),ml(t,{href:n&&n.replace(this.rules.inline.anyPunctuation,`$1`),title:r&&r.replace(this.rules.inline.anyPunctuation,`$1`)},t[0],this.lexer,this.rules)}}reflink(e,t){let n;if((n=this.rules.inline.reflink.exec(e))||(n=this.rules.inline.nolink.exec(e))){let e=t[(n[2]||n[1]).replace(this.rules.other.multipleSpaceGlobal,` `).toLowerCase()];if(!e){let e=n[0].charAt(0);return{type:`text`,raw:e,text:e}}return ml(n,e,n[0],this.lexer,this.rules)}}emStrong(e,t,n=``){let r=this.rules.inline.emStrongLDelim.exec(e);if(!(!r||!r[1]&&!r[2]&&!r[3]&&!r[4]||r[4]&&n.match(this.rules.other.unicodeAlphaNumeric))&&(!(r[1]||r[3])||!n||this.rules.inline.punctuation.exec(n))){let n=[...r[0]].length-1,i,a,o=n,s=0,c=r[0][0]===`*`?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(c.lastIndex=0,t=t.slice(-1*e.length+n);(r=c.exec(t))!=null;){if(i=r[1]||r[2]||r[3]||r[4]||r[5]||r[6],!i)continue;if(a=[...i].length,r[3]||r[4]){o+=a;continue}else if((r[5]||r[6])&&n%3&&!((n+a)%3)){s+=a;continue}if(o-=a,o>0)continue;a=Math.min(a,a+o+s);let t=[...r[0]][0].length,c=e.slice(0,n+r.index+t+a);if(Math.min(n,a)%2){let e=c.slice(1,-1);return{type:`em`,raw:c,text:e,tokens:this.lexer.inlineTokens(e)}}let l=c.slice(2,-2);return{type:`strong`,raw:c,text:l,tokens:this.lexer.inlineTokens(l)}}}}codespan(e){let t=this.rules.inline.code.exec(e);if(t){let e=t[2].replace(this.rules.other.newLineCharGlobal,` `),n=this.rules.other.nonSpaceChar.test(e),r=this.rules.other.startingSpaceChar.test(e)&&this.rules.other.endingSpaceChar.test(e);return n&&r&&(e=e.substring(1,e.length-1)),{type:`codespan`,raw:t[0],text:e}}}br(e){let t=this.rules.inline.br.exec(e);if(t)return{type:`br`,raw:t[0]}}del(e,t,n=``){let r=this.rules.inline.delLDelim.exec(e);if(r&&(!r[1]||!n||this.rules.inline.punctuation.exec(n))){let n=[...r[0]].length-1,i,a,o=n,s=this.rules.inline.delRDelim;for(s.lastIndex=0,t=t.slice(-1*e.length+n);(r=s.exec(t))!=null;){if(i=r[1]||r[2]||r[3]||r[4]||r[5]||r[6],!i||(a=[...i].length,a!==n))continue;if(r[3]||r[4]){o+=a;continue}if(o-=a,o>0)continue;a=Math.min(a,a+o);let t=[...r[0]][0].length,s=e.slice(0,n+r.index+t+a),c=s.slice(n,-n);return{type:`del`,raw:s,text:c,tokens:this.lexer.inlineTokens(c)}}}}autolink(e){let t=this.rules.inline.autolink.exec(e);if(t){let e,n;return t[2]===`@`?(e=t[1],n=`mailto:`+e):(e=t[1],n=e),{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}url(e){let t;if(t=this.rules.inline.url.exec(e)){let e,n;if(t[2]===`@`)e=t[0],n=`mailto:`+e;else{let r;do r=t[0],t[0]=this.rules.inline._backpedal.exec(t[0])?.[0]??``;while(r!==t[0]);e=t[0],n=t[1]===`www.`?`http://`+t[0]:t[0]}return{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}inlineText(e){let t=this.rules.inline.text.exec(e);if(t){let e=this.lexer.state.inRawBlock;return{type:`text`,raw:t[0],text:t[0],escaped:e}}}},_l=class e{tokens;options;state;inlineQueue;tokenizer;constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||Xs,this.options.tokenizer=this.options.tokenizer||new gl,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={other:ec,block:il.normal,inline:al.normal};this.options.pedantic?(t.block=il.pedantic,t.inline=al.pedantic):this.options.gfm&&(t.block=il.gfm,this.options.breaks?t.inline=al.breaks:t.inline=al.gfm),this.tokenizer.rules=t}static get rules(){return{block:il,inline:al}}static lex(t,n){return new e(n).lex(t)}static lexInline(t,n){return new e(n).inlineTokens(t)}lex(e){e=e.replace(ec.carriageReturn,`
`),this.blockTokens(e,this.tokens);for(let e=0;e<this.inlineQueue.length;e++){let t=this.inlineQueue[e];this.inlineTokens(t.src,t.tokens)}return this.inlineQueue=[],this.tokens}blockTokens(e,t=[],n=!1){for(this.tokenizer.lexer=this,this.options.pedantic&&(e=e.replace(ec.tabCharGlobal,`    `).replace(ec.spaceLine,``));e;){let r;if(this.options.extensions?.block?.some(n=>(r=n.call({lexer:this},e,t))?(e=e.substring(r.raw.length),t.push(r),!0):!1))continue;if(r=this.tokenizer.space(e)){e=e.substring(r.raw.length);let n=t.at(-1);r.raw.length===1&&n!==void 0?n.raw+=`
...
`}strong({tokens:e}){return`<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return`<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return`<code>${cl(e,!0)}</code>`}br(e){return`<br>`}del({tokens:e}){return`<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:t,tokens:n}){let r=this.parser.parseInline(n),i=ll(e);if(i===null)return r;e=i;let a=`<a href="`+e+`"`;return t&&(a+=` title="`+cl(t)+`"`),a+=`>`+r+`</a>`,a}image({href:e,title:t,text:n,tokens:r}){r&&(n=this.parser.parseInline(r,this.parser.textRenderer));let i=ll(e);if(i===null)return cl(n);e=i;let a=`<img src="${e}" alt="${cl(n)}"`;return t&&(a+=` title="${cl(t)}"`),a+=`>`,a}text(e){return`tokens`in e&&e.tokens?this.parser.parseInline(e.tokens):`escaped`in e&&e.escaped?e.text:cl(e.text)}},yl=class{strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return``+e}image({text:e}){return``+e}br(){return``}checkbox({raw:e}){return e}},bl=class e{options;renderer;textRenderer;constructor(e){this.options=e||Xs,this.options.renderer=this.options.renderer||new vl,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new yl}static parse(t,n){return new e(n).parse(t)}static parseInline(t,n){return new e(n).parseInline(t)}parse(e){this.renderer.parser=this;let t=``;for(let n=0;n<e.length;n++){let r=e[n];if(this.options.extensions?.renderers?.[r.type]){let e=r,n=this.options.extensions.renderers[e.type].call({parser:this},e);if(n!==!1||![`space`,`hr`,`heading`,`code`,`table`,`blockquote`,`list`,`html`,`def`,`paragraph`,`text`].includes(e.type)){t+=n||``;continue}}let i=r;switch(i.type){case`space`:t+=this.renderer.space(i);break;case`hr`:t+=this.renderer.hr(i);break;case`heading`:t+=this.renderer.heading(i);break;case`code`:t+=this.renderer.code(i);break;case`table`:t+=this.renderer.table(i);break;case`blockquote`:t+=this.renderer.blockquote(i);break;case`list`:t+=this.renderer.list(i);break;case`checkbox`:t+=this.renderer.checkbox(i);break;case`html`:t+=this.renderer.html(i);break;case`def`:t+=this.renderer.def(i);break;case`paragraph`:t+=this.renderer.paragraph(i);break;case`text`:t+=this.renderer.text(i);break;default:{let e=`Token with "`+i.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return t}parseInline(e,t=this.renderer){this.renderer.parser=this;let n=``;for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions?.renderers?.[i.type]){let e=this.options.extensions.renderers[i.type].call({parser:this},i);if(e!==!1||![`escape`,`html`,`link`,`image`,`strong`,`em`,`codespan`,`br`,`del`,`text`].includes(i.type)){n+=e||``;continue}}let a=i;switch(a.type){case`escape`:n+=t.text(a);break;case`html`:n+=t.html(a);break;case`link`:n+=t.link(a);break;case`image`:n+=t.image(a);break;case`checkbox`:n+=t.checkbox(a);break;case`strong`:n+=t.strong(a);break;case`em`:n+=t.em(a);break;case`codespan`:n+=t.codespan(a);break;case`br`:n+=t.br(a);break;case`del`:n+=t.del(a);break;case`text`:n+=t.text(a);break;default:{let e=`Token with "`+a.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return n}},xl=class{options;block;constructor(e){this.options=e||Xs}static passThroughHooks=new Set([`preprocess`,`postprocess`,`processAllTokens`,`emStrongMask`]);static passThroughHooksRespectAsync=new Set([`preprocess`,`postprocess`,`processAllTokens`]);preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}emStrongMask(e){return e}provideLexer(){return this.block?_l.lex:_l.lexInline}provideParser(){return this.block?bl.parse:bl.parseInline}},Sl=class{defaults=Ys();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=bl;Renderer=vl;TextRenderer=yl;Lexer=_l;Tokenizer=gl;Hooks=xl;constructor(...e){this.use(...e)}walkTokens(e,t){let n=[];for(let r of e)switch(n=n.concat(t.call(this,r)),r.type){case`table`:{let e=r;for(let r of e.header)n=n.concat(this.walkTokens(r.tokens,t));for(let r of e.rows)for(let e of r)n=n.concat(this.walkTokens(e.tokens,t));break}case`list`:{let e=r;n=n.concat(this.walkTokens(e.items,t));break}default:{let e=r;this.defaults.extensions?.childTokens?.[e.type]?this.defaults.extensions.childTokens[e.type].forEach(r=>{let i=e[r].flat(1/0);n=n.concat(this.walkTokens(i,t))}):e.tokens&&(n=n.concat(this.walkTokens(e.tokens,t)))}}return n}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(e=>{let n={...e};if(n.async=this.defaults.async||n.async||!1,e.extensions&&(e.extensions.forEach(e=>{if(!e.name)throw Error(`extension name required`);if(`renderer`in e){let n=t.renderers[e.name];n?t.renderers[e.name]=function(...t){let r=e.renderer.apply(this,t);return r===!1&&(r=n.apply(this,t)),r}:t.renderers[e.name]=e.renderer}if(`tokenizer`in e){if(!e.level||e.level!==`block`&&e.level!==`inline`)throw Error(`extension level must be 'block' or 'inline'`);let n=t[e.level];n?n.unshift(e.tokenizer):t[e.level]=[e.tokenizer],e.start&&(e.level===`block`?t.startBlock?t.startBlock.push(e.start):t.startBlock=[e.start]:e.level===`inline`&&(t.startInline?t.startInline.push(e.start):t.startInline=[e.start]))}`childTokens`in e&&e.childTokens&&(t.childTokens[e.name]=e.childTokens)}),n.extensions=t),e.renderer){let t=this.defaults.renderer||new vl(this.defaults);for(let n in e.renderer){if(!(n in t))throw Error(`renderer '${n}' does not exist`);if([`options`,`parser`].includes(n))continue;let r=n,i=e.renderer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n||``}}n.renderer=t}if(e.tokenizer){let t=this.defaults.tokenizer||new gl(this.defaults);for(let n in e.tokenizer){if(!(n in t))throw Error(`tokenizer '${n}' does not exist`);if([`options`,`rules`,`lexer`].includes(n))continue;let r=n,i=e.tokenizer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.tokenizer=t}if(e.hooks){let t=this.defaults.hooks||new xl;for(let n in e.hooks){if(!(n in t))throw Error(`hook '${n}' does not exist`);if([`options`,`block`].includes(n))continue;let r=n,i=e.hooks[r],a=t[r];xl.passThroughHooks.has(n)?t[r]=e=>{if(this.defaults.async&&xl.passThroughHooksRespectAsync.has(n))return(async()=>{let n=await i.call(t,e);return a.call(t,n)})();let r=i.call(t,e);return a.call(t,r)}:t[r]=(...e)=>{if(this.defaults.async)return(async()=>{let n=await i.apply(t,e);return n===!1&&(n=await a.apply(t,e)),n})();let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.hooks=t}if(e.walkTokens){let t=this.defaults.walkTokens,r=e.walkTokens;n.walkTokens=function(e){let n=[];return n.push(r.call(this,e)),t&&(n=n.concat(t.call(this,e))),n}}this.defaults={...this.defaults,...n}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return _l.lex(e,t??this.defaults)}parser(e,t){return bl.parse(e,t??this.defaults)}parseMarkdown(e){return(t,n)=>{let r={...n},i={...this.defaults,...r},a=this.onError(!!i.silent,!!i.async);if(this.defaults.async===!0&&r.async===!1)return a(Error(`marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise.`));if(typeof t>`u`||t===null)return a(Error(`marked(): input parameter is undefined or null`));if(typeof t!=`string`)return a(Error(`marked(): input parameter is of type `+Object.prototype.toString.call(t)+`, string expected`));if(i.hooks&&(i.hooks.options=i,i.hooks.block=e),i.async)return(async()=>{let n=i.hooks?await i.hooks.preprocess(t):t,r=await(i.hooks?await i.hooks.provideLexer():e?_l.lex:_l.lexInline)(n,i),a=i.hooks?await i.hooks.processAllTokens(r):r;i.walkTokens&&await Promise.all(this.walkTokens(a,i.walkTokens));let o=await(i.hooks?await i.hooks.provideParser():e?bl.parse:bl.parseInline)(a,i);return i.hooks?await i.hooks.postprocess(o):o})().catch(a);try{i.hooks&&(t=i.hooks.preprocess(t));let n=(i.hooks?i.hooks.provideLexer():e?_l.lex:_l.lexInline)(t,i);i.hooks&&(n=i.hooks.processAllTokens(n)),i.walkTokens&&this.walkTokens(n,i.walkTokens);let r=(i.hooks?i.hooks.provideParser():e?bl.parse:bl.parseInline)(n,i);return i.hooks&&(r=i.hooks.postprocess(r)),r}catch(e){return a(e)}}}onError(e,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+cl(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}},Cl=new Sl;function q(e,t){return Cl.parse(e,t)}q.options=q.setOptions=function(e){return Cl.setOptions(e),q.defaults=Cl.defaults,Zs(q.defaults),q},q.getDefaults=Ys,q.defaults=Xs,q.use=function(...e){return Cl.use(...e),q.defaults=Cl.defaults,Zs(q.defaults),q},q.walkTokens=function(e,t){return Cl.walkTokens(e,t)},q.parseInline=Cl.parseInline,q.Parser=bl,q.parser=bl.parse,q.Renderer=vl,q.TextRenderer=yl,q.Lexer=_l,q.lexer=_l.lex,q.Tokenizer=gl,q.Hooks=xl,q.parse=q,q.options,q.setOptions,q.use,q.walkTokens,q.parseInline,bl.parse,_l.lex;var wl={ALLOWED_TAGS:`a.b.blockquote.br.button.code.del.details.div.em.h1.h2.h3.h4.hr.i.li.ol.p.pre.span.strong.summary.table.tbody.td.th.thead.tr.ul.img`.split(`.`),ALLOWED_ATTR:[`class`,`href`,`rel`,`target`,`title`,`start`,`src`,`alt`,`data-code`,`type`,`aria-label`],ADD_DATA_URI_TAGS:[`img`]},Tl=!1,El=14e4,Dl=4e4,Ol=200,kl=5e4,Al=/^data:image\/[a-z0-9.+-]+;base64,/i,jl=new Map,Ml=`chat-link-tail-blur`;function Nl(e){let t=jl.get(e);return t===void 0?null:(jl.delete(e),jl.set(e,t),t)}function Pl(e,t){if(jl.set(e,t),jl.size<=Ol)return;let n=jl.keys().next().value;n&&jl.delete(n)}function Fl(){Tl||(Tl=!0,Js.addHook(`afterSanitizeAttributes`,e=>{if(!(e instanceof HTMLAnchorElement))return;let t=e.getAttribute(`href`);t&&(e.setAttribute(`rel`,`noreferrer noopener`),e.setAttribute(`target`,`_blank`),t.toLowerCase().includes(`tail`)&&e.classList.add(Ml))}))}function Il(e){let t=e.trim();if(!t)return``;if(Fl(),t.length<=kl){let e=Nl(t);if(e!==null)return e}let n=u(t,El),r=n.truncated?`\n\n… truncated (${n.total} chars, showing first ${n.text.length}).`:``;if(n.text.length>Dl){let e=Bl(`${n.text}${r}`),i=Js.sanitize(e,wl);return t.length<=kl&&Pl(t,i),i}let i;try{i=q.parse(`${n.text}${r}`,{renderer:Ll,gfm:!0,breaks:!0})}catch(e){console.warn(`[markdown] marked.parse failed, falling back to plain text:`,e),i=`<pre class="code-block">${zl(`${n.text}${r}`)}</pre>`}let a=Js.sanitize(i,wl);return t.length<=kl&&Pl(t,a),a}var Ll=new q.Renderer;Ll.html=({text:e})=>zl(e),Ll.image=e=>{let t=Rl(e.text),n=e.href?.trim()??``;return Al.test(n)?`<img class="markdown-inline-image" src="${zl(n)}" alt="${zl(t)}">`:zl(t)};function Rl(e){return e?.trim()||`image`}Ll.code=({text:e,lang:t,escaped:n})=>{let r=`<pre><code${t?` class="language-${zl(t)}"`:``}>${n?e:zl(e)}</code></pre>`,i=`<div class="code-block-header">${t?`<span class="code-block-lang">${zl(t)}</span>`:``}${`<button type="button" class="code-block-copy" data-code="${e.replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}" aria-label="Copy code"><span class="code-block-copy__idle">Copy</span><span class="code-block-copy__done">Copied!</span></button>`}</div>`,a=e.trim();if(t===`json`||!t&&(a.startsWith(`{`)&&a.endsWith(`}`)||a.startsWith(`[`)&&a.endsWith(`]`))){let t=e.split(`
`).length;return`<details class="json-collapse"><summary>${t>1?`JSON &middot; ${t} lines`:`JSON`}</summary><div class="code-block-wrapper">${i}${r}</div></details>`}return`<div class="code-block-wrapper">${i}${r}</div>`};function zl(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function Bl(e){return`<div class="markdown-plain-text-fallback">${zl(e.replace(/\r\n?/g,`
`))}</div>`}var Vl=`data:`,Hl=new Set([`http:`,`https:`,`blob:`]),Ul=new Set([`image/svg+xml`]);function Wl(e){if(!e.toLowerCase().startsWith(Vl))return!1;let t=e.indexOf(`,`);if(t<5)return!1;let n=e.slice(5,t).split(`;`)[0]?.trim().toLowerCase()??``;return n.startsWith(`image/`)?!Ul.has(n):!1}function Gl(e,t,n={}){let r=e.trim();if(!r)return null;if(n.allowDataImage===!0&&Wl(r))return r;if(r.toLowerCase().startsWith(Vl))return null;try{let e=new URL(r,t);return Hl.has(e.protocol.toLowerCase())?e.toString():null}catch{return null}}function Kl(e,t={}){let n=Gl(e,t.baseHref??window.location.href,t);if(!n)return null;let r=window.open(n,`_blank`,`noopener,noreferrer`);return r&&(r.opener=null),r}var ql=/\p{Script=Hebrew}|\p{Script=Arabic}|\p{Script=Syriac}|\p{Script=Thaana}|\p{Script=Nko}|\p{Script=Samaritan}|\p{Script=Mandaic}|\p{Script=Adlam}|\p{Script=Phoenician}|\p{Script=Lydian}/u;function Jl(e,t=/[\s\p{P}\p{S}]/u){if(!e)return`ltr`;for(let n of e)if(!t.test(n))return ql.test(n)?`rtl`:`ltr`;return`ltr`}var Yl=[{id:`read`,label:`read`,description:`Read file contents`,sectionId:`fs`,profiles:[`coding`]},{id:`write`,label:`write`,description:`Create or overwrite files`,sectionId:`fs`,profiles:[`coding`]},{id:`edit`,label:`edit`,description:`Make precise edits`,sectionId:`fs`,profiles:[`coding`]},{id:`apply_patch`,label:`apply_patch`,description:`Patch files (OpenAI)`,sectionId:`fs`,profiles:[`coding`]},{id:`exec`,label:`exec`,description:`Run shell commands`,sectionId:`runtime`,profiles:[`coding`]},{id:`process`,label:`process`,description:`Manage background processes`,sectionId:`runtime`,profiles:[`coding`]},{id:`web_search`,label:`web_search`,description:`Search the web`,sectionId:`web`,profiles:[`coding`],includeInOpenClawGroup:!0},{id:`web_fetch`,label:`web_fetch`,description:`Fetch web content`,sectionId:`web`,profiles:[`coding`],includeInOpenClawGroup:!0},{id:`memory_search`,label:`memory_search`,description:`Semantic search`,sectionId:`memory`,profiles:[`coding`],includeInOpenClawGroup:!0},{id:`memory_get`,label:`memory_get`,description:`Read memory files`,sectionId:`memory`,profiles:[`coding`],includeInOpenClawGroup:!0},{id:`sessions_list`,label:`sessions_list`,description:`List sessions`,sectionId:`sessions`,profiles:[`coding`,`messaging`],includeInOpenClawGroup:!0},{id:`sessions_history`,label:`sessions_history`,description:`Session history`,sectionId:`sessions`,profiles:[`coding`,`messaging`],includeInOpenClawGroup:!0},{id:`sessions_send`,label:`sessions_send`,description:`Send to session`,sectionId:`sessions`,profiles:[`coding`,`messaging`],includeInOpenClawGroup:!0},{id:`sessions_spawn`,label:`sessions_spawn`,description:`Spawn sub-agent`,sectionId:`sessions`,profiles:[`coding`],includeInOpenClawGroup:!0},{id:`sessions_yield`,label:`sessions_yield`,description:`End turn to receive sub-agent results`,sectionId:`sessions`,profiles:[`coding`],includeInOpenClawGroup:!0},{id:`subagents`,label:`subagents`,description:`Manage sub-agents`,sectionId:`sessions`,profiles:[`coding`],includeInOpenClawGroup:!0},{id:`session_status`,label:`session_status`,description:`Session status`,sectionId:`sessions`,profiles:[`minimal`,`coding`,`messaging`],includeInOpenClawGroup:!0},{id:`browser`,label:`browser`,description:`Control web browser`,sectionId:`ui`,profiles:[],includeInOpenClawGroup:!0},{id:`canvas`,label:`canvas`,description:`Control canvases`,sectionId:`ui`,profiles:[],includeInOpenClawGroup:!0},{id:`message`,label:`message`,description:`Send messages`,sectionId:`messaging`,profiles:[`messaging`],includeInOpenClawGroup:!0},{id:`cron`,label:`cron`,description:`Schedule tasks`,sectionId:`automation`,profiles:[`coding`],includeInOpenClawGroup:!0},{id:`gateway`,label:`gateway`,description:`Gateway control`,sectionId:`automation`,profiles:[],includeInOpenClawGroup:!0},{id:`nodes`,label:`nodes`,description:`Nodes + devices`,sectionId:`nodes`,profiles:[],includeInOpenClawGroup:!0},{id:`agents_list`,label:`agents_list`,description:`List agents`,sectionId:`agents`,profiles:[],includeInOpenClawGroup:!0},{id:`image`,label:`image`,description:`Image understanding`,sectionId:`media`,profiles:[`coding`],includeInOpenClawGroup:!0},{id:`image_generate`,label:`image_generate`,description:`Image generation`,sectionId:`media`,profiles:[`coding`],includeInOpenClawGroup:!0},{id:`tts`,label:`tts`,description:`Text-to-speech conversion`,sectionId:`media`,profiles:[],includeInOpenClawGroup:!0}];new Map(Yl.map(e=>[e.id,e]));function Xl(e){return Yl.filter(t=>t.profiles.includes(e)).map(e=>e.id)}var Zl={minimal:{allow:Xl(`minimal`)},coding:{allow:Xl(`coding`)},messaging:{allow:Xl(`messaging`)},full:{}};function Ql(){let e=new Map;for(let t of Yl){let n=`group:${t.sectionId}`,r=e.get(n)??[];r.push(t.id),e.set(n,r)}let t=Yl.filter(e=>e.includeInOpenClawGroup).map(e=>e.id);return{"group:openclaw":t,...Object.fromEntries(e.entries())}}var $l=Ql();function eu(e){if(!e)return;let t=Zl[e];if(t&&!(!t.allow&&!t.deny))return{allow:t.allow?[...t.allow]:void 0,deny:t.deny?[...t.deny]:void 0}}var tu={bash:`exec`,"apply-patch":`apply_patch`},nu={...$l};function ru(e){let t=e.trim().toLowerCase();return tu[t]??t}function iu(e){return e?e.map(ru).filter(Boolean):[]}function au(e){let t=iu(e),n=[];for(let e of t){let t=nu[e];if(t){n.push(...t);continue}n.push(e)}return Array.from(new Set(n))}function ou(e){return eu(e)}var su=[{id:`fs`,label:`Files`,tools:[{id:`read`,label:`read`,description:`Read file contents`},{id:`write`,label:`write`,description:`Create or overwrite files`},{id:`edit`,label:`edit`,description:`Make precise edits`},{id:`apply_patch`,label:`apply_patch`,description:`Patch files (OpenAI)`}]},{id:`runtime`,label:`Runtime`,tools:[{id:`exec`,label:`exec`,description:`Run shell commands`},{id:`process`,label:`process`,description:`Manage background processes`}]},{id:`web`,label:`Web`,tools:[{id:`web_search`,label:`web_search`,description:`Search the web`},{id:`web_fetch`,label:`web_fetch`,description:`Fetch web content`}]},{id:`memory`,label:`Memory`,tools:[{id:`memory_search`,label:`memory_search`,description:`Semantic search`},{id:`memory_get`,label:`memory_get`,description:`Read memory files`}]},{id:`sessions`,label:`Sessions`,tools:[{id:`sessions_list`,label:`sessions_list`,description:`List sessions`},{id:`sessions_history`,label:`sessions_history`,description:`Session history`},{id:`sessions_send`,label:`sessions_send`,description:`Send to session`},{id:`sessions_spawn`,label:`sessions_spawn`,description:`Spawn sub-agent`},{id:`session_status`,label:`session_status`,description:`Session status`}]},{id:`ui`,label:`UI`,tools:[{id:`browser`,label:`browser`,description:`Control web browser`},{id:`canvas`,label:`canvas`,description:`Control canvases`}]},{id:`messaging`,label:`Messaging`,tools:[{id:`message`,label:`message`,description:`Send messages`}]},{id:`automation`,label:`Automation`,tools:[{id:`cron`,label:`cron`,description:`Schedule tasks`},{id:`gateway`,label:`gateway`,description:`Gateway control`}]},{id:`nodes`,label:`Nodes`,tools:[{id:`nodes`,label:`nodes`,description:`Nodes + devices`}]},{id:`agents`,label:`Agents`,tools:[{id:`agents_list`,label:`agents_list`,description:`List agents`}]},{id:`media`,label:`Media`,tools:[{id:`image`,label:`image`,description:`Image understanding`}]}],cu=[{id:`minimal`,label:`Minimal`},{id:`coding`,label:`Coding`},{id:`messaging`,label:`Messaging`},{id:`full`,label:`Full`}];function lu(e){return e?.groups?.length?e.groups.map(e=>({id:e.id,label:e.label,source:e.source,pluginId:e.pluginId,tools:e.tools.map(e=>({id:e.id,label:e.label,description:e.description,source:e.source,pluginId:e.pluginId,optional:e.optional,defaultProfiles:[...e.defaultProfiles]}))})):su}function uu(e){return e?.profiles?.length?e.profiles:cu}function du(e){return e.name?.trim()||e.identity?.name?.trim()||e.id}var fu=/^(https?:\/\/|data:image\/|\/)/i;function pu(e,t){let n=[t?.avatar?.trim(),e.identity?.avatarUrl?.trim(),e.identity?.avatar?.trim()];for(let e of n)if(e&&fu.test(e))return e;return null}function mu(e){let t=e?.trim()?e.replace(/\/$/,``):``;return t?`${t}/favicon.svg`:`favicon.svg`}function hu(e,t){return t&&e===t?`default`:null}function gu(e){if(e==null||!Number.isFinite(e))return`-`;if(e<1024)return`${e} B`;let t=[`KB`,`MB`,`GB`,`TB`],n=e/1024,r=0;for(;n>=1024&&r<t.length-1;)n/=1024,r+=1;return`${n.toFixed(n<10?1:0)} ${t[r]}`}function _u(e,t){let n=e;return{entry:(n?.agents?.list??[]).find(e=>e?.id===t),defaults:n?.agents?.defaults,globalTools:n?.tools}}function vu(e,t,n,r,i){let a=_u(t,e.id),o=(n&&n.agentId===e.id?n.workspace:null)||a.entry?.workspace||a.defaults?.workspace||`default`,s=a.entry?.model?yu(a.entry?.model):yu(a.defaults?.model),c=i?.name?.trim()||e.identity?.name?.trim()||e.name?.trim()||a.entry?.name||e.id,l=pu(e,i)?`custom`:`—`,u=Array.isArray(a.entry?.skills)?a.entry?.skills:null,d=u?.length??null;return{workspace:o,model:s,identityName:c,identityAvatar:l,skillsLabel:u?`${d} selected`:`all skills`,isDefault:!!(r&&e.id===r)}}function yu(e){if(!e)return`-`;if(typeof e==`string`)return e.trim()||`-`;if(typeof e==`object`&&e){let t=e,n=t.primary?.trim();if(n){let e=Array.isArray(t.fallbacks)?t.fallbacks.length:0;return e>0?`${n} (+${e} fallback)`:n}}return`-`}function bu(e){let t=e.match(/^(.+) \(\+\d+ fallback\)$/);return t?t[1]:e}function xu(e){if(!e)return null;if(typeof e==`string`)return e.trim()||null;if(typeof e==`object`&&e){let t=e;return(typeof t.primary==`string`?t.primary:typeof t.model==`string`?t.model:typeof t.id==`string`?t.id:typeof t.value==`string`?t.value:null)?.trim()||null}return null}function Su(e){if(!e||typeof e==`string`)return null;if(typeof e==`object`&&e){let t=e,n=Array.isArray(t.fallbacks)?t.fallbacks:Array.isArray(t.fallback)?t.fallback:null;return n?n.filter(e=>typeof e==`string`):null}return null}function Cu(e,t){return Su(e)??Su(t)}function wu(e,t){if(typeof t!=`string`)return;let n=t.trim();n&&e.add(n)}function Tu(e,t){if(!t)return;if(typeof t==`string`){wu(e,t);return}if(typeof t!=`object`)return;let n=t;wu(e,n.primary),wu(e,n.model),wu(e,n.id),wu(e,n.value);let r=Array.isArray(n.fallbacks)?n.fallbacks:Array.isArray(n.fallback)?n.fallback:[];for(let t of r)wu(e,t)}function Eu(e){let t=Array.from(e),n=Array.from({length:t.length},()=>``),r=(e,r,i)=>{let a=e,o=r,s=e;for(;a<r&&o<i;)n[s++]=t[a].localeCompare(t[o])<=0?t[a++]:t[o++];for(;a<r;)n[s++]=t[a++];for(;o<i;)n[s++]=t[o++];for(let r=e;r<i;r+=1)t[r]=n[r]},i=(e,t)=>{if(t-e<=1)return;let n=e+t>>>1;i(e,n),i(n,t),r(e,n,t)};return i(0,t.length),t}function Du(e){if(!e||typeof e!=`object`)return[];let t=e.agents;if(!t||typeof t!=`object`)return[];let n=new Set,r=t.defaults;if(r&&typeof r==`object`){let e=r;Tu(n,e.model);let t=e.models;if(t&&typeof t==`object`)for(let e of Object.keys(t))wu(n,e)}let i=t.list;if(i&&typeof i==`object`)for(let e of Object.values(i))!e||typeof e!=`object`||Tu(n,e.model);return Eu(n)}function Ou(e){return e.split(`,`).map(e=>e.trim()).filter(Boolean)}function ku(e){let t=e?.agents?.defaults?.models;if(!t||typeof t!=`object`)return[];let n=[];for(let[e,r]of Object.entries(t)){let t=e.trim();if(!t)continue;let i=r&&typeof r==`object`&&`alias`in r&&typeof r.alias==`string`?r.alias?.trim():void 0,a=i&&i!==t?`${i} (${t})`:t;n.push({value:t,label:a})}return n}function Au(e,t){let r=ku(e),i=t?r.some(e=>e.value===t):!1;return t&&!i&&r.unshift({value:t,label:`Current (${t})`}),r.length===0?n`
      <option value="" disabled>No configured models</option>
    `:r.map(e=>n`<option value=${e.value}>${e.label}</option>`)}function ju(e){let t=ru(e);if(!t)return{kind:`exact`,value:``};if(t===`*`)return{kind:`all`};if(!t.includes(`*`))return{kind:`exact`,value:t};let n=t.replace(/[.*+?^${}()|[\\]\\]/g,`\\$&`);return{kind:`regex`,value:RegExp(`^${n.replaceAll(`\\*`,`.*`)}$`)}}function Mu(e){return Array.isArray(e)?au(e).map(ju).filter(e=>e.kind!==`exact`||e.value.length>0):[]}function Nu(e,t){for(let n of t)if(n.kind===`all`||n.kind===`exact`&&e===n.value||n.kind===`regex`&&n.value.test(e))return!0;return!1}function Pu(e,t){if(!t)return!0;let n=ru(e);if(Nu(n,Mu(t.deny)))return!1;let r=Mu(t.allow);return!!(r.length===0||Nu(n,r)||n===`apply_patch`&&Nu(`exec`,r))}function Fu(e,t){if(!Array.isArray(t)||t.length===0)return!1;let n=ru(e),r=Mu(t);return!!(Nu(n,r)||n===`apply_patch`&&Nu(`exec`,r))}function Iu(e){return ou(e)??void 0}var Lu=1500,Ru=2e3,zu=`Copy as markdown`,Bu=`Copied`,Vu=`Copy failed`;async function Hu(e){if(!e)return!1;try{return await navigator.clipboard.writeText(e),!0}catch{return!1}}function Uu(e,t){e.title=t,e.setAttribute(`aria-label`,t)}function Wu(e){let t=e.label??zu;return n`
    <button
      class="chat-copy-btn"
      type="button"
      title=${t}
      aria-label=${t}
      @click=${async n=>{let r=n.currentTarget;if(!r||r.dataset.copying===`1`)return;r.dataset.copying=`1`,r.setAttribute(`aria-busy`,`true`),r.disabled=!0;let i=await Hu(e.text());if(r.isConnected){if(delete r.dataset.copying,r.removeAttribute(`aria-busy`),r.disabled=!1,!i){r.dataset.error=`1`,Uu(r,Vu),window.setTimeout(()=>{r.isConnected&&(delete r.dataset.error,Uu(r,t))},Ru);return}r.dataset.copied=`1`,Uu(r,Bu),window.setTimeout(()=>{r.isConnected&&(delete r.dataset.copied,Uu(r,t))},Lu)}}}
    >
  ...
  `}function Gu(e){return Wu({text:()=>e,label:zu})}function Ku(e){let t=e,n=typeof t.role==`string`?t.role:`unknown`,r=typeof t.toolCallId==`string`||typeof t.tool_call_id==`string`,i=t.content,a=Array.isArray(i)?i:null,o=Array.isArray(a)&&a.some(e=>{let t=e,n=(typeof t.type==`string`?t.type:``).toLowerCase();return n===`toolresult`||n===`tool_result`}),s=typeof t.toolName==`string`||typeof t.tool_name==`string`;(r||o||s)&&(n=`toolResult`);let c=[];typeof t.content==`string`?c=[{type:`text`,text:t.content}]:Array.isArray(t.content)?c=t.content.map(e=>({type:e.type||`text`,text:e.text,name:e.name,args:e.args||e.arguments})):typeof t.text==`string`&&(c=[{type:`text`,text:t.text}]);let l=typeof t.timestamp==`number`?t.timestamp:Date.now(),u=typeof t.id==`string`?t.id:void 0,d=typeof t.senderLabel==`string`&&t.senderLabel.trim()?t.senderLabel.trim():null;return(n===`user`||n===`User`)&&(c=c.map(e=>e.type===`text`&&typeof e.text==`string`?{...e,text:Oo(e.text)}:e)),{role:n,content:c,timestamp:l,id:u,senderLabel:d}}function qu(e){let t=e.toLowerCase();return e===`user`||e===`User`?e:e===`assistant`?`assistant`:e===`system`?`system`:t===`toolresult`||t===`tool_result`||t===`tool`||t===`function`?`tool`:e}function Ju(e){let t=e,n=typeof t.role==`string`?t.role.toLowerCase():``;return n===`toolresult`||n===`tool_result`}function Yu(){let e=globalThis;return e.SpeechRecognition??e.webkitSpeechRecognition??null}function Xu(){return Yu()!==null}var Zu=null;function Qu(e){let t=Yu();if(!t)return e.onError?.(`Speech recognition is not supported in this browser`),!1;$u();let n=new t;return n.continuous=!0,n.interimResults=!0,n.lang=navigator.language||`en-US`,n.addEventListener(`start`,()=>e.onStart?.()),n.addEventListener(`result`,t=>{let n=t,r=``,i=``;for(let e=n.resultIndex;e<n.results.length;e++){let t=n.results[e];if(!t?.[0])continue;let a=t[0].transcript;t.isFinal?i+=a:r+=a}i?e.onTranscript(i,!0):r&&e.onTranscript(r,!1)}),n.addEventListener(`error`,t=>{let n=t;n.error===`aborted`||n.error===`no-speech`||e.onError?.(n.error)}),n.addEventListener(`end`,()=>{Zu===n&&(Zu=null),e.onEnd?.()}),Zu=n,n.start(),!0}function $u(){if(Zu){let e=Zu;Zu=null;try{e.stop()}catch{}}}function ed(){return`speechSynthesis`in globalThis}var td=null;function nd(e,t){if(!ed())return t?.onError?.(`Speech synthesis is not supported in this browser`),!1;rd();let n=ad(e);if(!n.trim())return!1;let r=new SpeechSynthesisUtterance(n);return r.rate=1,r.pitch=1,r.addEventListener(`start`,()=>t?.onStart?.()),r.addEventListener(`end`,()=>{td===r&&(td=null),t?.onEnd?.()}),r.addEventListener(`error`,e=>{td===r&&(td=null),!(e.error===`canceled`||e.error===`interrupted`)&&t?.onError?.(e.error)}),td=r,speechSynthesis.speak(r),!0}function rd(){td&&=null,ed()&&speechSynthesis.cancel()}function id(){return ed()&&speechSynthesis.speaking}function ad(e){return e.replace(/```[\s\S]*?```/g,``).replace(/`[^`]+`/g,``).replace(/!\[.*?\]\(.*?\)/g,``).replace(/\[([^\]]+)\]\(.*?\)/g,`$1`).replace(/^#{1,6}\s+/gm,``).replace(/\*{1,3}(.*?)\*{1,3}/g,`$1`).replace(/_{1,3}(.*?)_{1,3}/g,`$1`).replace(/^>\s?/gm,``).replace(/^[-*_]{3,}\s*$/gm,``).replace(/^\s*[-*+]\s+/gm,``).replace(/^\s*\d+\.\s+/gm,``).replace(/<[^>]+>/g,``).replace(/\n{3,}/g,`

`).trim()}var od={version:1,fallback:{emoji:`🧩`,detailKeys:[`command`,`path`,`url`,`targetUrl`,`targetId`,`ref`,`element`,`node`,`nodeId`,`id`,`requestId`,`to`,`channelId`,`guildId`,`userId`,`name`,`query`,`pattern`,`messageId`]},tools:{bash:{emoji:`🛠️`,title:`Bash`,detailKeys:[`command`]},process:{emoji:`🧰`,title:`Process`,detailKeys:[`sessionId`]},read:{emoji:`📖`,title:`Read`,detailKeys:[`path`]},write:{emoji:`✍️`,title:`Write`,detailKeys:[`path`]},edit:{emoji:`📝`,title:`Edit`,detailKeys:[`path`]},attach:{emoji:`📎`,title:`Attach`,detailKeys:[`path`,`url`,`fileName`]},browser:{emoji:`🌐`,title:`Browser`,actions:{status:{label:`status`},start:{label:`start`},stop:{label:`stop`},tabs:{label:`tabs`},open:{label:`open`,detailKeys:[`targetUrl`]},focus:{label:`focus`,detailKeys:[`targetId`]},close:{label:`close`,detailKeys:[`targetId`]},snapshot:{label:`snapshot`,detailKeys:[`targetUrl`,`targetId`,`ref`,`element`,`format`]},screenshot:{label:`screenshot`,detailKeys:[`targetUrl`,`targetId`,`ref`,`element`]},navigate:{label:`navigate`,detailKeys:[`targetUrl`,`targetId`]},console:{label:`console`,detailKeys:[`level`,`targetId`]},pdf:{label:`pdf`,detailKeys:[`targetId`]},upload:{label:`upload`,detailKeys:[`paths`,`ref`,`inputRef`,`element`,`targetId`]},dialog:{label:`dialog`,detailKeys:[`accept`,`promptText`,`targetId`]},act:{label:`act`,detailKeys:[`request.kind`,`request.ref`,`request.selector`,`request.text`,`request.value`]}}},canvas:{emoji:`🖼️`,title:`Canvas`,actions:{present:{label:`present`,detailKeys:[`target`,`node`,`nodeId`]},hide:{label:`hide`,detailKeys:[`node`,`nodeId`]},navigate:{label:`navigate`,detailKeys:[`url`,`node`,`nodeId`]},eval:{label:`eval`,detailKeys:[`javaScript`,`node`,`nodeId`]},snapshot:{label:`snapshot`,detailKeys:[`format`,`node`,`nodeId`]},a2ui_push:{label:`A2UI push`,detailKeys:[`jsonlPath`,`node`,`nodeId`]},a2ui_reset:{label:`A2UI reset`,detailKeys:[`node`,`nodeId`]}}},nodes:{emoji:`📱`,title:`Nodes`,actions:{status:{label:`status`},describe:{label:`describe`,detailKeys:[`node`,`nodeId`]},pending:{label:`pending`},approve:{label:`approve`,detailKeys:[`requestId`]},reject:{label:`reject`,detailKeys:[`requestId`]},notify:{label:`notify`,detailKeys:[`node`,`nodeId`,`title`,`body`]},camera_snap:{label:`camera snap`,detailKeys:[`node`,`nodeId`,`facing`,`deviceId`]},camera_list:{label:`camera list`,detailKeys:[`node`,`nodeId`]},camera_clip:{label:`camera clip`,detailKeys:[`node`,`nodeId`,`facing`,`duration`,`durationMs`]},screen_record:{label:`screen record`,detailKeys:[`node`,`nodeId`,`duration`,`durationMs`,`fps`,`screenIndex`]}}},cron:{emoji:`⏰`,title:`Cron`,actions:{status:{label:`status`},list:{label:`list`},add:{label:`add`,detailKeys:[`job.name`,`job.id`,`job.schedule`,`job.cron`]},update:{label:`update`,detailKeys:[`id`]},remove:{label:`remove`,detailKeys:[`id`]},run:{label:`run`,detailKeys:[`id`]},runs:{label:`runs`,detailKeys:[`id`]},wake:{label:`wake`,detailKeys:[`text`,`mode`]}}},gateway:{emoji:`🔌`,title:`Gateway`,actions:{restart:{label:`restart`,detailKeys:[`reason`,`delayMs`]}}},whatsapp_login:{emoji:`🟢`,title:`WhatsApp Login`,actions:{start:{label:`start`},wait:{label:`wait`}}},discord:{emoji:`💬`,title:`Discord`,actions:{react:{label:`react`,detailKeys:[`channelId`,`messageId`,`emoji`]},reactions:{label:`reactions`,detailKeys:[`channelId`,`messageId`]},sticker:{label:`sticker`,detailKeys:[`to`,`stickerIds`]},poll:{label:`poll`,detailKeys:[`question`,`to`]},permissions:{label:`permissions`,detailKeys:[`channelId`]},readMessages:{label:`read messages`,detailKeys:[`channelId`,`limit`]},sendMessage:{label:`send`,detailKeys:[`to`,`content`]},editMessage:{label:`edit`,detailKeys:[`channelId`,`messageId`]},deleteMessage:{label:`delete`,detailKeys:[`channelId`,`messageId`]},threadCreate:{label:`thread create`,detailKeys:[`channelId`,`name`]},threadList:{label:`thread list`,detailKeys:[`guildId`,`channelId`]},threadReply:{label:`thread reply`,detailKeys:[`channelId`,`content`]},pinMessage:{label:`pin`,detailKeys:[`channelId`,`messageId`]},unpinMessage:{label:`unpin`,detailKeys:[`channelId`,`messageId`]},listPins:{label:`list pins`,detailKeys:[`channelId`]},searchMessages:{label:`search`,detailKeys:[`guildId`,`content`]},memberInfo:{label:`member`,detailKeys:[`guildId`,`userId`]},roleInfo:{label:`roles`,detailKeys:[`guildId`]},emojiList:{label:`emoji list`,detailKeys:[`guildId`]},roleAdd:{label:`role add`,detailKeys:[`guildId`,`userId`,`roleId`]},roleRemove:{label:`role remove`,detailKeys:[`guildId`,`userId`,`roleId`]},channelInfo:{label:`channel`,detailKeys:[`channelId`]},channelList:{label:`channels`,detailKeys:[`guildId`]},voiceStatus:{label:`voice`,detailKeys:[`guildId`,`userId`]},eventList:{label:`events`,detailKeys:[`guildId`]},eventCreate:{label:`event create`,detailKeys:[`guildId`,`name`]},timeout:{label:`timeout`,detailKeys:[`guildId`,`userId`]},kick:{label:`kick`,detailKeys:[`guildId`,`userId`]},ban:{label:`ban`,detailKeys:[`guildId`,`userId`]}}}}};function sd(e){return e&&typeof e==`object`?e:void 0}function cd(e){return(e??`tool`).trim()}function ld(e){let t=e.replace(/_/g,` `).trim();return t?t.split(/\s+/).map(e=>e.length<=2&&e.toUpperCase()===e?e:`${e.at(0)?.toUpperCase()??``}${e.slice(1)}`).join(` `):`Tool`}function ud(e){let t=e?.trim();if(t)return t.replace(/_/g,` `)}function dd(e){if(!e||typeof e!=`object`)return;let t=e.action;if(typeof t==`string`)return t.trim()||void 0}function fd(e){return Wd({toolKey:e.toolKey,args:e.args,meta:e.meta,action:dd(e.args),spec:e.spec,fallbackDetailKeys:e.fallbackDetailKeys,detailMode:e.detailMode,detailCoerce:e.detailCoerce,detailMaxEntries:e.detailMaxEntries,detailFormatKey:e.detailFormatKey})}function pd(e,t={}){let n=t.maxStringChars??160,r=t.maxArrayEntries??3;if(e!=null){if(typeof e==`string`){let t=e.trim();if(!t)return;let r=t.split(/\r?\n/)[0]?.trim()??``;return r?r.length>n?`${r.slice(0,Math.max(0,n-3))}…`:r:void 0}if(typeof e==`boolean`)return!e&&!t.includeFalse?void 0:e?`true`:`false`;if(typeof e==`number`)return Number.isFinite(e)?e===0&&!t.includeZero?void 0:String(e):t.includeNonFinite?String(e):void 0;if(Array.isArray(e)){let n=e.map(e=>pd(e,t)).filter(e=>!!e);if(n.length===0)return;let i=n.slice(0,r).join(`, `);return n.length>r?`${i}…`:i}}}function md(e,t){if(!e||typeof e!=`object`)return;let n=e;for(let e of t.split(`.`)){if(!e||!n||typeof n!=`object`)return;n=n[e]}return n}function hd(e){let t=sd(e);if(t)for(let e of[t.path,t.file_path,t.filePath]){if(typeof e!=`string`)continue;let t=e.trim();if(t)return t}}function gd(e){let t=sd(e);if(!t)return;let n=hd(t);if(!n)return;let r=typeof t.offset==`number`&&Number.isFinite(t.offset)?Math.floor(t.offset):void 0,i=typeof t.limit==`number`&&Number.isFinite(t.limit)?Math.floor(t.limit):void 0,a=r===void 0?void 0:Math.max(1,r),o=i===void 0?void 0:Math.max(1,i);return a!==void 0&&o!==void 0?`${o===1?`line`:`lines`} ${a}-${a+o-1} from ${n}`:a===void 0?o===void 0?`from ${n}`:`first ${o} ${o===1?`line`:`lines`} of ${n}`:`from line ${a} in ${n}`}function _d(e,t){let n=sd(t);if(!n)return;let r=hd(n)??(typeof n.url==`string`?n.url.trim():void 0);if(!r)return;if(e===`attach`)return`from ${r}`;let i=e===`edit`?`in`:`to`,a=typeof n.content==`string`?n.content:typeof n.newText==`string`?n.newText:typeof n.new_string==`string`?n.new_string:void 0;return a&&a.length>0?`${i} ${r} (${a.length} chars)`:`${i} ${r}`}function vd(e){let t=sd(e);if(!t)return;let n=typeof t.query==`string`?t.query.trim():void 0,r=typeof t.count==`number`&&Number.isFinite(t.count)&&t.count>0?Math.floor(t.count):void 0;if(n)return r===void 0?`for "${n}"`:`for "${n}" (top ${r})`}function yd(e){let t=sd(e);if(!t)return;let n=typeof t.url==`string`?t.url.trim():void 0;if(!n)return;let r=typeof t.extractMode==`string`?t.extractMode.trim():void 0,i=typeof t.maxChars==`number`&&Number.isFinite(t.maxChars)&&t.maxChars>0?Math.floor(t.maxChars):void 0,a=[r?`mode ${r}`:void 0,i===void 0?void 0:`max ${i} chars`].filter(e=>!!e).join(`, `);return a?`from ${n} (${a})`:`from ${n}`}function bd(e){if(!e)return e;let t=e.trim();return t.length>=2&&(t.startsWith(`"`)&&t.endsWith(`"`)||t.startsWith(`'`)&&t.endsWith(`'`))?t.slice(1,-1).trim():t}function xd(e,t=48){if(!e)return[];let n=[],r=``,i,a=!1;for(let o=0;o<e.length;o+=1){let s=e[o];if(a){r+=s,a=!1;continue}if(s===`\\`){a=!0;continue}if(i){s===i?i=void 0:r+=s;continue}if(s===`"`||s===`'`){i=s;continue}if(/\s/.test(s)){if(!r)continue;if(n.push(r),n.length>=t)return n;r=``;continue}r+=s}return r&&n.push(r),n}function Sd(e){if(!e)return;let t=bd(e)??e;return(t.split(/[/]/).at(-1)??t).trim().toLowerCase()}function Cd(e,t){let n=new Set(t);for(let r=0;r<e.length;r+=1){let i=e[r];if(i){if(n.has(i)){let t=e[r+1];if(t&&!t.startsWith(`-`))return t;continue}for(let e of t)if(e.startsWith(`--`)&&i.startsWith(`${e}=`))return i.slice(e.length+1)}}}function wd(e,t=1,n=[]){let r=[],i=new Set(n);for(let n=t;n<e.length;n+=1){let t=e[n];if(t){if(t===`--`){for(let t=n+1;t<e.length;t+=1){let n=e[t];n&&r.push(n)}break}if(t.startsWith(`--`)){if(t.includes(`=`))continue;i.has(t)&&(n+=1);continue}if(t.startsWith(`-`)){i.has(t)&&(n+=1);continue}r.push(t)}}return r}function Td(e,t=1,n=[]){return wd(e,t,n)[0]}function Ed(e){if(e.length===0)return e;let t=0;if(Sd(e[0])===`env`){for(t=1;t<e.length;){let n=e[t];if(!n)break;if(n.startsWith(`-`)){t+=1;continue}if(/^[A-Za-z_][A-Za-z0-9_]*=/.test(n)){t+=1;continue}break}return e.slice(t)}for(;t<e.length&&/^[A-Za-z_][A-Za-z0-9_]*=/.test(e[t]);)t+=1;return e.slice(t)}function Dd(e){let t=xd(e,10);if(t.length<3)return e;let n=Sd(t[0]);if(!(n===`bash`||n===`sh`||n===`zsh`||n===`fish`))return e;let r=t.findIndex((e,t)=>t>0&&(e===`-c`||e===`-lc`||e===`-ic`));if(r===-1)return e;let i=t.slice(r+1).join(` `).trim();return i?bd(i)??e:e}function Od(e,t){let n,r=!1;for(let i=0;i<e.length;i+=1){let a=e[i];if(r){r=!1;continue}if(a===`\\`){r=!0;continue}if(n){a===n&&(n=void 0);continue}if(a===`"`||a===`'`){n=a;continue}if(t(a,i)===!1)return}}function kd(e){let t=[],n=0;return Od(e,(r,i)=>r===`;`?(t.push(e.slice(n,i)),n=i+1,!0):(r===`&`||r===`|`)&&e[i+1]===r?(t.push(e.slice(n,i)),n=i+2,!0):!0),t.push(e.slice(n)),t.map(e=>e.trim()).filter(e=>e.length>0)}function Ad(e){let t=[],n=0;return Od(e,(r,i)=>(r===`|`&&e[i-1]!==`|`&&e[i+1]!==`|`&&(t.push(e.slice(n,i)),n=i+1),!0)),t.push(e.slice(n)),t.map(e=>e.trim()).filter(e=>e.length>0)}function jd(e){let t=xd(e,3),n=Sd(t[0]);if(n===`cd`||n===`pushd`)return t[1]||void 0}function Md(e){let t=Sd(xd(e,2)[0]);return t===`cd`||t===`pushd`||t===`popd`}function Nd(e){return Sd(xd(e,2)[0])===`popd`}function Pd(e){let t=e.trim(),n;for(let e=0;e<4;e+=1){let r;Od(t,(e,n)=>{if(e===`&`&&t[n+1]===`&`)return r={index:n,length:2},!1;if(e===`|`&&t[n+1]===`|`)return r={index:n,length:2,isOr:!0},!1;if(e===`;`||e===`
`)return r={index:n,length:1},!1});let i=(r?t.slice(0,r.index):t).trim(),a=(r?!r.isOr:e>0)&&Md(i);if(!(i.startsWith(`set `)||i.startsWith(`export `)||i.startsWith(`unset `)||a)||(a&&(n=Nd(i)?void 0:jd(i)??n),t=r?t.slice(r.index+r.length).trimStart():``,!t))break}return{command:t.trim(),chdirPath:n}}function Fd(e){if(e.length===0)return`run command`;let t=Sd(e[0])??`command`;if(t===`git`){let t=new Set([`-C`,`-c`,`--git-dir`,`--work-tree`,`--namespace`,`--config-env`]),n=Cd(e,[`-C`]),r;for(let n=1;n<e.length;n+=1){let i=e[n];if(i){if(i===`--`){r=Td(e,n+1);break}if(i.startsWith(`--`)){if(i.includes(`=`))continue;t.has(i)&&(n+=1);continue}if(i.startsWith(`-`)){t.has(i)&&(n+=1);continue}r=i;break}}let i={status:`check git status`,diff:`check git diff`,log:`view git history`,show:`show git object`,branch:`list git branches`,checkout:`switch git branch`,switch:`switch git branch`,commit:`create git commit`,pull:`pull git changes`,push:`push git changes`,fetch:`fetch git changes`,merge:`merge git changes`,rebase:`rebase git branch`,add:`stage git changes`,restore:`restore git files`,reset:`reset git state`,stash:`stash git changes`};return r&&i[r]?i[r]:!r||r.startsWith(`/`)||r.startsWith(`~`)||r.includes(`/`)?n?`run git command in ${n}`:`run git command`:`run git ${r}`}if(t===`grep`||t===`rg`||t===`ripgrep`){let t=wd(e,1,[`-e`,`--regexp`,`-f`,`--file`,`-m`,`--max-count`,`-A`,`--after-context`,`-B`,`--before-context`,`-C`,`--context`]),n=Cd(e,[`-e`,`--regexp`])??t[0],r=t.length>1?t.at(-1):void 0;return n?r?`search "${n}" in ${r}`:`search "${n}"`:`search text`}if(t===`find`){let t=e[1]&&!e[1].startsWith(`-`)?e[1]:`.`,n=Cd(e,[`-name`,`-iname`]);return n?`find files named "${n}" in ${t}`:`find files in ${t}`}if(t===`ls`){let t=Td(e,1);return t?`list files in ${t}`:`list files`}if(t===`head`||t===`tail`){let n=Cd(e,[`-n`,`--lines`])??e.slice(1).find(e=>/^-\d+$/.test(e))?.slice(1),r=wd(e,1,[`-n`,`--lines`]),i=r.at(-1);i&&/^\d+$/.test(i)&&r.length===1&&(i=void 0);let a=t===`head`?`first`:`last`,o=n===`1`?`line`:`lines`;return n&&i?`show ${a} ${n} ${o} of ${i}`:n?`show ${a} ${n} ${o}`:i?`show ${i}`:`show ${t} output`}if(t===`cat`){let t=Td(e,1);return t?`show ${t}`:`show output`}if(t===`sed`){let t=Cd(e,[`-e`,`--expression`]),n=wd(e,1,[`-e`,`--expression`,`-f`,`--file`]),r=t??n[0],i=t?n[0]:n[1];if(r){let e=(bd(r)??r).replace(/\s+/g,``),t=e.match(/^([0-9]+),([0-9]+)p$/);if(t)return i?`print lines ${t[1]}-${t[2]} from ${i}`:`print lines ${t[1]}-${t[2]}`;let n=e.match(/^([0-9]+)p$/);if(n)return i?`print line ${n[1]} from ${i}`:`print line ${n[1]}`}return i?`run sed on ${i}`:`run sed transform`}if(t===`printf`||t===`echo`)return`print text`;if(t===`cp`||t===`mv`){let n=wd(e,1,[`-t`,`--target-directory`,`-S`,`--suffix`]),r=n[0],i=n[1],a=t===`cp`?`copy`:`move`;return r&&i?`${a} ${r} to ${i}`:r?`${a} ${r}`:`${a} files`}if(t===`rm`){let t=Td(e,1);return t?`remove ${t}`:`remove files`}if(t===`mkdir`){let t=Td(e,1);return t?`create folder ${t}`:`create folder`}if(t===`touch`){let t=Td(e,1);return t?`create file ${t}`:`create file`}if(t===`curl`||t===`wget`){let t=e.find(e=>/^https?:\/\//i.test(e));return t?`fetch ${t}`:`fetch url`}if(t===`npm`||t===`pnpm`||t===`yarn`||t===`bun`){let n=wd(e,1,[`--prefix`,`-C`,`--cwd`,`--config`]),r=n[0]??`command`;return{install:`install dependencies`,test:`run tests`,build:`run build`,start:`start app`,lint:`run lint`,run:n[1]?`run ${n[1]}`:`run script`}[r]??`run ${t} ${r}`}if(t===`node`||t===`python`||t===`python3`||t===`ruby`||t===`php`){if(e.slice(1).find(e=>e.startsWith(`<<`)))return`run ${t} inline script (heredoc)`;if((t===`node`?Cd(e,[`-e`,`--eval`]):t===`python`||t===`python3`?Cd(e,[`-c`]):void 0)!==void 0)return`run ${t} inline script`;let n=Td(e,1,t===`node`?[`-e`,`--eval`,`-m`]:[`-c`,`-e`,`--eval`,`-m`]);return n?t===`node`?`${e.includes(`--check`)||e.includes(`-c`)?`check js syntax for`:`run node script`} ${n}`:`run ${t} ${n}`:`run ${t}`}if(t===`openclaw`){let t=Td(e,1);return t?`run openclaw ${t}`:`run openclaw`}let n=Td(e,1);return!n||n.length>48?`run ${t}`:/^[A-Za-z0-9._/-]+$/.test(n)?`run ${t} ${n}`:`run ${t}`}function Id(e){let t=Ad(e);return t.length>1?`${Fd(Ed(xd(t[0])))} -> ${Fd(Ed(xd(t[t.length-1])))}${t.length>2?` (+${t.length-2} steps)`:``}`:Fd(Ed(xd(e)))}function Ld(e){let{command:t,chdirPath:n}=Pd(e);if(!t)return n?{text:``,chdirPath:n}:void 0;let r=kd(t);if(r.length===0)return;let i=r.map(e=>Id(e));return{text:i.length===1?i[0]:i.join(` → `),chdirPath:n,allGeneric:i.every(e=>zd(e))}}var Rd=`check git.view git.show git.list git.switch git.create git.pull git.push git.fetch git.merge git.rebase git.stage git.restore git.reset git.stash git.search .find files.list files.show first.show last.print line.print text.copy .move .remove .create folder.create file.fetch http.install dependencies.run tests.run build.start app.run lint.run openclaw.run node script.run node .run python.run ruby.run php.run sed.run git .run npm .run pnpm .run yarn .run bun .check js syntax`.split(`.`);function zd(e){return e===`run command`?!0:e.startsWith(`run `)?!Rd.some(t=>e.startsWith(t)):!1}function Bd(e,t=120){let n=e.replace(/\s*\n\s*/g,` `).replace(/\s{2,}/g,` `).trim();return n.length<=t?n:`${n.slice(0,Math.max(0,t-1))}…`}function Vd(e){let t=sd(e);if(!t)return;let n=typeof t.command==`string`?t.command.trim():void 0;if(!n)return;let r=Dd(n),i=Ld(r)??Ld(n),a=i?.text||`run command`,o=(typeof t.workdir==`string`?t.workdir:typeof t.cwd==`string`?t.cwd:void 0)?.trim()||i?.chdirPath||void 0,s=Bd(r);if(i?.allGeneric!==!1&&zd(a))return o?`${s} (in ${o})`:s;let c=o?`${a} (in ${o})`:a;return s&&s!==c&&s!==a?`${c} · \`${s}\``:c}function Hd(e,t){if(!(!e||!t))return e.actions?.[t]??void 0}function Ud(e,t,n){if(n.mode===`first`){for(let r of t){let t=pd(md(e,r),n.coerce);if(t)return t}return}let r=[];for(let i of t){let t=pd(md(e,i),n.coerce);t&&r.push({label:n.formatKey?n.formatKey(i):i,value:t})}if(r.length===0)return;if(r.length===1)return r[0].value;let i=new Set,a=[];for(let e of r){let t=`${e.label}:${e.value}`;i.has(t)||(i.add(t),a.push(e))}if(a.length!==0)return a.slice(0,n.maxEntries??8).map(e=>`${e.label} ${e.value}`).join(` · `)}function Wd(e){let t=Hd(e.spec,e.action),n=e.toolKey===`web_search`?`search`:e.toolKey===`web_fetch`?`fetch`:e.toolKey.replace(/_/g,` `).replace(/\./g,` `),r=ud(t?.label??e.action??n),i;e.toolKey===`exec`&&(i=Vd(e.args)),!i&&e.toolKey===`read`&&(i=gd(e.args)),!i&&(e.toolKey===`write`||e.toolKey===`edit`||e.toolKey===`attach`)&&(i=_d(e.toolKey,e.args)),!i&&e.toolKey===`web_search`&&(i=vd(e.args)),!i&&e.toolKey===`web_fetch`&&(i=yd(e.args));let a=t?.detailKeys??e.spec?.detailKeys??e.fallbackDetailKeys??[];return!i&&a.length>0&&(i=Ud(e.args,a,{mode:e.detailMode,coerce:e.detailCoerce,maxEntries:e.detailMaxEntries,formatKey:e.detailFormatKey})),!i&&e.meta&&(i=e.meta),{verb:r,detail:i}}function Gd(e,t={}){if(!e)return;let n=e.includes(` · `)?e.split(` · `).map(e=>e.trim()).filter(e=>e.length>0).join(`, `):e;if(n)return t.prefixWithWith?`with ${n}`:n}var Kd={"🧩":`puzzle`,"🛠️":`wrench`,"🧰":`wrench`,"📖":`fileText`,"✍️":`edit`,"📝":`penLine`,"📎":`paperclip`,"🌐":`globe`,"📺":`monitor`,"🧾":`fileText`,"🔐":`settings`,"💻":`monitor`,"🔌":`plug`,"💬":`messageSquare`},qd={icon:`messageSquare`,title:`Slack`,actions:{react:{label:`react`,detailKeys:[`channelId`,`messageId`,`emoji`]},reactions:{label:`reactions`,detailKeys:[`channelId`,`messageId`]},sendMessage:{label:`send`,detailKeys:[`to`,`content`]},editMessage:{label:`edit`,detailKeys:[`channelId`,`messageId`]},deleteMessage:{label:`delete`,detailKeys:[`channelId`,`messageId`]},readMessages:{label:`read messages`,detailKeys:[`channelId`,`limit`]},pinMessage:{label:`pin`,detailKeys:[`channelId`,`messageId`]},unpinMessage:{label:`unpin`,detailKeys:[`channelId`,`messageId`]},listPins:{label:`list pins`,detailKeys:[`channelId`]},memberInfo:{label:`member`,detailKeys:[`userId`]},emojiList:{label:`emoji list`}}};function Jd(e){return e?Kd[e]??`puzzle`:`puzzle`}function Yd(e){return{icon:Jd(e?.emoji),title:e?.title,label:e?.label,detailKeys:e?.detailKeys,actions:e?.actions}}var Xd=od,Zd=Yd(Xd.fallback??{emoji:`🧩`}),Qd=Object.fromEntries(Object.entries(Xd.tools??{}).map(([e,t])=>[e,Yd(t)]));Qd.slack=qd;function $d(e){if(!e)return e;for(let t of[{re:/^\/Users\/[^/]+(\/|$)/,replacement:`~$1`},{re:/^\/home\/[^/]+(\/|$)/,replacement:`~$1`},{re:/^C:\\Users\\[^\\]+(\\|$)/i,replacement:`~$1`}])if(t.re.test(e))return e.replace(t.re,t.replacement);return e}function ef(e){let t=cd(e.name),n=t.toLowerCase(),r=Qd[n],i=r?.icon??Zd.icon??`puzzle`,a=r?.title??ld(t),o=r?.label??a,{verb:s,detail:c}=fd({toolKey:n,args:e.args,meta:e.meta,spec:r,fallbackDetailKeys:Zd.detailKeys,detailMode:`first`,detailCoerce:{includeFalse:!0,includeZero:!0}});return c&&=$d(c),{name:t,icon:i,title:a,label:o,verb:s,detail:c}}function tf(e){return Gd(e.detail,{prefixWithWith:!0})}function nf(e){let t=e.trim();if(t.startsWith(`{`)||t.startsWith(`[`))try{let e=JSON.parse(t);return"```json\n"+JSON.stringify(e,null,2)+"\n```"}catch{}return e}function rf(e){let t=e.split(`
`),n=t.slice(0,2),r=n.join(`
`);return r.length>100?r.slice(0,100)+`…`:n.length<t.length?r+`…`:r}function af(e){let t=e,n=sf(t.content),r=[];for(let e of n){let t=(typeof e.type==`string`?e.type:``).toLowerCase();([`toolcall`,`tool_call`,`tooluse`,`tool_use`].includes(t)||typeof e.name==`string`&&e.arguments!=null)&&r.push({kind:`call`,name:e.name??`tool`,args:cf(e.arguments??e.args)})}for(let e of n){let t=(typeof e.type==`string`?e.type:``).toLowerCase();if(t!==`toolresult`&&t!==`tool_result`)continue;let n=lf(e),i=typeof e.name==`string`?e.name:`tool`;r.push({kind:`result`,name:i,text:n})}if(Ju(e)&&!r.some(e=>e.kind===`result`)){let n=typeof t.toolName==`string`&&t.toolName||typeof t.tool_name==`string`&&t.tool_name||`tool`,i=Lo(e)??void 0;r.push({kind:`result`,name:n,text:i})}return r}function of(e,t){let r=ef({name:e.name,args:e.args}),a=tf(r),o=!!e.text?.trim(),s=!!t,c=s?()=>{if(o){t(nf(e.text));return}t(`## ${r.label}\n\n${a?`**Command:** \`${a}\`\n\n`:``}*No output — tool completed successfully.*`)}:void 0,l=o&&(e.text?.length??0)<=80,u=o&&!l,d=o&&l,f=!o;return n`
    <div
    ...
    >
      ...
      ${f?n`
            ...
            `:i}
      ${u?n`<div class="chat-tool-card__preview mono">${rf(e.text)}</div>`:i}
      ${d?n`<div class="chat-tool-card__inline mono">${e.text}</div>`:i}
    </div>
  `}function sf(e){return Array.isArray(e)?e.filter(Boolean):[]}function cf(e){if(typeof e!=`string`)return e;let t=e.trim();if(!t||!t.startsWith(`{`)&&!t.startsWith(`[`))return e;try{return JSON.parse(t)}catch{return e}}function lf(e){if(typeof e.text==`string`)return e.text;if(typeof e.content==`string`)return e.content}function uf(e){let t=e.content,n=[];if(Array.isArray(t))for(let e of t){if(typeof e!=`object`||!e)continue;let t=e;if(t.type===`image`){let e=t.source;if(e?.type===`base64`&&typeof e.data==`string`){let t=e.data,r=e.media_type||`image/png`,i=t.startsWith(`data:`)?t:`data:${r};base64,${t}`;n.push({url:i})}else typeof t.url==`string`&&n.push({url:t.url})}else if(t.type===`image_url`){let e=t.image_url;typeof e?.url==`string`&&n.push({url:e.url})}}return n}function df(e,t){return n`
  ...
  `}function ff(e,t,r,i,a){let o=new Date(t).toLocaleTimeString([],{hour:`numeric`,minute:`2-digit`}),s=i?.name??`Assistant`;return n`
    <div class="chat-group assistant">
      ${Sf(`assistant`,i,a)}
      <div class="chat-group-messages">
        ${Af({role:`assistant`,content:[{type:`text`,text:e}],timestamp:t},{isStreaming:!0,showReasoning:!1},r)}
  ...
  `}function pf(e,t){let r=qu(e.role),a=t.assistantName??`Assistant`,o=e.senderLabel?.trim(),s=r===`user`?o??`You`:r===`assistant`?a:r===`tool`?`Tool`:r,c=r===`user`?`user`:r===`assistant`?`assistant`:r===`tool`?`tool`:`other`,l=new Date(e.timestamp).toLocaleTimeString([],{hour:`numeric`,minute:`2-digit`}),u=mf(e,t.contextWindow??null);return n`
    <div class="chat-group ${c}">
      ${Sf(e.role,{name:a,avatar:t.assistantAvatar??null},t.basePath)}
      <div class="chat-group-messages">
        ${e.messages.map((n,r)=>Af(n.message,{isStreaming:e.isStreaming&&r===e.messages.length-1,showReasoning:t.showReasoning,showToolCalls:t.showToolCalls??!0},t.onOpenSidebar))}
        <div class="chat-group-footer">
          <span class="chat-sender-name">${s}</span>
          <span class="chat-group-timestamp">${l}</span>
          ${gf(u)}
          ${r===`assistant`&&ed()?xf(e):i}
          ${t.onDelete?bf(t.onDelete,r===`user`?`left`:`right`):i}
        </div>
      </div>
    </div>
  `}function mf(e,t){let n=0,r=0,i=0,a=0,o=0,s=null,c=!1;for(let{message:t}of e.messages){let e=t;if(e.role!==`assistant`)continue;let l=e.usage;l&&(c=!0,n+=l.input??l.inputTokens??0,r+=l.output??l.outputTokens??0,i+=l.cacheRead??l.cache_read_input_tokens??0,a+=l.cacheWrite??l.cache_creation_input_tokens??0);let u=e.cost;u?.total&&(o+=u.total),typeof e.model==`string`&&e.model!==`gateway-injected`&&(s=e.model)}if(!c&&!s)return null;let l=t&&n>0?Math.min(Math.round(n/t*100),100):null;return{input:n,output:r,cacheRead:i,cacheWrite:a,cost:o,model:s,contextPercent:l}}function hf(e){return e>=1e6?`${(e/1e6).toFixed(1).replace(/\.0$/,``)}M`:e>=1e3?`${(e/1e3).toFixed(1).replace(/\.0$/,``)}k`:String(e)}function gf(e){if(!e)return i;let t=[];if(e.input&&t.push(n`<span class="msg-meta__tokens">↑${hf(e.input)}</span>`),e.output&&t.push(n`<span class="msg-meta__tokens">↓${hf(e.output)}</span>`),e.cacheRead&&t.push(n`<span class="msg-meta__cache">R${hf(e.cacheRead)}</span>`),e.cacheWrite&&t.push(n`<span class="msg-meta__cache">W${hf(e.cacheWrite)}</span>`),e.cost>0&&t.push(n`<span class="msg-meta__cost">$${e.cost.toFixed(4)}</span>`),e.contextPercent!==null){let r=e.contextPercent,i=r>=90?`msg-meta__ctx msg-meta__ctx--danger`:r>=75?`msg-meta__ctx msg-meta__ctx--warn`:`msg-meta__ctx`;t.push(n`<span class="${i}">${r}% ctx</span>`)}if(e.model){let r=e.model.includes(`/`)?e.model.split(`/`).pop():e.model;t.push(n`<span class="msg-meta__model">${r}</span>`)}return t.length===0?i:n`<span class="msg-meta">${t}</span>`}function _f(e){let t=[];for(let{message:n}of e.messages){let e=Lo(n);e?.trim()&&t.push(e.trim())}return t.join(`

`)}var vf=`openclaw:skipDeleteConfirm`;function yf(){try{return E()?.getItem(vf)===`1`}catch{return!1}}function bf(e,t){return n`
    <span class="chat-delete-wrap">
      <button
        class="chat-group-delete"
        title="Delete"
        aria-label="Delete message"
        @click=${n=>{if(yf()){e();return}let r=n.currentTarget,i=r.closest(`.chat-delete-wrap`),a=i?.querySelector(`.chat-delete-confirm`);if(a){a.remove();return}let o=document.createElement(`div`);o.className=`chat-delete-confirm chat-delete-confirm--${t}`,o.innerHTML=`
          ...
          `,i.appendChild(o);let s=o.querySelector(`.chat-delete-confirm__cancel`),c=o.querySelector(`.chat-delete-confirm__yes`),l=o.querySelector(`.chat-delete-confirm__check`);s.addEventListener(`click`,()=>o.remove()),c.addEventListener(`click`,()=>{if(l.checked)try{E()?.setItem(vf,`1`)}catch{}o.remove(),e()});let u=e=>{!o.contains(e.target)&&e.target!==r&&(o.remove(),document.removeEventListener(`click`,u,!0))};requestAnimationFrame(()=>document.addEventListener(`click`,u,!0))}}
      >${W.trash??W.x}</button>
    </span>
  `}function xf(e){return n`
    <button
      class="chat-tts-btn"
      type="button"
      title=${id()?`Stop speaking`:`Read aloud`}
      aria-label=${id()?`Stop speaking`:`Read aloud`}
      @click=${t=>{let n=t.currentTarget;if(id()){rd(),n.classList.remove(`chat-tts-btn--active`),n.title=`Read aloud`;return}let r=_f(e);r&&(n.classList.add(`chat-tts-btn--active`),n.title=`Stop speaking`,nd(r,{onEnd:()=>{n.isConnected&&(n.classList.remove(`chat-tts-btn--active`),n.title=`Read aloud`)},onError:()=>{n.isConnected&&(n.classList.remove(`chat-tts-btn--active`),n.title=`Read aloud`)}}))}}
    >
      ${W.volume2}
    </button>
  `}function Sf(e,t,r){let i=qu(e),a=t?.name?.trim()||`Assistant`,o=t?.avatar?.trim()||``,s=i===`user`?n`
        ...
        `:i===`assistant`?n`
          ...
          `:i===`tool`?n`
            ...
            `,c=i===`user`?`user`:i===`assistant`?`assistant`:i===`tool`?`tool`:`other`;return o&&i===`assistant`?Cf(o)?n`<img
        class="chat-avatar ${c}"
        src="${o}"
        alt="${a}"
      />`:n`<img
    ...
    />`:i===`assistant`&&r?n`<img
      ...
      src="${mu(r)}"
      alt="${a}"
    />`:n`<div class="chat-avatar ${c}">${s}</div>`}function Cf(e){return/^https?:\/\//i.test(e)||/^data:image\//i.test(e)||e.startsWith(`/`)}function wf(e){if(e.length===0)return i;let t=e=>{Kl(e,{allowDataImage:!0})};return n`
  ...
  `}function Tf(e,t){let r=e.filter(e=>e.kind===`call`),i=e.filter(e=>e.kind===`result`),a=Math.max(r.length,i.length)||e.length,o=[...new Set(e.map(e=>e.name))],s=o.length<=3?o.join(`, `):`${o.slice(0,2).join(`, `)} +${o.length-2} more`;return n`
  ...
  `}var Ef=2e4;function Df(e){let t=e.trim();if(t.length>Ef)return null;if(t.startsWith(`{`)&&t.endsWith(`}`)||t.startsWith(`[`)&&t.endsWith(`]`))try{let e=JSON.parse(t);return{parsed:e,pretty:JSON.stringify(e,null,2)}}catch{return null}return null}function Of(e){if(Array.isArray(e))return`Array (${e.length} item${e.length===1?``:`s`})`;if(e&&typeof e==`object`){let t=Object.keys(e);return t.length<=4?`{ ${t.join(`, `)} }`:`Object (${t.length} keys)`}return`JSON`}function kf(e,t){return n`
    <button
  ...
  `}function Af(e,t,r){let a=e,o=typeof a.role==`string`?a.role:`unknown`,s=qu(o),c=Ju(e)||o.toLowerCase()===`toolresult`||o.toLowerCase()===`tool_result`||typeof a.toolCallId==`string`||typeof a.tool_call_id==`string`,l=t.showToolCalls??!0?af(e):[],u=l.length>0,d=uf(e),f=d.length>0,p=Lo(e),m=t.showReasoning&&o===`assistant`?zo(e):null,h=p?.trim()?p:null,g=m?Vo(m):null,_=h,v=o===`assistant`&&!!_?.trim(),y=o===`assistant`&&!!(r&&_?.trim()),b=_&&!t.isStreaming?Df(_):null,x=[`chat-bubble`,t.isStreaming?`streaming`:``,`fade-in`].filter(Boolean).join(` `);if(!_&&u&&c)return Tf(l,r);let S=u&&(t.showToolCalls??!0);if(!_&&!S&&!f)return i;let C=s===`tool`||c,w=[...new Set(l.map(e=>e.name))],T=w.length<=3?w.join(`, `):`${w.slice(0,2).join(`, `)} +${w.length-2} more`,E=_&&!T?_.trim().replace(/\s+/g,` `).slice(0,120):``;return n`
    <div class="${x}">
      ...
      ${C?n`
            <details class="chat-tool-msg-collapse">
              ...
              <div class="chat-tool-msg-body">
                ${wf(d)}
                ${g?n`<div class="chat-thinking">${Go(Il(g))}</div>`:i}
                ${b?n`<details class="chat-json-collapse">
                        <summary class="chat-json-summary">
                          <span class="chat-json-badge">JSON</span>
                          <span class="chat-json-label">${Of(b.parsed)}</span>
                        </summary>
                        <pre class="chat-json-content"><code>${b.pretty}</code></pre>
                      </details>`:_?n`<div class="chat-text" dir="${Jl(_)}">${Go(Il(_))}</div>`:i}
                ${u?Tf(l,r):i}
              </div>
            </details>
          `:n`
  ...
  `}var jf=50,Mf=class{constructor(){this.items=[],this.cursor=-1}push(e){let t=e.trim();t&&this.items[this.items.length-1]!==t&&(this.items.push(t),this.items.length>jf&&this.items.shift(),this.cursor=-1)}up(){return this.items.length===0?null:(this.cursor<0?this.cursor=this.items.length-1:this.cursor>0&&this.cursor--,this.items[this.cursor]??null)}down(){return this.cursor<0?null:(this.cursor++,this.cursor>=this.items.length?(this.cursor=-1,null):this.items[this.cursor]??null)}reset(){this.cursor=-1}},Nf=`openclaw:pinned:`,Pf=class{constructor(e){this._indices=new Set,this.key=Nf+e,this.load()}get indices(){return this._indices}has(e){return this._indices.has(e)}pin(e){this._indices.add(e),this.save()}unpin(e){this._indices.delete(e),this.save()}toggle(e){this._indices.has(e)?this.unpin(e):this.pin(e)}clear(){this._indices.clear(),this.save()}load(){try{let e=E()?.getItem(this.key);if(!e)return;let t=JSON.parse(e);Array.isArray(t)&&(this._indices=new Set(t.filter(e=>typeof e==`number`)))}catch{}}save(){try{E()?.setItem(this.key,JSON.stringify([...this._indices]))}catch{}}};function Ff(e){return Lo(e)??``}function If(e,t){let n=t.trim().toLowerCase();return n?(Lo(e)??``).toLowerCase().includes(n):!0}function Lf(e,t,n){if(e.has(t)){let n=e.get(t);return e.delete(t),e.set(t,n),n}let r=n();for(e.set(t,r);e.size>20;){let t=e.keys().next().value;if(typeof t!=`string`)break;e.delete(t)}return r}var Rf=[{name:`new`,description:`Start a new session`,icon:`plus`,category:`session`,executeLocal:!0},{name:`reset`,description:`Reset current session`,icon:`refresh`,category:`session`,executeLocal:!0},{name:`compact`,description:`Compact session context`,icon:`loader`,category:`session`,executeLocal:!0},{name:`stop`,description:`Stop current run`,icon:`stop`,category:`session`,executeLocal:!0},{name:`clear`,description:`Clear chat history`,icon:`trash`,category:`session`,executeLocal:!0},{name:`focus`,description:`Toggle focus mode`,icon:`eye`,category:`session`,executeLocal:!0},{name:`model`,description:`Show or set model`,args:`<name>`,icon:`brain`,category:`model`,executeLocal:!0},{name:`think`,description:`Set thinking level`,args:`<level>`,icon:`brain`,category:`model`,executeLocal:!0,argOptions:[`off`,`low`,`medium`,`high`]},{name:`verbose`,description:`Toggle verbose mode`,args:`<on|off|full>`,icon:`terminal`,category:`model`,executeLocal:!0,argOptions:[`on`,`off`,`full`]},{name:`fast`,description:`Toggle fast mode`,args:`<status|on|off>`,icon:`zap`,category:`model`,executeLocal:!0,argOptions:[`status`,`on`,`off`]},{name:`help`,description:`Show available commands`,icon:`book`,category:`tools`,executeLocal:!0},{name:`status`,description:`Show session status`,icon:`barChart`,category:`tools`},{name:`export`,description:`Export session to Markdown`,icon:`download`,category:`tools`,executeLocal:!0},{name:`usage`,description:`Show token usage`,icon:`barChart`,category:`tools`,executeLocal:!0},{name:`agents`,description:`List agents`,icon:`monitor`,category:`agents`,executeLocal:!0},{name:`kill`,description:`Abort sub-agents`,args:`<id|all>`,icon:`x`,category:`agents`,executeLocal:!0},{name:`skill`,description:`Run a skill`,args:`<name>`,icon:`zap`,category:`tools`},{name:`steer`,description:`Steer a sub-agent`,args:`<id> <msg>`,icon:`send`,category:`agents`}],zf=[`session`,`model`,`tools`,`agents`],Bf={session:`Session`,model:`Model`,agents:`Agents`,tools:`Tools`};function Vf(e){let t=e.toLowerCase();return(t?Rf.filter(e=>e.name.startsWith(t)||e.description.toLowerCase().includes(t)):Rf).toSorted((e,n)=>{let r=zf.indexOf(e.category??`session`),i=zf.indexOf(n.category??`session`);if(r!==i)return r-i;if(t){let r=e.name.startsWith(t)?0:1,i=n.name.startsWith(t)?0:1;if(r!==i)return r-i}return 0})}function Hf(e){let t=e.trim();if(!t.startsWith(`/`))return null;let n=t.slice(1),r=n.search(/[\s:]/u),i=r===-1?n:n.slice(0,r),a=r===-1?``:n.slice(r).trimStart();a.startsWith(`:`)&&(a=a.slice(1).trimStart());let o=a.trim();if(!i)return null;let s=Rf.find(e=>e.name===i.toLowerCase());return s?{command:s,args:o}:null}function Uf(e){return n`
    <div class="sidebar-panel">
      ...
      <div class="sidebar-content">
        ${e.error?n`
            ...
            `:e.content?n`<div class="sidebar-markdown">${Go(Il(e.content))}</div>`:n`
                  <div class="muted">No content available</div>
                `}
      </div>
    </div>
  `}function J(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var Wf=class extends c{constructor(...e){super(...e),this.splitRatio=.6,this.minRatio=.4,this.maxRatio=.7,this.isDragging=!1,this.startX=0,this.startRatio=0,this.handleMouseDown=e=>{this.isDragging=!0,this.startX=e.clientX,this.startRatio=this.splitRatio,this.classList.add(`dragging`),document.addEventListener(`mousemove`,this.handleMouseMove),document.addEventListener(`mouseup`,this.handleMouseUp),e.preventDefault()},this.handleMouseMove=e=>{if(!this.isDragging)return;let t=this.parentElement;if(!t)return;let n=t.getBoundingClientRect().width,r=(e.clientX-this.startX)/n,i=this.startRatio+r;i=Math.max(this.minRatio,Math.min(this.maxRatio,i)),this.dispatchEvent(new CustomEvent(`resize`,{detail:{splitRatio:i},bubbles:!0,composed:!0}))},this.handleMouseUp=()=>{this.isDragging=!1,this.classList.remove(`dragging`),document.removeEventListener(`mousemove`,this.handleMouseMove),document.removeEventListener(`mouseup`,this.handleMouseUp)}}static{this.styles=r`
    :host {
      width: 4px;
      cursor: col-resize;
  ...
  `}render(){return i}connectedCallback(){super.connectedCallback(),this.addEventListener(`mousedown`,this.handleMouseDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`mousedown`,this.handleMouseDown),document.removeEventListener(`mousemove`,this.handleMouseMove),document.removeEventListener(`mouseup`,this.handleMouseUp)}};J([x({type:Number})],Wf.prototype,`splitRatio`,void 0),J([x({type:Number})],Wf.prototype,`minRatio`,void 0),J([x({type:Number})],Wf.prototype,`maxRatio`,void 0),Wf=J([v(`resizable-divider`)],Wf);var Gf=5e3,Kf=8e3,qf=new Map,Jf=new Map,Yf=new Map;function Xf(e){return Lf(qf,e,()=>new Mf)}function Zf(e){return Lf(Jf,e,()=>new Pf(e))}function Qf(e){return Lf(Yf,e,()=>new xo(e))}function $f(){return{sttRecording:!1,sttInterimText:``,slashMenuOpen:!1,slashMenuItems:[],slashMenuIndex:0,slashMenuMode:`command`,slashMenuCommand:null,slashMenuArgItems:[],searchOpen:!1,searchQuery:``,pinnedExpanded:!1}}var Y=$f();function ep(){Y.sttRecording&&$u(),Object.assign(Y,$f())}function tp(e){e.style.height=`auto`,e.style.height=`${Math.min(e.scrollHeight,150)}px`}function np(e){return e?e.active?n`
      <div class="compaction-indicator compaction-indicator--active" role="status" aria-live="polite">
        ${W.loader} Compacting context...
      </div>
    `:e.completedAt&&Date.now()-e.completedAt<Gf?n`
        <div class="compaction-indicator compaction-indicator--complete" role="status" aria-live="polite">
          ${W.check} Context compacted
        </div>
      `:i:i}function rp(e){if(!e)return i;let t=e.phase??`active`;if(Date.now()-e.occurredAt>=Kf)return i;let r=[`Selected: ${e.selected}`,t===`cleared`?`Active: ${e.selected}`:`Active: ${e.active}`,t===`cleared`&&e.previous?`Previous fallback: ${e.previous}`:null,e.reason?`Reason: ${e.reason}`:null,e.attempts.length>0?`Attempts: ${e.attempts.slice(0,3).join(` | `)}`:null].filter(Boolean).join(` • `),a=t===`cleared`?`Fallback cleared: ${e.selected}`:`Fallback active: ${e.active}`;return n`
  ...
  `}function ip(e){let t=e.trim().replace(/^#/,``);return/^[0-9a-fA-F]{6}$/.test(t)?[parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16)]:null}var ap=null;function op(){if(ap)return ap;let e=getComputedStyle(document.documentElement),t=e.getPropertyValue(`--warn`).trim()||`#f59e0b`,n=e.getPropertyValue(`--danger`).trim()||`#ef4444`;return ap={warnHex:t,dangerHex:n,warnRgb:ip(t)??[245,158,11],dangerRgb:ip(n)??[239,68,68]},ap}function sp(e,t){if(e?.totalTokensFresh===!1)return i;let r=e?.totalTokens??0,a=e?.contextTokens??t??0;if(!r||!a)return i;let o=r/a;if(o<.85)return i;let s=Math.min(Math.round(o*100),100),{warnRgb:c,dangerRgb:l}=op(),[u,d,f]=c,[p,m,h]=l,g=Math.min(Math.max((o-.85)/.1,0),1),_=Math.round(u+(p-u)*g),v=Math.round(d+(m-d)*g),y=Math.round(f+(h-f)*g);return n`
    <div class="context-notice" role="status" style="--ctx-color:${`rgb(${_}, ${v}, ${y})`};--ctx-bg:${`rgba(${_}, ${v}, ${y}, ${.08+.08*g})`}">
      ...
      <span class="context-notice__detail">${cp(r)} / ${cp(a)}</span>
    </div>
  `}function cp(e){return e>=1e6?`${(e/1e6).toFixed(1).replace(/\.0$/,``)}M`:e>=1e3?`${(e/1e3).toFixed(1).replace(/\.0$/,``)}k`:String(e)}function lp(){return`att-${Date.now()}-${Math.random().toString(36).slice(2,9)}`}function up(e,t){let n=e.clipboardData?.items;if(!n||!t.onAttachmentsChange)return;let r=[];for(let e=0;e<n.length;e++){let t=n[e];t.type.startsWith(`image/`)&&r.push(t)}if(r.length!==0){e.preventDefault();for(let e of r){let n=e.getAsFile();if(!n)continue;let r=new FileReader;r.addEventListener(`load`,()=>{let e=r.result,i={id:lp(),dataUrl:e,mimeType:n.type},a=t.attachments??[];t.onAttachmentsChange?.([...a,i])}),r.readAsDataURL(n)}}}function dp(e,t){let n=e.target;if(!n.files||!t.onAttachmentsChange)return;let r=t.attachments??[],i=[],a=0;for(let e of n.files){if(!yo(e.type))continue;a++;let n=new FileReader;n.addEventListener(`load`,()=>{i.push({id:lp(),dataUrl:n.result,mimeType:e.type}),a--,a===0&&t.onAttachmentsChange?.([...r,...i])}),n.readAsDataURL(e)}n.value=``}function fp(e,t){e.preventDefault();let n=e.dataTransfer?.files;if(!n||!t.onAttachmentsChange)return;let r=t.attachments??[],i=[],a=0;for(let e of n){if(!yo(e.type))continue;a++;let n=new FileReader;n.addEventListener(`load`,()=>{i.push({id:lp(),dataUrl:n.result,mimeType:e.type}),a--,a===0&&t.onAttachmentsChange?.([...r,...i])}),n.readAsDataURL(e)}}function pp(e){let t=e.attachments??[];return t.length===0?i:n`
  ...
  `}function mp(){Y.slashMenuMode=`command`,Y.slashMenuCommand=null,Y.slashMenuArgItems=[],Y.slashMenuItems=[]}function hp(e,t){let n=e.match(/^\/(\S+)\s(.*)$/);if(n){let e=n[1].toLowerCase(),r=n[2].toLowerCase(),i=Rf.find(t=>t.name===e);if(i?.argOptions?.length){let e=r?i.argOptions.filter(e=>e.toLowerCase().startsWith(r)):i.argOptions;if(e.length>0){Y.slashMenuMode=`args`,Y.slashMenuCommand=i,Y.slashMenuArgItems=e,Y.slashMenuOpen=!0,Y.slashMenuIndex=0,Y.slashMenuItems=[],t();return}}Y.slashMenuOpen=!1,mp(),t();return}let r=e.match(/^\/(\S*)$/);if(r){let e=Vf(r[1]);Y.slashMenuItems=e,Y.slashMenuOpen=e.length>0,Y.slashMenuIndex=0,Y.slashMenuMode=`command`,Y.slashMenuCommand=null,Y.slashMenuArgItems=[]}else Y.slashMenuOpen=!1,mp();t()}function gp(e,t,n){if(e.argOptions?.length){t.onDraftChange(`/${e.name} `),Y.slashMenuMode=`args`,Y.slashMenuCommand=e,Y.slashMenuArgItems=e.argOptions,Y.slashMenuOpen=!0,Y.slashMenuIndex=0,Y.slashMenuItems=[],n();return}Y.slashMenuOpen=!1,mp(),n(),e.executeLocal&&!e.args?t.onSendMessage?t.onSendMessage(`/${e.name}`):(t.onDraftChange(`/${e.name}`),t.onSend()):t.onDraftChange(`/${e.name} `)}function _p(e,t,n){if(e.argOptions?.length){t.onDraftChange(`/${e.name} `),Y.slashMenuMode=`args`,Y.slashMenuCommand=e,Y.slashMenuArgItems=e.argOptions,Y.slashMenuOpen=!0,Y.slashMenuIndex=0,Y.slashMenuItems=[],n();return}Y.slashMenuOpen=!1,mp(),t.onDraftChange(e.args?`/${e.name} `:`/${e.name}`),n()}function vp(e,t,n,r){let i=Y.slashMenuCommand?.name??``;Y.slashMenuOpen=!1,mp(),n(),r?t.onSendMessage?t.onSendMessage(`/${i} ${e}`):(t.onDraftChange(`/${i} ${e}`),t.onSend()):t.onDraftChange(`/${i} ${e}`)}function yp(e){return e.length<100?null:`~${Math.ceil(e.length/4)} tokens`}function bp(e){Ho(e.messages,e.assistantName)}var xp=[`What can you do?`,`Summarize my recent sessions`,`Help me configure a channel`,`Check system health`];function Sp(e){let t=e.assistantName||`Assistant`,r=pu({identity:{avatar:e.assistantAvatar??void 0,avatarUrl:e.assistantAvatarUrl??void 0}}),i=mu(e.basePath??``);return n`
  ...
  `}function Cp(e){return Y.searchOpen?n`
  ...
  `:i}function wp(e,t,r){let a=Array.isArray(e.messages)?e.messages:[],o=[];for(let e of t.indices){let t=a[e];if(!t)continue;let n=Ff(t),r=typeof t.role==`string`?t.role:`unknown`;o.push({index:e,text:n,role:r})}return o.length===0?i:n`
  ...
  `}function Tp(e,t){if(!Y.slashMenuOpen)return i;if(Y.slashMenuMode===`args`&&Y.slashMenuCommand&&Y.slashMenuArgItems.length>0)return n`
    ...
    `;if(Y.slashMenuItems.length===0)return i;let r=new Map;for(let e=0;e<Y.slashMenuItems.length;e++){let t=Y.slashMenuItems[e],n=t.category??`session`,i=r.get(n);i||(i=[],r.set(n,i)),i.push({cmd:t,globalIdx:e})}let a=[];for(let[o,s]of r)a.push(n`
      <div class="slash-menu-group">
        <div class="slash-menu-group__label">${Bf[o]}</div>
  ...
  `}function Ep(e){let t=e.connected,r=e.sending||e.stream!==null,a=!!(e.canAbort&&e.onAbort),o=e.sessions?.sessions?.find(t=>t.key===e.sessionKey),s=o?.reasoningLevel??`off`,c=e.showThinking&&s!==`off`,l={name:e.assistantName,avatar:pu({identity:{avatar:e.assistantAvatar??void 0,avatarUrl:e.assistantAvatarUrl??void 0}})??null},u=Zf(e.sessionKey),d=Qf(e.sessionKey),f=Xf(e.sessionKey),p=(e.attachments?.length??0)>0,m=yp(e.draft),h=e.connected?p?`Add a message or paste more images...`:`Message ${e.assistantName||`agent`} (Enter to send)`:`Connect to the gateway to start chatting...`,g=e.onRequestUpdate??(()=>{}),_=e.getDraft??(()=>e.draft),v=e.splitRatio??.6,y=!!(e.sidebarOpen&&e.onCloseSidebar),b=e=>{let t=e.target.closest(`.code-block-copy`);if(!t)return;let n=t.dataset.code??``;navigator.clipboard.writeText(n).then(()=>{t.classList.add(`copied`),setTimeout(()=>t.classList.remove(`copied`),1500)},()=>{})},x=kp(e),S=x.length===0&&!e.loading,C=n`
    <div
      class="chat-thread"
      role="log"
      aria-live="polite"
  ...
  `,w=()=>{requestAnimationFrame(()=>{document.querySelector(`.slash-menu-item--active`)?.scrollIntoView({block:`nearest`,behavior:`smooth`})})};return n`
    ...
    >
      ...
      ${rp(e.fallbackStatus)}
      ${np(e.compactionStatus)}
      ${sp(o,e.sessions?.defaults?.contextTokens??null)}
      ...
      <div class="agent-chat__input">
        ...
        <textarea
          ...
          @keydown=${n=>{if(Y.slashMenuOpen&&Y.slashMenuMode===`args`&&Y.slashMenuArgItems.length>0){let t=Y.slashMenuArgItems.length;switch(n.key){case`ArrowDown`:n.preventDefault(),Y.slashMenuIndex=(Y.slashMenuIndex+1)%t,g(),w();return;case`ArrowUp`:n.preventDefault(),Y.slashMenuIndex=(Y.slashMenuIndex-1+t)%t,g(),w();return;case`Tab`:n.preventDefault(),vp(Y.slashMenuArgItems[Y.slashMenuIndex],e,g,!1);return;case`Enter`:n.preventDefault(),vp(Y.slashMenuArgItems[Y.slashMenuIndex],e,g,!0);return;case`Escape`:n.preventDefault(),Y.slashMenuOpen=!1,mp(),g();return}}if(Y.slashMenuOpen&&Y.slashMenuItems.length>0){let t=Y.slashMenuItems.length;switch(n.key){case`ArrowDown`:n.preventDefault(),Y.slashMenuIndex=(Y.slashMenuIndex+1)%t,g(),w();return;case`ArrowUp`:n.preventDefault(),Y.slashMenuIndex=(Y.slashMenuIndex-1+t)%t,g(),w();return;case`Tab`:n.preventDefault(),_p(Y.slashMenuItems[Y.slashMenuIndex],e,g);return;case`Enter`:n.preventDefault(),gp(Y.slashMenuItems[Y.slashMenuIndex],e,g);return;case`Escape`:n.preventDefault(),Y.slashMenuOpen=!1,mp(),g();return}}if(!e.draft.trim()){if(n.key===`ArrowUp`){let t=f.up();t!==null&&(n.preventDefault(),e.onDraftChange(t));return}if(n.key===`ArrowDown`){let t=f.down();n.preventDefault(),e.onDraftChange(t??``);return}}if((n.metaKey||n.ctrlKey)&&!n.shiftKey&&n.key===`f`){n.preventDefault(),Y.searchOpen=!Y.searchOpen,Y.searchOpen||(Y.searchQuery=``),g();return}if(n.key===`Enter`&&!n.shiftKey){if(n.isComposing||n.keyCode===229||!e.connected)return;n.preventDefault(),t&&(e.draft.trim()&&f.push(e.draft),e.onSend())}}}
          @input=${t=>{let n=t.target;tp(n),hp(n.value,g),f.reset(),e.onDraftChange(n.value)}}
          @paste=${t=>up(t,e)}
        ...
        <div class="agent-chat__toolbar">
          <div class="agent-chat__toolbar-left">
            ...
            ${Xu()?n`
                  <button
                    ...
                    @click=${()=>{Y.sttRecording?($u(),Y.sttRecording=!1,Y.sttInterimText=``,g()):Qu({onTranscript:(t,n)=>{if(n){let n=_(),r=n&&!n.endsWith(` `)?` `:``;e.onDraftChange(n+r+t),Y.sttInterimText=``}else Y.sttInterimText=t;g()},onStart:()=>{Y.sttRecording=!0,g()},onEnd:()=>{Y.sttRecording=!1,Y.sttInterimText=``,g()},onError:()=>{Y.sttRecording=!1,Y.sttInterimText=``,g()}})&&(Y.sttRecording=!0,g())}}
          ...
          <div class="agent-chat__toolbar-right">
            ...
            ${a?i:n`
                  ...
                  `}
            <button class="btn-ghost" @click=${()=>bp(e)} title="Export" ?disabled=${e.messages.length===0}>
              ${W.download}
            </button>
  ...
  `}var Dp=200;function Op(e){let t=[],n=null;for(let r of e){if(r.kind!==`message`){n&&=(t.push(n),null),t.push(r);continue}let e=Ku(r.message),i=qu(e.role),a=i.toLowerCase()===`user`?e.senderLabel??null:null,o=e.timestamp||Date.now();!n||n.role!==i||i.toLowerCase()===`user`&&n.senderLabel!==a?(n&&t.push(n),n={kind:`group`,key:`group:${i}:${r.key}`,role:i,senderLabel:a,messages:[{message:r.message,key:r.key}],timestamp:o,isStreaming:!1}):n.messages.push({message:r.message,key:r.key})}return n&&t.push(n),t}function kp(e){let t=[],n=Array.isArray(e.messages)?e.messages:[],r=Array.isArray(e.toolMessages)?e.toolMessages:[],i=Math.max(0,n.length-Dp);i>0&&t.push({kind:`message`,key:`chat:history:notice`,message:{role:`system`,content:`Showing last ${Dp} messages (${i} hidden).`,timestamp:Date.now()}});for(let r=i;r<n.length;r++){let i=n[r],a=Ku(i),o=i.__openclaw;if(o&&o.kind===`compaction`){t.push({kind:`divider`,key:typeof o.id==`string`?`divider:compaction:${o.id}`:`divider:compaction:${a.timestamp}:${r}`,label:`Compaction`,timestamp:a.timestamp??Date.now()});continue}!e.showToolCalls&&a.role.toLowerCase()===`toolresult`||Y.searchOpen&&Y.searchQuery.trim()&&!If(i,Y.searchQuery)||t.push({kind:`message`,key:Ap(i,r),message:i})}let a=e.streamSegments??[],o=Math.max(a.length,r.length);for(let i=0;i<o;i++)i<a.length&&a[i].text.trim().length>0&&t.push({kind:`stream`,key:`stream-seg:${e.sessionKey}:${i}`,text:a[i].text,startedAt:a[i].ts}),i<r.length&&e.showToolCalls&&t.push({kind:`message`,key:Ap(r[i],i+n.length),message:r[i]});if(e.stream!==null){let n=`stream:${e.sessionKey}:${e.streamStartedAt??`live`}`;e.stream.trim().length>0?t.push({kind:`stream`,key:n,text:e.stream,startedAt:e.streamStartedAt??Date.now()}):t.push({kind:`reading-indicator`,key:n})}return Op(t)}function Ap(e,t){let n=e,r=typeof n.toolCallId==`string`?n.toolCallId:``;if(r)return`tool:${r}`;let i=typeof n.id==`string`?n.id:``;if(i)return`msg:${i}`;let a=typeof n.messageId==`string`?n.messageId:``;if(a)return`msg:${a}`;let o=typeof n.timestamp==`number`?n.timestamp:null,s=typeof n.role==`string`?n.role:`unknown`;return o==null?`msg:${s}:${t}`:`msg:${s}:${o}:${t}`}function jp(e,t){let n={...t,lastActiveSessionKey:t.lastActiveSessionKey?.trim()||t.sessionKey.trim()||`main`};e.settings=n,Ua(n),(t.theme!==e.theme||t.themeMode!==e.themeMode)&&(e.theme=t.theme,e.themeMode=t.themeMode,Wp(e,Ea(t.theme,t.themeMode))),Up(t.borderRadius),e.applySessionKey=e.settings.lastActiveSessionKey}function Mp(e,t){let n=t.trim();n&&e.settings.lastActiveSessionKey!==n&&jp(e,{...e.settings,lastActiveSessionKey:n})}function Np(e){if(!window.location.search&&!window.location.hash)return;let t=new URL(window.location.href),n=new URLSearchParams(t.search),r=new URLSearchParams(t.hash.startsWith(`#`)?t.hash.slice(1):t.hash),i=n.get(`gatewayUrl`)??r.get(`gatewayUrl`),a=i?.trim()??``,o=!!(a&&a!==e.settings.gatewayUrl),s=r.get(`token`)??n.get(`token`),c=n.get(`password`)??r.get(`password`),l=n.get(`session`)??r.get(`session`),u=!!(s?.trim()&&!l?.trim()&&!o),d=!1;if(n.has(`token`)&&(n.delete(`token`),d=!0),s!=null){let t=s.trim();t&&o?e.pendingGatewayToken=t:t&&t!==e.settings.token&&jp(e,{...e.settings,token:t}),r.delete(`token`),d=!0}if(u&&(e.sessionKey=`main`,jp(e,{...e.settings,sessionKey:`main`,lastActiveSessionKey:`main`})),c!=null&&(n.delete(`password`),r.delete(`password`),d=!0),l!=null){let t=l.trim();t&&(e.sessionKey=t,jp(e,{...e.settings,sessionKey:t,lastActiveSessionKey:t}))}if(i!=null&&(o?(e.pendingGatewayUrl=a,s?.trim()||(e.pendingGatewayToken=null)):(e.pendingGatewayUrl=null,e.pendingGatewayToken=null),n.delete(`gatewayUrl`),r.delete(`gatewayUrl`),d=!0),!d)return;t.search=n.toString();let f=r.toString();t.hash=f?`#${f}`:``,window.history.replaceState({},``,t.toString())}function Pp(e,t){Yp(e,t,{refreshPolicy:`always`,syncUrl:!0})}function Fp(e,t,n){Ka({nextTheme:Ea(t,e.themeMode),applyTheme:()=>{jp(e,{...e.settings,theme:t})},context:n,currentTheme:e.themeResolved}),Gp(e)}function Ip(e,t,n){Ka({nextTheme:Ea(e.theme,t),applyTheme:()=>{jp(e,{...e.settings,themeMode:t})},context:n,currentTheme:e.themeResolved}),Gp(e)}async function Lp(e){if(e.tab===`overview`&&await Qp(e),e.tab===`channels`&&await rm(e),e.tab===`instances`&&await Di(e),e.tab===`usage`&&await ra(e),e.tab===`sessions`&&await ki(e),e.tab===`cron`&&await im(e),e.tab===`skills`&&await Pi(e),e.tab===`agents`){await Wt(e),await z(e);let t=e.agentsList?.agents?.map(e=>e.id)??[];t.length>0&&Ht(e,t);let n=e.agentsSelectedId??e.agentsList?.defaultId??e.agentsList?.agents?.[0]?.id;n&&(Vt(e,n),e.agentsPanel===`skills`&&Ut(e,n),e.agentsPanel===`channels`&&I(e,!1),e.agentsPanel===`cron`&&im(e))}e.tab===`nodes`&&(await Pt(e),await ni(e),await z(e),await li(e)),e.tab===`chat`&&(await yg(e),dt(e,!e.chatHasAutoScrolled)),(e.tab===`config`||e.tab===`communications`||e.tab===`appearance`||e.tab===`automation`||e.tab===`infrastructure`||e.tab===`aiAgents`)&&(await je(e),await z(e)),e.tab===`graph`&&await wi(e,typeof window<`u`?window.location.origin:``),e.tab===`debug`&&(await Et(e),e.eventLog=e.eventLogBuffer),e.tab===`logs`&&(e.logsAtBottom=!0,await Nt(e,{reset:!0}),ft(e,!0))}function Rp(){if(typeof window>`u`)return``;let e=window.__OPENCLAW_CONTROL_UI_BASE_PATH__;return typeof e==`string`&&e.trim()?ua(e):ma(window.location.pathname)}function zp(e){e.theme=e.settings.theme??`claw`,e.themeMode=e.settings.themeMode??`system`,Wp(e,Ea(e.theme,e.themeMode)),Up(e.settings.borderRadius??50),Gp(e)}function Bp(e){Gp(e)}function Vp(e){e.systemThemeCleanup?.(),e.systemThemeCleanup=null}var Hp={sm:6,md:10,lg:14,xl:20,default:10};function Up(e){if(typeof document>`u`)return;let t=document.documentElement,n=e/50;t.style.setProperty(`--radius-sm`,`${Math.round(Hp.sm*n)}px`),t.style.setProperty(`--radius-md`,`${Math.round(Hp.md*n)}px`),t.style.setProperty(`--radius-lg`,`${Math.round(Hp.lg*n)}px`),t.style.setProperty(`--radius-xl`,`${Math.round(Hp.xl*n)}px`),t.style.setProperty(`--radius`,`${Math.round(Hp.default*n)}px`)}function Wp(e,t){if(e.themeResolved=t,typeof document>`u`)return;let n=document.documentElement,r=t.endsWith(`light`)?`light`:`dark`;n.dataset.theme=t,n.dataset.themeMode=r,n.style.colorScheme=r}function Gp(e){if(e.themeMode!==`system`){e.systemThemeCleanup?.(),e.systemThemeCleanup=null;return}if(e.systemThemeCleanup||typeof globalThis.matchMedia!=`function`)return;let t=globalThis.matchMedia(`(prefers-color-scheme: light)`),n=()=>{e.themeMode===`system`&&Wp(e,Ea(e.theme,`system`))};if(typeof t.addEventListener==`function`){t.addEventListener(`change`,n),e.systemThemeCleanup=()=>t.removeEventListener(`change`,n);return}typeof t.addListener==`function`&&(t.addListener(n),e.systemThemeCleanup=()=>t.removeListener(n))}function Kp(e,t){if(typeof window>`u`)return;let n=pa(window.location.pathname,e.basePath)??`chat`;Jp(e,n),Xp(e,n,t)}function qp(e){if(typeof window>`u`)return;let t=pa(window.location.pathname,e.basePath);if(!t)return;let n=new URL(window.location.href).searchParams.get(`session`)?.trim();n&&(e.sessionKey=n,jp(e,{...e.settings,sessionKey:n,lastActiveSessionKey:n})),Jp(e,t)}function Jp(e,t){Yp(e,t,{refreshPolicy:`connected`})}function Yp(e,t,n){let r=e.tab;e.tab!==t&&(e.tab=t),r===`chat`&&t!==`chat`&&ep(),t===`chat`&&(e.chatHasAutoScrolled=!1),t===`logs`?Lt(e):Rt(e),t===`debug`?zt(e):Bt(e),(n.refreshPolicy===`always`||e.connected)&&Lp(e),n.syncUrl&&Xp(e,t,!1)}function Xp(e,t,n){if(typeof window>`u`)return;let r=da(fa(t,e.basePath)),i=da(window.location.pathname),a=new URL(window.location.href);t===`chat`&&e.sessionKey?a.searchParams.set(`session`,e.sessionKey):a.searchParams.delete(`session`),i!==r&&(a.pathname=r),n?window.history.replaceState({},``,a.toString()):window.history.pushState({},``,a.toString())}function Zp(e,t,n){if(typeof window>`u`)return;let r=new URL(window.location.href);r.searchParams.set(`session`,t),n?window.history.replaceState({},``,r.toString()):window.history.pushState({},``,r.toString())}async function Qp(e){let t=e;await Promise.allSettled([I(t,!1),Di(t),ki(t),en(t),tn(t),Et(t),Pi(t),ra(t),tm(t)]),nm(t)}function $p(e){return e?.scopes?Tt({role:e.role??`operator`,requestedScopes:[`operator.read`],allowedScopes:e.scopes}):!1}function em(e){return e?Object.values(e).some(e=>Array.isArray(e)&&e.length>0):!1}async function tm(e){if(!(!e.client||!e.connected))try{let t=await e.client.request(`logs.tail`,{cursor:e.overviewLogCursor||void 0,limit:100,maxBytes:5e4}),n=Array.isArray(t.lines)?t.lines.filter(e=>typeof e==`string`):[];e.overviewLogLines=[...e.overviewLogLines,...n].slice(-500),typeof t.cursor==`number`&&(e.overviewLogCursor=t.cursor)}catch{}}function nm(e){let t=[];e.lastError&&t.push({severity:`error`,icon:`x`,title:`Gateway Error`,description:e.lastError});let n=e.hello?.auth??null;n?.scopes&&!$p(n)&&t.push({severity:`warning`,icon:`key`,title:`Missing operator.read scope`,description:`This connection does not have the operator.read scope. Some features may be unavailable.`,href:`https://docs.openclaw.ai/web/dashboard`,external:!0});let r=e.skillsReport?.skills??[],i=r.filter(e=>!e.disabled&&em(e.missing));if(i.length>0){let e=i.slice(0,3).map(e=>e.name),n=i.length>3?` +${i.length-3} more`:``;t.push({severity:`warning`,icon:`zap`,title:`Skills with missing dependencies`,description:`${e.join(`, `)}${n}`})}let a=r.filter(e=>e.blockedByAllowlist);a.length>0&&t.push({severity:`warning`,icon:`shield`,title:`${a.length} skill${a.length>1?`s`:``} blocked`,description:a.map(e=>e.name).join(`, `)});let o=e.cronJobs??[],s=o.filter(e=>e.state?.lastStatus===`error`);s.length>0&&t.push({severity:`error`,icon:`clock`,title:`${s.length} cron job${s.length>1?`s`:``} failed`,description:s.map(e=>e.name).join(`, `)});let c=Date.now(),l=o.filter(e=>e.enabled&&e.state?.nextRunAtMs!=null&&c-e.state.nextRunAtMs>3e5);l.length>0&&t.push({severity:`warning`,icon:`clock`,title:`${l.length} overdue job${l.length>1?`s`:``}`,description:l.map(e=>e.name).join(`, `)}),e.attentionItems=t}async function rm(e){await Promise.all([I(e,!0),je(e),z(e)])}async function im(e){let t=e,n=t.cronRunsScope===`job`?t.cronRunsJobId:null;await Promise.all([I(t,!1),en(t),tn(t),Sn(t,n)])}var am=50,om=80,sm=12e4;function cm(e){return typeof e==`string`&&e.trim()||null}function lm(e,t){let n=cm(t);if(!n)return null;let r=cm(e);if(r){let e=`${r}/`;if(n.toLowerCase().startsWith(e.toLowerCase())){let t=n.slice(e.length).trim();if(t)return`${r}/${t}`}return`${r}/${n}`}let i=n.indexOf(`/`);if(i>0){let e=n.slice(0,i).trim(),t=n.slice(i+1).trim();if(e&&t)return`${e}/${t}`}return n}function um(e){return Array.isArray(e)?e.map(e=>cm(e)).filter(e=>!!e):[]}function dm(e){if(!Array.isArray(e))return[];let t=[];for(let n of e){if(!n||typeof n!=`object`)continue;let e=n,r=cm(e.provider),i=cm(e.model);if(!r||!i)continue;let a=cm(e.reason)?.replace(/_/g,` `)??cm(e.code)??(typeof e.status==`number`?`HTTP ${e.status}`:null)??cm(e.error)??`error`;t.push({provider:r,model:i,reason:a})}return t}function fm(e){if(!e||typeof e!=`object`)return null;let t=e;if(typeof t.text==`string`)return t.text;let n=t.content;if(!Array.isArray(n))return null;let r=n.map(e=>{if(!e||typeof e!=`object`)return null;let t=e;return t.type===`text`&&typeof t.text==`string`?t.text:null}).filter(e=>!!e);return r.length===0?null:r.join(`
`)}function pm(e){if(e==null)return null;if(typeof e==`number`||typeof e==`boolean`)return String(e);let t=fm(e),n;if(typeof e==`string`)n=e;else if(t)n=t;else try{n=JSON.stringify(e,null,2)}catch{n=String(e)}let r=u(n,sm);return r.truncated?`${r.text}\n\n… truncated (${r.total} chars, showing first ${r.text.length}).`:r.text}function mm(e){let t=[];return t.push({type:`toolcall`,name:e.name,arguments:e.args??{}}),e.output&&t.push({type:`toolresult`,name:e.name,text:e.output}),{role:`assistant`,toolCallId:e.toolCallId,runId:e.runId,content:t,timestamp:e.startedAt}}function hm(e){if(e.toolStreamOrder.length<=am)return;let t=e.toolStreamOrder.length-am,n=e.toolStreamOrder.splice(0,t);for(let t of n)e.toolStreamById.delete(t)}function gm(e){e.chatToolMessages=e.toolStreamOrder.map(t=>e.toolStreamById.get(t)?.message).filter(e=>!!e)}function _m(e){e.toolStreamSyncTimer!=null&&(clearTimeout(e.toolStreamSyncTimer),e.toolStreamSyncTimer=null),gm(e)}function vm(e,t=!1){if(t){_m(e);return}e.toolStreamSyncTimer??=window.setTimeout(()=>_m(e),om)}function ym(e){e.toolStreamSyncTimer!=null&&(clearTimeout(e.toolStreamSyncTimer),e.toolStreamSyncTimer=null),e.toolStreamById.clear(),e.toolStreamOrder=[],e.chatToolMessages=[],e.chatStreamSegments=[]}var bm=5e3,xm=8e3;function Sm(e,t){let n=t.data??{},r=typeof n.phase==`string`?n.phase:``;e.compactionClearTimer!=null&&(window.clearTimeout(e.compactionClearTimer),e.compactionClearTimer=null),r===`start`?e.compactionStatus={active:!0,startedAt:Date.now(),completedAt:null}:r===`end`&&(e.compactionStatus={active:!1,startedAt:e.compactionStatus?.startedAt??null,completedAt:Date.now()},e.compactionClearTimer=window.setTimeout(()=>{e.compactionStatus=null,e.compactionClearTimer=null},bm))}function Cm(e,t,n){let r=typeof t.sessionKey==`string`?t.sessionKey:void 0;return r&&r!==e.sessionKey?{accepted:!1}:!e.chatRunId&&n?.allowSessionScopedWhenIdle&&r?{accepted:!0,sessionKey:r}:!r&&e.chatRunId&&t.runId!==e.chatRunId||e.chatRunId&&t.runId!==e.chatRunId||!e.chatRunId?{accepted:!1}:{accepted:!0,sessionKey:r}}function wm(e,t){let n=t.data??{},r=t.stream===`fallback`?`fallback`:cm(n.phase);if(t.stream===`lifecycle`&&r!==`fallback`&&r!==`fallback_cleared`||!Cm(e,t,{allowSessionScopedWhenIdle:!0}).accepted)return;let i=lm(n.selectedProvider,n.selectedModel)??lm(n.fromProvider,n.fromModel),a=lm(n.activeProvider,n.activeModel)??lm(n.toProvider,n.toModel),o=lm(n.previousActiveProvider,n.previousActiveModel)??cm(n.previousActiveModel);if(!i||!a||r===`fallback`&&i===a)return;let s=cm(n.reasonSummary)??cm(n.reason),c=(()=>{let e=um(n.attemptSummaries);return e.length>0?e:dm(n.attempts).map(e=>`${lm(e.provider,e.model)??`${e.provider}/${e.model}`}: ${e.reason}`)})();e.fallbackClearTimer!=null&&(window.clearTimeout(e.fallbackClearTimer),e.fallbackClearTimer=null),e.fallbackStatus={phase:r===`fallback_cleared`?`cleared`:`active`,selected:i,active:r===`fallback_cleared`?i:a,previous:r===`fallback_cleared`?o??(a===i?void 0:a):void 0,reason:s??void 0,attempts:c,occurredAt:Date.now()},e.fallbackClearTimer=window.setTimeout(()=>{e.fallbackStatus=null,e.fallbackClearTimer=null},xm)}function Tm(e,t){if(!t)return;if(t.stream===`compaction`){Sm(e,t);return}if(t.stream===`lifecycle`||t.stream===`fallback`){wm(e,t);return}if(t.stream!==`tool`)return;let n=typeof t.sessionKey==`string`?t.sessionKey:void 0;if(n&&n!==e.sessionKey)return;let r=t.data??{},i=typeof r.toolCallId==`string`?r.toolCallId:``;if(!i)return;let a=typeof r.name==`string`?r.name:`tool`,o=typeof r.phase==`string`?r.phase:``,s=o===`start`?r.args:void 0,c=o===`update`?pm(r.partialResult):o===`result`?pm(r.result):void 0,l=Date.now(),u=e.toolStreamById.get(i);u?(u.name=a,s!==void 0&&(u.args=s),c!==void 0&&(u.output=c||void 0),u.updatedAt=l):(e.chatStream&&e.chatStream.trim().length>0&&(e.chatStreamSegments=[...e.chatStreamSegments,{text:e.chatStream,ts:l}],e.chatStream=null,e.chatStreamStartedAt=null),u={toolCallId:i,runId:t.runId,sessionKey:n,name:a,args:s,output:c||void 0,startedAt:typeof t.ts==`number`?t.ts:l,updatedAt:l,message:{}},e.toolStreamById.set(i,u),e.toolStreamOrder.push(i)),u.message=mm(u),hm(e),vm(e,o===`result`)}var Em=[`off`,`minimal`,`low`,`medium`,`high`,`adaptive`],Dm=/^claude-(?:opus|sonnet)-4(?:\.|-)6(?:$|[-.])/i,Om=/claude-(?:opus|sonnet)-4(?:\.|-)6(?:$|[-.])/i;function km(e){if(!e)return``;let t=e.trim().toLowerCase();return t===`z.ai`||t===`z-ai`?`zai`:t===`bedrock`||t===`aws-bedrock`?`amazon-bedrock`:t}function Am(e){return km(e)===`zai`}function jm(e){if(!e)return;let t=e.trim().toLowerCase(),n=t.replace(/[\s_-]+/g,``);if(n===`adaptive`||n===`auto`)return`adaptive`;if(n===`xhigh`||n===`extrahigh`)return`xhigh`;if([`off`].includes(t))return`off`;if([`on`,`enable`,`enabled`].includes(t))return`low`;if([`min`,`minimal`].includes(t))return`minimal`;if([`low`,`thinkhard`,`think-hard`,`think_hard`].includes(t))return`low`;if([`mid`,`med`,`medium`,`thinkharder`,`think-harder`,`harder`].includes(t))return`medium`;if([`high`,`ultra`,`ultrathink`,`think-hard`,`thinkhardest`,`highest`,`max`].includes(t))return`high`;if([`think`].includes(t))return`minimal`}function Mm(e,t){return[...Em]}function Nm(e,t){return Am(e)?[`off`,`on`]:Mm(e,t)}function Pm(e,t,n=`, `){return Nm(e,t).join(n)}function Fm(e){let t=km(e.provider),n=e.model.trim();return t===`anthropic`&&Dm.test(n)||t===`amazon-bedrock`&&Om.test(n)?`adaptive`:e.catalog?.find(t=>t.provider===e.provider&&t.id===e.model)?.reasoning?`low`:`off`}function Im(e){if(!e)return;let t=e.toLowerCase();if([`off`,`false`,`no`,`0`].includes(t))return`off`;if([`full`,`all`,`everything`].includes(t))return`full`;if([`on`,`minimal`,`true`,`yes`,`1`].includes(t))return`on`}function Lm(e){return Im(e)}var Rm=`main`,zm=`main`,Bm=/^[a-z0-9][a-z0-9_-]{0,63}$/i,Vm=/[^a-z0-9_-]+/g,Hm=/^-+/,Um=/-+$/;function Wm(e){let t=(e??``).trim();return t?t.toLowerCase():zm}function Gm(e){let t=(e??``).trim();return t?Bm.test(t)?t.toLowerCase():t.toLowerCase().replace(Vm,`-`).replace(Hm,``).replace(Um,``).slice(0,64)||`main`:Rm}function Km(e){return`agent:${Gm(e.agentId)}:${Wm(e.mainKey)}`}function qm(e,t){let n=e.trim();if(!n)return``;let r=t?.trim();return r?`${r}/${n}`:n}function Jm(e){let t=e.trim();return t?t.includes(`/`)?{kind:`qualified`,value:t}:{kind:`raw`,value:t}:null}function Ym(e,t){if(!e)return``;let n=e?.value.trim();if(!n)return``;if(e.kind===`qualified`)return n;let r=``;for(let e of t){if(e.id.trim().toLowerCase()!==n.toLowerCase())continue;let t=qm(e.id,e.provider);if(!r){r=t;continue}if(r.toLowerCase()!==t.toLowerCase())return n}return r||n}function Xm(e,t){return typeof e==`string`?qm(e,t):``}function Zm(e){let t=e.trim();if(!t)return``;let n=t.indexOf(`/`);return n<=0?t:`${t.slice(n+1)} · ${t.slice(0,n)}`}function Qm(e){let t=e.provider?.trim();return{value:qm(e.id,t),label:t?`${e.id} · ${t}`:e.id}}async function $m(e,t,n,r){switch(n){case`help`:return eh();case`new`:return{content:`Starting new session...`,action:`new-session`};case`reset`:return{content:`Resetting session...`,action:`reset`};case`stop`:return{content:`Stopping current run...`,action:`stop`};case`clear`:return{content:`Chat history cleared.`,action:`clear`};case`focus`:return{content:`Toggled focus mode.`,action:`toggle-focus`};case`compact`:return await th(e,t);case`model`:return await nh(e,t,r);case`think`:return await rh(e,t,r);case`fast`:return await ah(e,t,r);case`verbose`:return await ih(e,t,r);case`export`:return{content:`Exporting session...`,action:`export`};case`usage`:return await oh(e,t);case`agents`:return await sh(e);case`kill`:return await ch(e,t,r);default:return{content:`Unknown command: \`/${n}\``}}}function eh(){let e=[`**Available Commands**
`],t=``;for(let n of Rf){let r=n.category??`session`;r!==t&&(t=r,e.push(`**${r.charAt(0).toUpperCase()+r.slice(1)}**`));let i=n.args?` ${n.args}`:``,a=n.executeLocal?``:` *(agent)*`;e.push(`\`/${n.name}${i}\` — ${n.description}${a}`)}return e.push("\nType `/` to open the command menu."),{content:e.join(`
`)}}async function th(e,t){try{return await e.request(`sessions.compact`,{key:t}),{content:`Context compacted successfully.`,action:`refresh`}}catch(e){return{content:`Compaction failed: ${String(e)}`}}}async function nh(e,t,n){if(!n)try{let[n,r]=await Promise.all([e.request(`sessions.list`,{}),e.request(`models.list`,{})]),i=gh(n,t)?.model||n?.defaults?.model||`default`,a=r?.models?.map(e=>e.id)??[],o=[`**Current model:** \`${i}\``];return a.length>0&&o.push(`**Available:** ${a.slice(0,10).map(e=>`\`${e}\``).join(`, `)}${a.length>10?` +${a.length-10} more`:``}`),{content:o.join(`
`)}}catch(e){return{content:`Failed to get model info: ${String(e)}`}}try{let r=await e.request(`sessions.patch`,{key:t,model:n.trim()}),i=Xm(r.resolved?.model??n.trim(),r.resolved?.modelProvider);return{content:`Model set to \`${n.trim()}\`.`,action:`refresh`,sessionPatch:{modelOverride:Jm(i)}}}catch(e){return{content:`Failed to set model: ${String(e)}`}}}async function rh(e,t,n){let r=n.trim();if(!r)try{let{session:n,models:r}=await _h(e,t);return{content:mh(`Current thinking level: ${vh(n,r)}.`,Pm(n?.modelProvider,n?.model))}}catch(e){return{content:`Failed to get thinking level: ${String(e)}`}}let i=jm(r);if(!i)try{let n=await hh(e,t);return{content:`Unrecognized thinking level "${r}". Valid levels: ${Pm(n?.modelProvider,n?.model)}.`}}catch(e){return{content:`Failed to validate thinking level: ${String(e)}`}}try{return await e.request(`sessions.patch`,{key:t,thinkingLevel:i}),{content:`Thinking level set to **${i}**.`,action:`refresh`}}catch(e){return{content:`Failed to set thinking level: ${String(e)}`}}}async function ih(e,t,n){let r=n.trim();if(!r)try{return{content:mh(`Current verbose level: ${Lm((await hh(e,t))?.verboseLevel)??`off`}.`,`on, full, off`)}}catch(e){return{content:`Failed to get verbose level: ${String(e)}`}}let i=Lm(r);if(!i)return{content:`Unrecognized verbose level "${r}". Valid levels: off, on, full.`};try{return await e.request(`sessions.patch`,{key:t,verboseLevel:i}),{content:`Verbose mode set to **${i}**.`,action:`refresh`}}catch(e){return{content:`Failed to set verbose mode: ${String(e)}`}}}async function ah(e,t,n){let r=n.trim().toLowerCase();if(!r||r===`status`)try{return{content:mh(`Current fast mode: ${yh(await hh(e,t))}.`,`status, on, off`)}}catch(e){return{content:`Failed to get fast mode: ${String(e)}`}}if(r!==`on`&&r!==`off`)return{content:`Unrecognized fast mode "${n.trim()}". Valid levels: status, on, off.`};try{return await e.request(`sessions.patch`,{key:t,fastMode:r===`on`}),{content:`Fast mode ${r===`on`?`enabled`:`disabled`}.`,action:`refresh`}}catch(e){return{content:`Failed to set fast mode: ${String(e)}`}}}async function oh(e,t){try{let n=gh(await e.request(`sessions.list`,{}),t);if(!n)return{content:`No active session.`};let r=n.inputTokens??0,i=n.outputTokens??0,a=n.totalTokens??r+i,o=n.contextTokens??0,s=o>0?Math.round(r/o*100):null,c=[`**Session Usage**`,`Input: **${bh(r)}** tokens`,`Output: **${bh(i)}** tokens`,`Total: **${bh(a)}** tokens`];return s!==null&&c.push(`Context: **${s}%** of ${bh(o)}`),n.model&&c.push(`Model: \`${n.model}\``),{content:c.join(`
`)}}catch(e){return{content:`Failed to get usage: ${String(e)}`}}}async function sh(e){try{let t=await e.request(`agents.list`,{}),n=t?.agents??[];if(n.length===0)return{content:`No agents configured.`};let r=[`**Agents** (${n.length})\n`];for(let e of n){let n=e.id===t?.defaultId,i=e.identity?.name||e.name||e.id,a=n?` *(default)*`:``;r.push(`- \`${e.id}\` — ${i}${a}`)}return{content:r.join(`
`)}}catch(e){return{content:`Failed to list agents: ${String(e)}`}}}async function ch(e,t,n){let r=n.trim();if(!r)return{content:"Usage: `/kill <id|all>`"};try{let n=lh((await e.request(`sessions.list`,{}))?.sessions??[],t,r);if(n.length===0)return{content:r.toLowerCase()===`all`?`No active sub-agent sessions found.`:`No matching sub-agent sessions found for \`${r}\`.`};let i=await Promise.allSettled(n.map(t=>e.request(`chat.abort`,{sessionKey:t}))),a=i.filter(e=>e.status===`rejected`),o=i.filter(e=>e.status===`fulfilled`&&e.value?.aborted!==!1).length;if(o===0){if(a.length===0)return{content:r.toLowerCase()===`all`?`No active sub-agent runs to abort.`:`No active runs matched \`${r}\`.`};throw a[0]?.reason??Error(`abort failed`)}return r.toLowerCase()===`all`?{content:o===n.length?`Aborted ${o} sub-agent session${o===1?``:`s`}.`:`Aborted ${o} of ${n.length} sub-agent sessions.`}:{content:o===n.length?`Aborted ${o} matching sub-agent session${o===1?``:`s`} for \`${r}\`.`:`Aborted ${o} of ${n.length} matching sub-agent sessions for \`${r}\`.`}}catch(e){return{content:`Failed to abort: ${String(e)}`}}}function lh(e,t,n){let r=n.trim().toLowerCase();if(!r)return[];let i=new Set,a=t.trim().toLowerCase(),o=st(a)?.agentId??(a===`main`?`main`:void 0),s=dh(e);for(let t of e){let e=t?.key?.trim();if(!e||!ct(e))continue;let n=e.toLowerCase(),c=st(n),l=uh(n,a,s,o,c?.agentId);(r===`all`&&l||l&&n===r||l&&((c?.agentId??``)===r||n.endsWith(`:subagent:${r}`)||n===`subagent:${r}`))&&i.add(e)}return[...i]}function uh(e,t,n,r,i){if(!r||i!==r)return!1;let a=ph(t,r),o=new Set,s=fh(n.get(e)?.spawnedBy);for(;s&&!o.has(s);){if(a.has(s))return!0;o.add(s),s=fh(n.get(s)?.spawnedBy)}return ct(t)?e.startsWith(`${t}:subagent:`):!1}function dh(e){let t=new Map;for(let n of e){let e=fh(n?.key);e&&t.set(e,n)}return t}function fh(e){return e?.trim().toLowerCase()||void 0}function ph(e,t){let n=new Set([e]);if(t===`main`){let t=`agent:${Rm}:main`;e===`main`?n.add(t):e===t&&n.add(zm)}return n}function mh(e,t){return`${e}\nOptions: ${t}.`}async function hh(e,t){return gh(await e.request(`sessions.list`,{}),t)}function gh(e,t){let n=fh(t),r=st(n??``)?.agentId??(n===`main`?`main`:void 0),i=n?ph(n,r):new Set;return e?.sessions?.find(e=>{let t=fh(e.key);return t?i.has(t):!1})}async function _h(e,t){let[n,r]=await Promise.all([e.request(`sessions.list`,{}),e.request(`models.list`,{})]);return{session:gh(n,t),models:r?.models??[]}}function vh(e,t){return jm(e?.thinkingLevel)||(!e?.modelProvider||!e.model?`off`:Fm({provider:e.modelProvider,model:e.model,catalog:t}))}function yh(e){return e?.fastMode===!0?`on`:`off`}function bh(e){return e>=1e6?`${(e/1e6).toFixed(1).replace(/\.0$/,``)}M`:e>=1e3?`${(e/1e3).toFixed(1).replace(/\.0$/,``)}k`:String(e)}var X={AUTH_REQUIRED:`AUTH_REQUIRED`,AUTH_UNAUTHORIZED:`AUTH_UNAUTHORIZED`,AUTH_TOKEN_MISSING:`AUTH_TOKEN_MISSING`,AUTH_TOKEN_MISMATCH:`AUTH_TOKEN_MISMATCH`,AUTH_TOKEN_NOT_CONFIGURED:`AUTH_TOKEN_NOT_CONFIGURED`,AUTH_PASSWORD_MISSING:`AUTH_PASSWORD_MISSING`,AUTH_PASSWORD_MISMATCH:`AUTH_PASSWORD_MISMATCH`,AUTH_PASSWORD_NOT_CONFIGURED:`AUTH_PASSWORD_NOT_CONFIGURED`,AUTH_BOOTSTRAP_TOKEN_INVALID:`AUTH_BOOTSTRAP_TOKEN_INVALID`,AUTH_DEVICE_TOKEN_MISMATCH:`AUTH_DEVICE_TOKEN_MISMATCH`,AUTH_RATE_LIMITED:`AUTH_RATE_LIMITED`,AUTH_TAILSCALE_IDENTITY_MISSING:`AUTH_TAILSCALE_IDENTITY_MISSING`,AUTH_TAILSCALE_PROXY_MISSING:`AUTH_TAILSCALE_PROXY_MISSING`,AUTH_TAILSCALE_WHOIS_FAILED:`AUTH_TAILSCALE_WHOIS_FAILED`,AUTH_TAILSCALE_IDENTITY_MISMATCH:`AUTH_TAILSCALE_IDENTITY_MISMATCH`,CONTROL_UI_ORIGIN_NOT_ALLOWED:`CONTROL_UI_ORIGIN_NOT_ALLOWED`,CONTROL_UI_DEVICE_IDENTITY_REQUIRED:`CONTROL_UI_DEVICE_IDENTITY_REQUIRED`,DEVICE_IDENTITY_REQUIRED:`DEVICE_IDENTITY_REQUIRED`,DEVICE_AUTH_INVALID:`DEVICE_AUTH_INVALID`,DEVICE_AUTH_DEVICE_ID_MISMATCH:`DEVICE_AUTH_DEVICE_ID_MISMATCH`,DEVICE_AUTH_SIGNATURE_EXPIRED:`DEVICE_AUTH_SIGNATURE_EXPIRED`,DEVICE_AUTH_NONCE_REQUIRED:`DEVICE_AUTH_NONCE_REQUIRED`,DEVICE_AUTH_NONCE_MISMATCH:`DEVICE_AUTH_NONCE_MISMATCH`,DEVICE_AUTH_SIGNATURE_INVALID:`DEVICE_AUTH_SIGNATURE_INVALID`,DEVICE_AUTH_PUBLIC_KEY_INVALID:`DEVICE_AUTH_PUBLIC_KEY_INVALID`,PAIRING_REQUIRED:`PAIRING_REQUIRED`},xh=new Set([`retry_with_device_token`,`update_auth_configuration`,`update_auth_credentials`,`wait_then_retry`,`review_auth_configuration`]);function Sh(e){if(!e||typeof e!=`object`||Array.isArray(e))return null;let t=e.code;return typeof t==`string`&&t.trim().length>0?t:null}function Ch(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t=e,n=typeof t.canRetryWithDeviceToken==`boolean`?t.canRetryWithDeviceToken:void 0,r=typeof t.recommendedNextStep==`string`?t.recommendedNextStep.trim():``;return{canRetryWithDeviceToken:n,recommendedNextStep:xh.has(r)?r:void 0}}function wh(e){let t=e.scopes.join(`,`),n=e.token??``;return[`v2`,e.deviceId,e.clientId,e.clientMode,e.role,t,String(e.signedAtMs),n,e.nonce].join(`|`)}var Th={WEBCHAT_UI:`webchat-ui`,CONTROL_UI:`openclaw-control-ui`,WEBCHAT:`webchat`,CLI:`cli`,GATEWAY_CLIENT:`gateway-client`,MACOS_APP:`openclaw-macos`,IOS_APP:`openclaw-ios`,ANDROID_APP:`openclaw-android`,NODE_HOST:`node-host`,TEST:`test`,FINGERPRINT:`fingerprint`,PROBE:`openclaw-probe`},Eh=Th,Dh={WEBCHAT:`webchat`,CLI:`cli`,UI:`ui`,BACKEND:`backend`,NODE:`node`,PROBE:`probe`,TEST:`test`};new Set(Object.values(Th)),new Set(Object.values(Dh));var Oh=!1;function kh(e){e[6]=e[6]&15|64,e[8]=e[8]&63|128;let t=``;for(let n=0;n<e.length;n++)t+=e[n].toString(16).padStart(2,`0`);return`${t.slice(0,8)}-${t.slice(8,12)}-${t.slice(12,16)}-${t.slice(16,20)}-${t.slice(20)}`}function Ah(){let e=new Uint8Array(16),t=Date.now();for(let t=0;t<e.length;t++)e[t]=Math.floor(Math.random()*256);return e[0]^=t&255,e[1]^=t>>>8&255,e[2]^=t>>>16&255,e[3]^=t>>>24&255,e}function jh(){Oh||(Oh=!0,console.warn(`[uuid] crypto API missing; falling back to weak randomness`))}function Mh(e=globalThis.crypto){if(e&&typeof e.randomUUID==`function`)return e.randomUUID();if(e&&typeof e.getRandomValues==`function`){let t=new Uint8Array(16);return e.getRandomValues(t),kh(t)}return jh(),kh(Ah())}var Nh=class extends Error{constructor(e){super(e.message),this.name=`GatewayRequestError`,this.gatewayCode=e.code,this.details=e.details}};function Ph(e){return Sh(e?.details)}function Fh(e){if(!e)return!1;let t=Ph(e);return t===X.AUTH_TOKEN_MISSING||t===X.AUTH_BOOTSTRAP_TOKEN_INVALID||t===X.AUTH_PASSWORD_MISSING||t===X.AUTH_PASSWORD_MISMATCH||t===X.AUTH_RATE_LIMITED||t===X.PAIRING_REQUIRED||t===X.CONTROL_UI_DEVICE_IDENTITY_REQUIRED||t===X.DEVICE_IDENTITY_REQUIRED}function Ih(e){try{let t=new URL(e,window.location.href),n=t.hostname.trim().toLowerCase(),r=n===`localhost`||n===`::1`||n===`[::1]`||n===`127.0.0.1`,i=n.startsWith(`127.`);if(r||i)return!0;let a=new URL(window.location.href);return t.host===a.host}catch{return!1}}var Lh=`operator`,Rh=[`operator.admin`,`operator.read`,`operator.write`,`operator.approvals`,`operator.pairing`],zh=4008;function Bh(e){let t=e.authToken;if(t||e.authPassword)return{token:t,deviceToken:e.authDeviceToken??e.resolvedDeviceToken,password:e.authPassword}}async function Vh(e){let{deviceIdentity:t}=e;if(!t)return;let n=Date.now(),r=e.connectNonce??``,i=wh({deviceId:t.deviceId,clientId:e.client.id,clientMode:e.client.mode,role:e.role,scopes:e.scopes,signedAtMs:n,token:e.authToken??null,nonce:r}),a=await ti(t.privateKey,i);return{id:t.deviceId,publicKey:t.publicKey,signature:a,signedAt:n,nonce:r}}function Hh(e){return!e.deviceTokenRetryBudgetUsed&&!e.authDeviceToken&&!!e.explicitGatewayToken&&!!e.deviceIdentity&&!!e.storedToken&&e.canRetryWithDeviceTokenHint&&Ih(e.url)}var Uh=class{constructor(e){this.opts=e,this.ws=null,this.pending=new Map,this.closed=!1,this.lastSeq=null,this.connectNonce=null,this.connectSent=!1,this.connectTimer=null,this.backoffMs=800,this.pendingDeviceTokenRetry=!1,this.deviceTokenRetryBudgetUsed=!1}start(){this.closed=!1,this.connect()}stop(){this.closed=!0,this.ws?.close(),this.ws=null,this.pendingConnectError=void 0,this.pendingDeviceTokenRetry=!1,this.deviceTokenRetryBudgetUsed=!1,this.flushPending(Error(`gateway client stopped`))}get connected(){return this.ws?.readyState===WebSocket.OPEN}connect(){this.closed||(this.ws=new WebSocket(this.opts.url),this.ws.addEventListener(`open`,()=>this.queueConnect()),this.ws.addEventListener(`message`,e=>this.handleMessage(String(e.data??``))),this.ws.addEventListener(`close`,e=>{let t=String(e.reason??``),n=this.pendingConnectError;this.pendingConnectError=void 0,this.ws=null,this.flushPending(Error(`gateway closed (${e.code}): ${t}`)),this.opts.onClose?.({code:e.code,reason:t,error:n}),!(Ph(n)===X.AUTH_TOKEN_MISMATCH&&this.deviceTokenRetryBudgetUsed&&!this.pendingDeviceTokenRetry)&&(Fh(n)||this.scheduleReconnect())}),this.ws.addEventListener(`error`,()=>{}))}scheduleReconnect(){if(this.closed)return;let e=this.backoffMs;this.backoffMs=Math.min(this.backoffMs*1.7,15e3),window.setTimeout(()=>this.connect(),e)}flushPending(e){for(let[,t]of this.pending)t.reject(e);this.pending.clear()}buildConnectClient(){return{id:this.opts.clientName??Eh.CONTROL_UI,version:this.opts.clientVersion??`control-ui`,platform:this.opts.platform??navigator.platform??`web`,mode:this.opts.mode??Dh.WEBCHAT,instanceId:this.opts.instanceId}}buildConnectParams(e){return{minProtocol:3,maxProtocol:3,client:e.client,role:e.role,scopes:e.scopes,device:e.device,caps:[`tool-events`],auth:e.auth,userAgent:navigator.userAgent,locale:navigator.language}}async buildConnectPlan(){let e=Lh,t=[...Rh],n=this.buildConnectClient(),r=this.opts.token?.trim()||void 0,i=this.opts.password?.trim()||void 0,a=typeof crypto<`u`&&!!crypto.subtle,o=null,s={authToken:r,authPassword:i,canFallbackToShared:!1};return a&&(o=await ei(),s=this.selectConnectAuth({role:e,deviceId:o.deviceId}),this.pendingDeviceTokenRetry&&s.authDeviceToken&&(this.pendingDeviceTokenRetry=!1)),{role:e,scopes:t,client:n,explicitGatewayToken:r,selectedAuth:s,auth:Bh(s),deviceIdentity:o,device:await Vh({deviceIdentity:o,client:n,role:e,scopes:t,authToken:s.authToken,connectNonce:this.connectNonce})}}handleConnectHello(e,t){this.pendingDeviceTokenRetry=!1,this.deviceTokenRetryBudgetUsed=!1,e?.auth?.deviceToken&&t.deviceIdentity&&Rn({deviceId:t.deviceIdentity.deviceId,role:e.auth.role??t.role,token:e.auth.deviceToken,scopes:e.auth.scopes??[]}),this.backoffMs=800,this.opts.onHello?.(e)}handleConnectFailure(e,t){let n=e instanceof Nh?Ph(e):null,r=e instanceof Nh?Ch(e.details):{},i=r.recommendedNextStep===`retry_with_device_token`,a=r.canRetryWithDeviceToken===!0||i||n===X.AUTH_TOKEN_MISMATCH;Hh({deviceTokenRetryBudgetUsed:this.deviceTokenRetryBudgetUsed,authDeviceToken:t.selectedAuth.authDeviceToken,explicitGatewayToken:t.explicitGatewayToken,deviceIdentity:t.deviceIdentity,storedToken:t.selectedAuth.storedToken,canRetryWithDeviceTokenHint:a,url:this.opts.url})&&(this.pendingDeviceTokenRetry=!0,this.deviceTokenRetryBudgetUsed=!0),e instanceof Nh?this.pendingConnectError={code:e.gatewayCode,message:e.message,details:e.details}:this.pendingConnectError=void 0,t.selectedAuth.canFallbackToShared&&t.deviceIdentity&&n===X.AUTH_DEVICE_TOKEN_MISMATCH&&zn({deviceId:t.deviceIdentity.deviceId,role:t.role}),this.ws?.close(zh,`connect failed`)}async sendConnect(){if(this.connectSent)return;this.connectSent=!0,this.connectTimer!==null&&(window.clearTimeout(this.connectTimer),this.connectTimer=null);let e=await this.buildConnectPlan();this.request(`connect`,this.buildConnectParams(e)).then(t=>this.handleConnectHello(t,e)).catch(t=>this.handleConnectFailure(t,e))}handleMessage(e){let t;try{t=JSON.parse(e)}catch{return}let n=t;if(n.type===`event`){let e=t;if(e.event===`connect.challenge`){let t=e.payload,n=t&&typeof t.nonce==`string`?t.nonce:null;n&&(this.connectNonce=n,this.sendConnect());return}let n=typeof e.seq==`number`?e.seq:null;n!==null&&(this.lastSeq!==null&&n>this.lastSeq+1&&this.opts.onGap?.({expected:this.lastSeq+1,received:n}),this.lastSeq=n);try{this.opts.onEvent?.(e)}catch(e){console.error(`[gateway] event handler error:`,e)}return}if(n.type===`res`){let e=t,n=this.pending.get(e.id);if(!n)return;this.pending.delete(e.id),e.ok?n.resolve(e.payload):n.reject(new Nh({code:e.error?.code??`UNAVAILABLE`,message:e.error?.message??`request failed`,details:e.error?.details}));return}}selectConnectAuth(e){let t=this.opts.token?.trim()||void 0,n=this.opts.password?.trim()||void 0,r=Ln({deviceId:e.deviceId,role:e.role})?.token,i=this.pendingDeviceTokenRetry&&!!t&&!!r&&Ih(this.opts.url),a=t||n?void 0:r??void 0;return{authToken:t??a,authDeviceToken:i?r??void 0:void 0,authPassword:n,resolvedDeviceToken:a,storedToken:r??void 0,canFallbackToShared:!!(r&&t)}}request(e,t){if(!this.ws||this.ws.readyState!==WebSocket.OPEN)return Promise.reject(Error(`gateway not connected`));let n=Mh(),r={type:`req`,id:n,method:e,params:t},i=new Promise((e,t)=>{this.pending.set(n,{resolve:t=>e(t),reject:t})});return this.ws.send(JSON.stringify(r)),i}queueConnect(){this.connectNonce=null,this.connectSent=!1,this.connectTimer!==null&&window.clearTimeout(this.connectTimer),this.connectTimer=window.setTimeout(()=>{this.sendConnect()},750)}};function Wh(e){return typeof e==`string`?e:e instanceof Error&&typeof e.message==`string`?e.message:`unknown error`}function Gh(e){let t=Wh(e.message);switch(Ph(e)){case X.AUTH_TOKEN_MISMATCH:return`gateway token mismatch`;case X.AUTH_UNAUTHORIZED:return`gateway auth failed`;case X.AUTH_RATE_LIMITED:return`too many failed authentication attempts`;case X.PAIRING_REQUIRED:return`gateway pairing required`;case X.CONTROL_UI_DEVICE_IDENTITY_REQUIRED:return`device identity required (use HTTPS/localhost or allow insecure auth explicitly)`;case X.CONTROL_UI_ORIGIN_NOT_ALLOWED:return`origin not allowed (open the Control UI from the gateway host or allow it in gateway.controlUi.allowedOrigins)`;case X.AUTH_TOKEN_MISSING:return`gateway token missing`;default:break}let n=t.trim().toLowerCase();return n===`fetch failed`||n===`failed to fetch`||n===`connect failed`?`gateway connect failed`:t}function Kh(e){return e&&typeof e==`object`?Gh(e):Wh(e)}var qh=/^\s*NO_REPLY\s*$/;function Jh(e){return qh.test(e)}function Yh(e){if(!e||typeof e!=`object`)return!1;let t=e;if((typeof t.role==`string`?t.role.toLowerCase():``)!==`assistant`)return!1;if(typeof t.text==`string`)return Jh(t.text);let n=Io(e);return typeof n==`string`&&Jh(n)}function Xh(e){let t=e;t.toolStreamById instanceof Map&&Array.isArray(t.toolStreamOrder)&&Array.isArray(t.chatToolMessages)&&Array.isArray(t.chatStreamSegments)&&ym(t)}async function Zh(e){if(!(!e.client||!e.connected)){e.chatLoading=!0,e.lastError=null;try{let t=await e.client.request(`chat.history`,{sessionKey:e.sessionKey,limit:200});e.chatMessages=(Array.isArray(t.messages)?t.messages:[]).filter(e=>!Yh(e)),e.chatThinkingLevel=t.thinkingLevel??null,Xh(e),e.chatStream=null,e.chatStreamStartedAt=null}catch(t){e.lastError=String(t)}finally{e.chatLoading=!1}}}function Qh(e){let t=/^data:([^;]+);base64,(.+)$/.exec(e);return t?{mimeType:t[1],content:t[2]}:null}function $h(e,t){if(!e||typeof e!=`object`)return null;let n=e,r=n.role;if(typeof r==`string`){if((t.roleCaseSensitive?r:r.toLowerCase())!==`assistant`)return null}else if(t.roleRequirement===`required`)return null;return t.requireContentArray?Array.isArray(n.content)?n:null:!(`content`in n)&&!(t.allowTextField&&`text`in n)?null:n}function eg(e){return $h(e,{roleRequirement:`required`,roleCaseSensitive:!0,requireContentArray:!0})}function tg(e){return $h(e,{roleRequirement:`optional`,allowTextField:!0})}async function ng(e,t,n){if(!e.client||!e.connected)return null;let r=t.trim(),i=n&&n.length>0;if(!r&&!i)return null;let a=Date.now(),o=[];if(r&&o.push({type:`text`,text:r}),i)for(let e of n)o.push({type:`image`,source:{type:`base64`,media_type:e.mimeType,data:e.dataUrl}});e.chatMessages=[...e.chatMessages,{role:`user`,content:o,timestamp:a}],e.chatSending=!0,e.lastError=null;let s=Mh();e.chatRunId=s,e.chatStream=``,e.chatStreamStartedAt=a;let c=i?n.map(e=>{let t=Qh(e.dataUrl);return t?{type:`image`,mimeType:t.mimeType,content:t.content}:null}).filter(e=>e!==null):void 0;try{return await e.client.request(`chat.send`,{sessionKey:e.sessionKey,message:r,deliver:!1,idempotencyKey:s,attachments:c}),s}catch(t){let n=Kh(t);return e.chatRunId=null,e.chatStream=null,e.chatStreamStartedAt=null,e.lastError=n,e.chatMessages=[...e.chatMessages,{role:`assistant`,content:[{type:`text`,text:`Error: `+n}],timestamp:Date.now()}],null}finally{e.chatSending=!1}}async function rg(e){if(!e.client||!e.connected)return!1;let t=e.chatRunId;try{return await e.client.request(`chat.abort`,t?{sessionKey:e.sessionKey,runId:t}:{sessionKey:e.sessionKey}),!0}catch(t){return e.lastError=Kh(t),!1}}function ig(e,t){if(!t||t.sessionKey!==e.sessionKey)return null;if(t.runId&&e.chatRunId&&t.runId!==e.chatRunId){if(t.state===`final`){let n=tg(t.message);return n&&!Yh(n)?(e.chatMessages=[...e.chatMessages,n],null):`final`}return null}if(t.state===`delta`){let n=Io(t.message);if(typeof n==`string`&&!Jh(n)){let t=e.chatStream??``;(!t||n.length>=t.length)&&(e.chatStream=n)}}else if(t.state===`final`){let n=tg(t.message);n&&!Yh(n)?e.chatMessages=[...e.chatMessages,n]:e.chatStream?.trim()&&!Jh(e.chatStream)&&(e.chatMessages=[...e.chatMessages,{role:`assistant`,content:[{type:`text`,text:e.chatStream}],timestamp:Date.now()}]),e.chatStream=null,e.chatRunId=null,e.chatStreamStartedAt=null}else if(t.state===`aborted`){let n=eg(t.message);if(n&&!Yh(n))e.chatMessages=[...e.chatMessages,n];else{let t=e.chatStream??``;t.trim()&&!Jh(t)&&(e.chatMessages=[...e.chatMessages,{role:`assistant`,content:[{type:`text`,text:t}],timestamp:Date.now()}])}e.chatStream=null,e.chatRunId=null,e.chatStreamStartedAt=null}else t.state===`error`&&(e.chatStream=null,e.chatRunId=null,e.chatStreamStartedAt=null,e.lastError=t.errorMessage??`chat error`);return t.state}async function ag(e){try{return(await e.request(`models.list`,{}))?.models??[]}catch{return[]}}function og(e){return e.chatSending||!!e.chatRunId}function sg(e){let t=e.trim();if(!t)return!1;let n=t.toLowerCase();return n===`/stop`?!0:n===`stop`||n===`esc`||n===`abort`||n===`wait`||n===`exit`}function cg(e){let t=e.trim();if(!t)return!1;let n=t.toLowerCase();return n===`/new`||n===`/reset`?!0:n.startsWith(`/new `)||n.startsWith(`/reset `)}async function lg(e){e.connected&&(e.chatMessage=``,await rg(e))}function ug(e,t,n,r,i){let a=t.trim(),o=!!(n&&n.length>0);!a&&!o||(e.chatQueue=[...e.chatQueue,{id:Mh(),text:a,createdAt:Date.now(),attachments:o?n?.map(e=>({...e})):void 0,refreshSessions:r,localCommandArgs:i?.args,localCommandName:i?.name}])}async function dg(e,t,n){ym(e),ht(e);let r=await ng(e,t,n?.attachments),i=!!r;return!i&&n?.previousDraft!=null&&(e.chatMessage=n.previousDraft),!i&&n?.previousAttachments&&(e.chatAttachments=n.previousAttachments),i&&Mp(e,e.sessionKey),i&&n?.restoreDraft&&n.previousDraft?.trim()&&(e.chatMessage=n.previousDraft),i&&n?.restoreAttachments&&n.previousAttachments?.length&&(e.chatAttachments=n.previousAttachments),dt(e,!0),i&&!e.chatRunId&&fg(e),i&&n?.refreshSessions&&r&&e.refreshSessionsAfterChat.add(r),i}async function fg(e){if(!e.connected||og(e))return;let[t,...n]=e.chatQueue;if(!t)return;e.chatQueue=n;let r=!1;try{t.localCommandName?(await gg(e,t.localCommandName,t.localCommandArgs??``),r=!0):r=await dg(e,t.text,{attachments:t.attachments,refreshSessions:t.refreshSessions})}catch(t){e.lastError=String(t)}r?e.chatQueue.length>0&&fg(e):e.chatQueue=[t,...e.chatQueue]}function pg(e,t){e.chatQueue=e.chatQueue.filter(e=>e.id!==t)}async function mg(e,t,n){if(!e.connected)return;let r=e.chatMessage,i=(t??e.chatMessage).trim(),a=e.chatAttachments??[],o=t==null?a:[],s=o.length>0;if(!i&&!s)return;if(sg(i)){await lg(e);return}let c=Hf(i);if(c?.command.executeLocal){if(og(e)&&hg(c.command.name)){t??(e.chatMessage=``,e.chatAttachments=[]),ug(e,i,void 0,cg(i),{args:c.args,name:c.command.name});return}let a=t==null?r:void 0;t??(e.chatMessage=``,e.chatAttachments=[]),await gg(e,c.command.name,c.args,{previousDraft:a,restoreDraft:!!(t&&n?.restoreDraft)});return}let l=cg(i);if(t??(e.chatMessage=``,e.chatAttachments=[]),og(e)){ug(e,i,o,l);return}await dg(e,i,{previousDraft:t==null?r:void 0,restoreDraft:!!(t&&n?.restoreDraft),attachments:s?o:void 0,previousAttachments:t==null?a:void 0,restoreAttachments:!!(t&&n?.restoreDraft),refreshSessions:l})}function hg(e){return![`stop`,`focus`,`export`].includes(e)}async function gg(e,t,n,r){switch(t){case`stop`:await lg(e);return;case`new`:await dg(e,`/new`,{refreshSessions:!0,previousDraft:r?.previousDraft,restoreDraft:r?.restoreDraft});return;case`reset`:await dg(e,`/reset`,{refreshSessions:!0,previousDraft:r?.previousDraft,restoreDraft:r?.restoreDraft});return;case`clear`:await _g(e);return;case`focus`:e.onSlashAction?.(`toggle-focus`);return;case`export`:e.onSlashAction?.(`export`);return}if(!e.client)return;let i=e.sessionKey,a=await $m(e.client,i,t,n);a.content&&vg(e,a.content),a.sessionPatch&&`modelOverride`in a.sessionPatch&&(e.chatModelOverrides={...e.chatModelOverrides,[i]:a.sessionPatch.modelOverride??null}),a.action===`refresh`&&await yg(e),dt(e)}async function _g(e){if(!(!e.client||!e.connected)){try{await e.client.request(`sessions.reset`,{key:e.sessionKey}),e.chatMessages=[],e.chatStream=null,e.chatRunId=null,await Zh(e)}catch(t){e.lastError=String(t)}dt(e)}}function vg(e,t){e.chatMessages=[...e.chatMessages,{role:`system`,content:t,timestamp:Date.now()}]}async function yg(e,t){await Promise.all([Zh(e),ki(e,{activeMinutes:0,limit:0,includeGlobal:!0,includeUnknown:!0}),wg(e),bg(e)]),t?.scheduleScroll!==!1&&dt(e)}async function bg(e){if(!e.client||!e.connected){e.chatModelsLoading=!1,e.chatModelCatalog=[];return}e.chatModelsLoading=!0;try{e.chatModelCatalog=await ag(e.client)}finally{e.chatModelsLoading=!1}}var xg=fg;function Sg(e){let t=st(e.sessionKey);return t?.agentId?t.agentId:(e.hello?.snapshot)?.sessionDefaults?.defaultAgentId?.trim()||`main`}function Cg(e,t){let n=ua(e),r=encodeURIComponent(t);return n?`${n}/avatar/${r}?meta=1`:`avatar/${r}?meta=1`}async function wg(e){if(!e.connected){e.chatAvatarUrl=null;return}let t=Sg(e);if(!t){e.chatAvatarUrl=null;return}e.chatAvatarUrl=null;let n=Cg(e.basePath,t);try{let t=await fetch(n,{method:`GET`});if(!t.ok){e.chatAvatarUrl=null;return}let r=await t.json();e.chatAvatarUrl=(typeof r.avatarUrl==`string`?r.avatarUrl.trim():``)||null}catch{e.chatAvatarUrl=null}}function Tg(e){if(!e||e.state!==`final`)return!1;if(!e.message||typeof e.message!=`object`)return!0;let t=e.message,n=typeof t.role==`string`?t.role.toLowerCase():``;return!!(n&&n!==`assistant`)}function Eg(e,t){if(typeof e!=`string`)return;let n=e.trim();if(n)return n.length<=t?n:n.slice(0,t)}var Dg=50,Og=200;function kg(e){let t=Eg(e?.name,Dg)??`Assistant`,n=Eg(e?.avatar??void 0,Og)??null;return{agentId:typeof e?.agentId==`string`&&e.agentId.trim()?e.agentId.trim():null,name:t,avatar:n}}async function Ag(e,t){if(!e.client||!e.connected)return;let n=t?.sessionKey?.trim()||e.sessionKey.trim(),r=n?{sessionKey:n}:{};try{let t=await e.client.request(`agent.identity.get`,r);if(!t)return;let n=kg(t);e.assistantName=n.name,e.assistantAvatar=n.avatar,e.assistantAgentId=n.agentId??null}catch{}}function jg(e){return typeof e==`object`&&!!e}function Mg(e){if(!jg(e))return null;let t=typeof e.id==`string`?e.id.trim():``,n=e.request;if(!t||!jg(n))return null;let r=typeof n.command==`string`?n.command.trim():``;if(!r)return null;let i=typeof e.createdAtMs==`number`?e.createdAtMs:0,a=typeof e.expiresAtMs==`number`?e.expiresAtMs:0;return!i||!a?null:{id:t,request:{command:r,cwd:typeof n.cwd==`string`?n.cwd:null,host:typeof n.host==`string`?n.host:null,security:typeof n.security==`string`?n.security:null,ask:typeof n.ask==`string`?n.ask:null,agentId:typeof n.agentId==`string`?n.agentId:null,resolvedPath:typeof n.resolvedPath==`string`?n.resolvedPath:null,sessionKey:typeof n.sessionKey==`string`?n.sessionKey:null},createdAtMs:i,expiresAtMs:a}}function Ng(e){if(!jg(e))return null;let t=typeof e.id==`string`?e.id.trim():``;return t?{id:t,decision:typeof e.decision==`string`?e.decision:null,resolvedBy:typeof e.resolvedBy==`string`?e.resolvedBy:null,ts:typeof e.ts==`number`?e.ts:null}:null}function Pg(e){let t=Date.now();return e.filter(e=>e.expiresAtMs>t)}function Fg(e,t){let n=Pg(e).filter(e=>e.id!==t.id);return n.push(t),n}function Ig(e,t){return Pg(e).filter(e=>e.id!==t)}var Lg={ok:!1,ts:0,durationMs:0,heartbeatSeconds:0,defaultAgentId:``,agents:[],sessions:{path:``,count:0,recent:[]}};async function Rg(e){try{return await e.request(`health`,{})??Lg}catch{return Lg}}async function zg(e){if(!(!e.client||!e.connected)&&!e.healthLoading){e.healthLoading=!0,e.healthError=null;try{e.healthResult=await Rg(e.client)}catch(t){e.healthError=String(t)}finally{e.healthLoading=!1}}}function Bg(e){return/^(?:typeerror:\s*)?(?:fetch failed|failed to fetch)$/i.test(e.trim())}function Vg(e){let t=e.serverVersion?.trim();if(!t)return;let n=e.pageUrl??(typeof window>`u`?void 0:window.location.href);if(n)try{let r=new URL(n),i=new URL(e.gatewayUrl,r);return!new Set([`ws:`,`wss:`,`http:`,`https:`]).has(i.protocol)||i.host!==r.host?void 0:t}catch{return}}function Hg(e,t){let n=(e??``).trim(),r=t.mainSessionKey?.trim();if(!r)return n;if(!n)return r;let i=t.mainKey?.trim()||`main`,a=t.defaultAgentId?.trim();return n===`main`||n===i||a&&(n===`agent:${a}:main`||n===`agent:${a}:${i}`)?r:n}function Ug(e,t){if(!t?.mainSessionKey)return;let n=Hg(e.sessionKey,t),r=Hg(e.settings.sessionKey,t),i=Hg(e.settings.lastActiveSessionKey,t),a=n||r||e.sessionKey,o={...e.settings,sessionKey:r||a,lastActiveSessionKey:i||a},s=o.sessionKey!==e.settings.sessionKey||o.lastActiveSessionKey!==e.settings.lastActiveSessionKey;a!==e.sessionKey&&(e.sessionKey=a),s&&jp(e,o)}function Wg(e){let t=e;t.pendingShutdownMessage=null,e.lastError=null,e.lastErrorCode=null,e.hello=null,e.connected=!1,e.execApprovalQueue=[],e.execApprovalError=null;let n=e.client,r=Vg({gatewayUrl:e.settings.gatewayUrl,serverVersion:e.serverVersion}),i=new Uh({url:e.settings.gatewayUrl,token:e.settings.token.trim()?e.settings.token:void 0,password:e.password.trim()?e.password:void 0,clientName:`openclaw-control-ui`,clientVersion:r,mode:`webchat`,instanceId:e.clientInstanceId,onHello:n=>{e.client===i&&(t.pendingShutdownMessage=null,e.connected=!0,e.lastError=null,e.lastErrorCode=null,e.hello=n,Yg(e,n),e.chatRunId=null,e.chatStream=null,e.chatStreamStartedAt=null,ym(e),Oi(e),Ag(e),Wt(e),zg(e),Pt(e,{quiet:!0}),ni(e,{quiet:!0}),Lp(e))},onClose:({code:n,reason:r,error:a})=>{if(e.client===i)if(e.connected=!1,e.lastErrorCode=Ph(a)??(typeof a?.code==`string`?a.code:null),n!==1012){if(a?.message){e.lastError=e.lastErrorCode&&Bg(a.message)?Kh({message:a.message,details:a.details,code:a.code}):a.message;return}e.lastError=t.pendingShutdownMessage??`disconnected (${n}): ${r||`no reason`}`}else e.lastError=t.pendingShutdownMessage??null,e.lastErrorCode=null},onEvent:t=>{e.client===i&&Gg(e,t)},onGap:({expected:t,received:n})=>{e.client===i&&(e.lastError=`event gap detected (expected seq ${t}, got ${n}); refresh recommended`,e.lastErrorCode=null)}});e.client=i,n?.stop(),i.start()}function Gg(e,t){try{Jg(e,t)}catch(e){console.error(`[gateway] handleGatewayEvent error:`,t.event,e)}}function Kg(e,t,n){if(n!==`final`&&n!==`error`&&n!==`aborted`)return!1;let r=e,i=r.toolStreamOrder.length>0;ym(r),xg(e);let a=t?.runId;return a&&e.refreshSessionsAfterChat.has(a)&&(e.refreshSessionsAfterChat.delete(a),n===`final`&&ki(e,{activeMinutes:120})),i&&n===`final`?(Zh(e),!0):!1}function qg(e,t){t?.sessionKey&&Mp(e,t.sessionKey);let n=ig(e,t),r=Kg(e,t,n);n===`final`&&!r&&Tg(t)&&Zh(e)}function Jg(e,t){if(e.eventLogBuffer=[{ts:Date.now(),event:t.event,payload:t.payload},...e.eventLogBuffer].slice(0,250),(e.tab===`debug`||e.tab===`overview`)&&(e.eventLog=e.eventLogBuffer),t.event===`agent`){if(e.onboarding)return;Tm(e,t.payload);return}if(t.event===`chat`){qg(e,t.payload);return}if(t.event===`presence`){let n=t.payload;n?.presence&&Array.isArray(n.presence)&&(e.presenceEntries=n.presence,e.presenceError=null,e.presenceStatus=null);return}if(t.event===`shutdown`){let n=t.payload,r=n&&typeof n.reason==`string`&&n.reason.trim()?n.reason.trim():`gateway stopping`,i=typeof n?.restartExpectedMs==`number`?`Restarting: ${r}`:`Disconnected: ${r}`;e.pendingShutdownMessage=i,e.lastError=i,e.lastErrorCode=null;return}if(t.event===`sessions.changed`){ki(e);return}if(t.event===`cron`&&e.tab===`cron`&&im(e),(t.event===`device.pair.requested`||t.event===`device.pair.resolved`)&&ni(e,{quiet:!0}),t.event===`exec.approval.requested`){let n=Mg(t.payload);if(n){e.execApprovalQueue=Fg(e.execApprovalQueue,n),e.execApprovalError=null;let t=Math.max(0,n.expiresAtMs-Date.now()+500);window.setTimeout(()=>{e.execApprovalQueue=Ig(e.execApprovalQueue,n.id)},t)}return}if(t.event===`exec.approval.resolved`){let n=Ng(t.payload);n&&(e.execApprovalQueue=Ig(e.execApprovalQueue,n.id));return}t.event===`update.available`&&(e.updateAvailable=t.payload?.updateAvailable??null)}function Yg(e,t){let n=t.snapshot;n?.presence&&Array.isArray(n.presence)&&(e.presenceEntries=n.presence),n?.health&&(e.debugHealth=n.health,e.healthResult=n.health),n?.sessionDefaults&&Ug(e,n.sessionDefaults),e.updateAvailable=n?.updateAvailable??null}var Xg=`/__openclaw/control-ui-config.json`;async function Zg(e){if(typeof window>`u`||typeof fetch!=`function`)return;let t=ua(e.basePath??``),n=t?`${t}${Xg}`:Xg;try{let t=await fetch(n,{method:`GET`,headers:{Accept:`application/json`},credentials:`same-origin`});if(!t.ok)return;let r=await t.json(),i=kg({agentId:r.assistantAgentId??null,name:r.assistantName,avatar:r.assistantAvatar??null});e.assistantName=i.name,e.assistantAvatar=i.avatar,e.assistantAgentId=i.agentId??null,e.serverVersion=r.serverVersion??null}catch{}}function Qg(e){let t=++e.connectGeneration;e.basePath=Rp(),Np(e);let n=Zg(e);Kp(e,!0),zp(e),Bp(e),window.addEventListener(`popstate`,e.popStateHandler),n.finally(()=>{e.connectGeneration===t&&Wg(e)}),Ft(e),e.tab===`logs`&&Lt(e),e.tab===`debug`&&zt(e)}function $g(e){_t(e)}function e_(e){e.connectGeneration+=1,window.removeEventListener(`popstate`,e.popStateHandler),It(e),Rt(e),Bt(e),e.client?.stop(),e.client=null,e.connected=!1,Vp(e),e.topbarObserver?.disconnect(),e.topbarObserver=null}function t_(e,t){if(!(e.tab===`chat`&&e.chatManualRefreshInFlight)){if(e.tab===`chat`&&(t.has(`chatMessages`)||t.has(`chatToolMessages`)||t.has(`chatStream`)||t.has(`chatLoading`)||t.has(`tab`))){let n=t.has(`tab`),r=t.has(`chatLoading`)&&t.get(`chatLoading`)===!0&&!e.chatLoading,i=t.get(`chatStream`),a=t.has(`chatStream`)&&i==null&&typeof e.chatStream==`string`;dt(e,n||r||a||!e.chatHasAutoScrolled)}e.tab===`logs`&&(t.has(`logsEntries`)||t.has(`logsAutoFollow`)||t.has(`tab`))&&e.logsAutoFollow&&e.logsAtBottom&&ft(e,t.has(`tab`)||t.has(`logsAutoFollow`))}}var n_=new Set([`agent`,`channel`,`chat`,`provider`,`model`,`tool`,`label`,`key`,`session`,`id`,`has`,`mintokens`,`maxtokens`,`mincost`,`maxcost`,`minmessages`,`maxmessages`]),r_=e=>e.trim().toLowerCase(),i_=e=>{let t=e.replace(/[.+^${}()|[\]\\]/g,`\\$&`).replace(/\*/g,`.*`).replace(/\?/g,`.`);return RegExp(`^${t}$`,`i`)},a_=e=>{let t=e.trim().toLowerCase();if(!t)return null;t.startsWith(`$`)&&(t=t.slice(1));let n=1;t.endsWith(`k`)?(n=1e3,t=t.slice(0,-1)):t.endsWith(`m`)&&(n=1e6,t=t.slice(0,-1));let r=Number(t);return Number.isFinite(r)?r*n:null},o_=e=>(e.match(/"[^"]+"|\S+/g)??[]).map(e=>{let t=e.replace(/^"|"$/g,``),n=t.indexOf(`:`);return n>0?{key:t.slice(0,n),value:t.slice(n+1),raw:t}:{value:t,raw:t}}),s_=e=>[e.label,e.key,e.sessionId].filter(e=>!!e).map(e=>e.toLowerCase()),c_=e=>{let t=new Set;e.modelProvider&&t.add(e.modelProvider.toLowerCase()),e.providerOverride&&t.add(e.providerOverride.toLowerCase()),e.origin?.provider&&t.add(e.origin.provider.toLowerCase());for(let n of e.usage?.modelUsage??[])n.provider&&t.add(n.provider.toLowerCase());return Array.from(t)},l_=e=>{let t=new Set;e.model&&t.add(e.model.toLowerCase());for(let n of e.usage?.modelUsage??[])n.model&&t.add(n.model.toLowerCase());return Array.from(t)},u_=e=>(e.usage?.toolUsage?.tools??[]).map(e=>e.name.toLowerCase()),d_=(e,t)=>{let n=r_(t.value??``);if(!n)return!0;if(!t.key)return s_(e).some(e=>e.includes(n));switch(r_(t.key)){case`agent`:return e.agentId?.toLowerCase().includes(n)??!1;case`channel`:return e.channel?.toLowerCase().includes(n)??!1;case`chat`:return e.chatType?.toLowerCase().includes(n)??!1;case`provider`:return c_(e).some(e=>e.includes(n));case`model`:return l_(e).some(e=>e.includes(n));case`tool`:return u_(e).some(e=>e.includes(n));case`label`:return e.label?.toLowerCase().includes(n)??!1;case`key`:case`session`:case`id`:if(n.includes(`*`)||n.includes(`?`)){let t=i_(n);return t.test(e.key)||(e.sessionId?t.test(e.sessionId):!1)}return e.key.toLowerCase().includes(n)||(e.sessionId?.toLowerCase().includes(n)??!1);case`has`:switch(n){case`tools`:return(e.usage?.toolUsage?.totalCalls??0)>0;case`errors`:return(e.usage?.messageCounts?.errors??0)>0;case`context`:return!!e.contextWeight;case`usage`:return!!e.usage;case`model`:return l_(e).length>0;case`provider`:return c_(e).length>0;default:return!0}case`mintokens`:{let t=a_(n);return t===null?!0:(e.usage?.totalTokens??0)>=t}case`maxtokens`:{let t=a_(n);return t===null?!0:(e.usage?.totalTokens??0)<=t}case`mincost`:{let t=a_(n);return t===null?!0:(e.usage?.totalCost??0)>=t}case`maxcost`:{let t=a_(n);return t===null?!0:(e.usage?.totalCost??0)<=t}case`minmessages`:{let t=a_(n);return t===null?!0:(e.usage?.messageCounts?.total??0)>=t}case`maxmessages`:{let t=a_(n);return t===null?!0:(e.usage?.messageCounts?.total??0)<=t}default:return!0}},f_=(e,t)=>{let n=o_(t);if(n.length===0)return{sessions:e,warnings:[]};let r=[];for(let e of n){if(!e.key)continue;let t=r_(e.key);if(!n_.has(t)){r.push(`Unknown filter: ${e.key}`);continue}if(e.value===``&&r.push(`Missing value for ${e.key}`),t===`has`){let t=new Set([`tools`,`errors`,`context`,`usage`,`model`,`provider`]);e.value&&!t.has(r_(e.value))&&r.push(`Unknown has:${e.value}`)}[`mintokens`,`maxtokens`,`mincost`,`maxcost`,`minmessages`,`maxmessages`].includes(t)&&e.value&&a_(e.value)===null&&r.push(`Invalid number for ${e.key}`)}return{sessions:e.filter(e=>n.every(t=>d_(e,t))),warnings:r}};function p_(e){let t=e.split(`
...
`).trim()}}function m_(e,t){!t||t.count<=0||(e.count+=t.count,e.sum+=t.avgMs*t.count,e.min=Math.min(e.min,t.minMs),e.max=Math.max(e.max,t.maxMs),e.p95Max=Math.max(e.p95Max,t.p95Ms))}function h_(e,t){for(let n of t??[]){let t=e.get(n.date)??{date:n.date,count:0,sum:0,min:1/0,max:0,p95Max:0};t.count+=n.count,t.sum+=n.avgMs*n.count,t.min=Math.min(t.min,n.minMs),t.max=Math.max(t.max,n.maxMs),t.p95Max=Math.max(t.p95Max,n.p95Ms),e.set(n.date,t)}}function g_(e){return{byChannel:Array.from(e.byChannelMap.entries()).map(([e,t])=>({channel:e,totals:t})).toSorted((e,t)=>t.totals.totalCost-e.totals.totalCost),latency:e.latencyTotals.count>0?{count:e.latencyTotals.count,avgMs:e.latencyTotals.sum/e.latencyTotals.count,minMs:e.latencyTotals.min===1/0?0:e.latencyTotals.min,maxMs:e.latencyTotals.max,p95Ms:e.latencyTotals.p95Max}:void 0,dailyLatency:Array.from(e.dailyLatencyMap.values()).map(e=>({date:e.date,count:e.count,avgMs:e.count?e.sum/e.count:0,minMs:e.min===1/0?0:e.min,maxMs:e.max,p95Ms:e.p95Max})).toSorted((e,t)=>e.date.localeCompare(t.date)),modelDaily:Array.from(e.modelDailyMap.values()).toSorted((e,t)=>e.date.localeCompare(t.date)||t.cost-e.cost),daily:Array.from(e.dailyMap.values()).toSorted((e,t)=>e.date.localeCompare(t.date))}}var __=4;function v_(e){return Math.round(e/__)}function Z(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:String(e)}function y_(e){let t=new Date;return t.setHours(e,0,0,0),t.toLocaleTimeString(void 0,{hour:`numeric`})}function b_(e,t){let n=Array.from({length:24},()=>0),r=Array.from({length:24},()=>0);for(let i of e){let e=i.usage;if(!e?.messageCounts||e.messageCounts.total===0)continue;let a=e.firstActivity??i.updatedAt,o=e.lastActivity??i.updatedAt;if(!a||!o)continue;let s=Math.min(a,o),c=Math.max(a,o),l=Math.max(c-s,1)/6e4,u=s;for(;u<c;){let i=new Date(u),a=x_(i,t),o=C_(i,t),s=Math.min(o.getTime(),c),d=Math.max((s-u)/6e4,0)/l;n[a]+=e.messageCounts.errors*d,r[a]+=e.messageCounts.total*d,u=s+1}}return r.map((e,t)=>{let r=n[t];return{hour:t,rate:e>0?r/e:0,errors:r,msgs:e}}).filter(e=>e.msgs>0&&e.errors>0).toSorted((e,t)=>t.rate-e.rate).slice(0,5).map(e=>({label:y_(e.hour),value:`${(e.rate*100).toFixed(2)}%`,sub:`${Math.round(e.errors)} ${P(`usage.overview.errors`).toLowerCase()} · ${Math.round(e.msgs)} ${P(`usage.overview.messagesAbbrev`)}`}))}function x_(e,t){return t===`utc`?e.getUTCHours():e.getHours()}function S_(e,t){return t===`utc`?e.getUTCDay():e.getDay()}function C_(e,t){let n=new Date(e);return t===`utc`?n.setUTCMinutes(59,59,999):n.setMinutes(59,59,999),n}function w_(e,t){let n=Array.from({length:24},()=>0),r=Array.from({length:7},()=>0),i=0,a=!1;for(let o of e){let e=o.usage;if(!e||!e.totalTokens||e.totalTokens<=0)continue;i+=e.totalTokens;let s=e.firstActivity??o.updatedAt,c=e.lastActivity??o.updatedAt;if(!s||!c)continue;a=!0;let l=Math.min(s,c),u=Math.max(s,c),d=Math.max(u-l,1)/6e4,f=l;for(;f<u;){let i=new Date(f),a=x_(i,t),o=S_(i,t),s=C_(i,t),c=Math.min(s.getTime(),u),l=Math.max((c-f)/6e4,0)/d;n[a]+=e.totalTokens*l,r[o]+=e.totalTokens*l,f=c+1}}let o=[P(`usage.mosaic.sun`),P(`usage.mosaic.mon`),P(`usage.mosaic.tue`),P(`usage.mosaic.wed`),P(`usage.mosaic.thu`),P(`usage.mosaic.fri`),P(`usage.mosaic.sat`)].map((e,t)=>({label:e,tokens:r[t]}));return{hasData:a,totalTokens:i,hourTotals:n,weekdayTotals:o}}function T_(e,t,r,i){let a=w_(e,t);if(!a.hasData)return n`
  ...
  `}function Q(e,t=2){return`$${e.toFixed(t)}`}function E_(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function D_(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!t)return null;let[,n,r,i]=t,a=new Date(Date.UTC(Number(n),Number(r)-1,Number(i)));return Number.isNaN(a.valueOf())?null:a}function O_(e){let t=D_(e);return t?t.toLocaleDateString(void 0,{month:`short`,day:`numeric`}):e}function k_(e){let t=D_(e);return t?t.toLocaleDateString(void 0,{month:`long`,day:`numeric`,year:`numeric`}):e}var A_=()=>({input:0,output:0,cacheRead:0,cacheWrite:0,totalTokens:0,totalCost:0,inputCost:0,outputCost:0,cacheReadCost:0,cacheWriteCost:0,missingCostEntries:0}),j_=(e,t)=>{e.input+=t.input??0,e.output+=t.output??0,e.cacheRead+=t.cacheRead??0,e.cacheWrite+=t.cacheWrite??0,e.totalTokens+=t.totalTokens??0,e.totalCost+=t.totalCost??0,e.inputCost+=t.inputCost??0,e.outputCost+=t.outputCost??0,e.cacheReadCost+=t.cacheReadCost??0,e.cacheWriteCost+=t.cacheWriteCost??0,e.missingCostEntries+=t.missingCostEntries??0},M_=(e,t)=>{if(e.length===0)return t??{messages:{total:0,user:0,assistant:0,toolCalls:0,toolResults:0,errors:0},tools:{totalCalls:0,uniqueTools:0,tools:[]},byModel:[],byProvider:[],byAgent:[],byChannel:[],daily:[]};let n={total:0,user:0,assistant:0,toolCalls:0,toolResults:0,errors:0},r=new Map,i=new Map,a=new Map,o=new Map,s=new Map,c=new Map,l=new Map,u=new Map,d={count:0,sum:0,min:1/0,max:0,p95Max:0};for(let t of e){let e=t.usage;if(e){if(e.messageCounts&&(n.total+=e.messageCounts.total,n.user+=e.messageCounts.user,n.assistant+=e.messageCounts.assistant,n.toolCalls+=e.messageCounts.toolCalls,n.toolResults+=e.messageCounts.toolResults,n.errors+=e.messageCounts.errors),e.toolUsage)for(let t of e.toolUsage.tools)r.set(t.name,(r.get(t.name)??0)+t.count);if(e.modelUsage)for(let t of e.modelUsage){let e=`${t.provider??`unknown`}::${t.model??`unknown`}`,n=i.get(e)??{provider:t.provider,model:t.model,count:0,totals:A_()};n.count+=t.count,j_(n.totals,t.totals),i.set(e,n);let r=t.provider??`unknown`,o=a.get(r)??{provider:t.provider,model:void 0,count:0,totals:A_()};o.count+=t.count,j_(o.totals,t.totals),a.set(r,o)}if(m_(d,e.latency),t.agentId){let n=o.get(t.agentId)??A_();j_(n,e),o.set(t.agentId,n)}if(t.channel){let n=s.get(t.channel)??A_();j_(n,e),s.set(t.channel,n)}for(let t of e.dailyBreakdown??[]){let e=c.get(t.date)??{date:t.date,tokens:0,cost:0,messages:0,toolCalls:0,errors:0};e.tokens+=t.tokens,e.cost+=t.cost,c.set(t.date,e)}for(let t of e.dailyMessageCounts??[]){let e=c.get(t.date)??{date:t.date,tokens:0,cost:0,messages:0,toolCalls:0,errors:0};e.messages+=t.total,e.toolCalls+=t.toolCalls,e.errors+=t.errors,c.set(t.date,e)}h_(l,e.dailyLatency);for(let t of e.dailyModelUsage??[]){let e=`${t.date}::${t.provider??`unknown`}::${t.model??`unknown`}`,n=u.get(e)??{date:t.date,provider:t.provider,model:t.model,tokens:0,cost:0,count:0};n.tokens+=t.tokens,n.cost+=t.cost,n.count+=t.count,u.set(e,n)}}}let f=g_({byChannelMap:s,latencyTotals:d,dailyLatencyMap:l,modelDailyMap:u,dailyMap:c});return{messages:n,tools:{totalCalls:Array.from(r.values()).reduce((e,t)=>e+t,0),uniqueTools:r.size,tools:Array.from(r.entries()).map(([e,t])=>({name:e,count:t})).toSorted((e,t)=>t.count-e.count)},byModel:Array.from(i.values()).toSorted((e,t)=>t.totals.totalCost-e.totals.totalCost),byProvider:Array.from(a.values()).toSorted((e,t)=>t.totals.totalCost-e.totals.totalCost),byAgent:Array.from(o.entries()).map(([e,t])=>({agentId:e,totals:t})).toSorted((e,t)=>t.totals.totalCost-e.totals.totalCost),...f}},N_=(e,t,n)=>{let r=0,i=0;for(let t of e){let e=t.usage?.durationMs??0;e>0&&(r+=e,i+=1)}let a=i?r/i:0,o=t&&r>0?t.totalTokens/(r/6e4):void 0,s=t&&r>0?t.totalCost/(r/6e4):void 0,c=n.messages.total?n.messages.errors/n.messages.total:0,l=n.daily.filter(e=>e.messages>0&&e.errors>0).map(e=>({date:e.date,errors:e.errors,messages:e.messages,rate:e.errors/e.messages})).toSorted((e,t)=>t.rate-e.rate||t.errors-e.errors)[0];return{durationSumMs:r,durationCount:i,avgDurationMs:a,throughputTokensPerMin:o,throughputCostPerMin:s,errorRate:c,peakErrorDay:l}};function P_(e,t,n=`text/plain`){let r=new Blob([t],{type:`${n};charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=e,a.click(),URL.revokeObjectURL(i)}function F_(e){return/[",\n]/.test(e)?`"${e.replaceAll(`"`,`""`)}"`:e}function I_(e){return e.map(e=>e==null?``:F_(String(e))).join(`,`)}var L_=e=>{let t=[I_([`key`,`label`,`agentId`,`channel`,`provider`,`model`,`updatedAt`,`durationMs`,`messages`,`errors`,`toolCalls`,`inputTokens`,`outputTokens`,`cacheReadTokens`,`cacheWriteTokens`,`totalTokens`,`totalCost`])];for(let n of e){let e=n.usage;t.push(I_([n.key,n.label??``,n.agentId??``,n.channel??``,n.modelProvider??n.providerOverride??``,n.model??n.modelOverride??``,n.updatedAt?new Date(n.updatedAt).toISOString():``,e?.durationMs??``,e?.messageCounts?.total??``,e?.messageCounts?.errors??``,e?.messageCounts?.toolCalls??``,e?.input??``,e?.output??``,e?.cacheRead??``,e?.cacheWrite??``,e?.totalTokens??``,e?.totalCost??``]))}return t.join(`
`)},R_=e=>{let t=[I_([`date`,`inputTokens`,`outputTokens`,`cacheReadTokens`,`cacheWriteTokens`,`totalTokens`,`inputCost`,`outputCost`,`cacheReadCost`,`cacheWriteCost`,`totalCost`])];for(let n of e)t.push(I_([n.date,n.input,n.output,n.cacheRead,n.cacheWrite,n.totalTokens,n.inputCost??``,n.outputCost??``,n.cacheReadCost??``,n.cacheWriteCost??``,n.totalCost]));return t.join(`
`)},z_=(e,t,n)=>{let r=e.trim();if(!r)return[];let i=r.length?r.split(/\s+/):[],a=i.length?i[i.length-1]:``,[o,s]=a.includes(`:`)?[a.slice(0,a.indexOf(`:`)),a.slice(a.indexOf(`:`)+1)]:[``,``],c=o.toLowerCase(),l=s.toLowerCase(),u=e=>{let t=new Set;for(let n of e)n&&t.add(n);return Array.from(t)},d=u(t.map(e=>e.agentId)).slice(0,6),f=u(t.map(e=>e.channel)).slice(0,6),p=u([...t.map(e=>e.modelProvider),...t.map(e=>e.providerOverride),...n?.byProvider.map(e=>e.provider)??[]]).slice(0,6),m=u([...t.map(e=>e.model),...n?.byModel.map(e=>e.model)??[]]).slice(0,6),h=u(n?.tools.tools.map(e=>e.name)??[]).slice(0,6);if(!c)return[{label:`agent:`,value:`agent:`},{label:`channel:`,value:`channel:`},{label:`provider:`,value:`provider:`},{label:`model:`,value:`model:`},{label:`tool:`,value:`tool:`},{label:`has:errors`,value:`has:errors`},{label:`has:tools`,value:`has:tools`},{label:`minTokens:`,value:`minTokens:`},{label:`maxCost:`,value:`maxCost:`}];let g=[],_=(e,t)=>{for(let n of t)(!l||n.toLowerCase().includes(l))&&g.push({label:`${e}:${n}`,value:`${e}:${n}`})};switch(c){case`agent`:_(`agent`,d);break;case`channel`:_(`channel`,f);break;case`provider`:_(`provider`,p);break;case`model`:_(`model`,m);break;case`tool`:_(`tool`,h);break;case`has`:[`errors`,`tools`,`context`,`usage`,`model`,`provider`].forEach(e=>{(!l||e.includes(l))&&g.push({label:`has:${e}`,value:`has:${e}`})});break;default:break}return g},B_=(e,t)=>{let n=e.trim();if(!n)return`${t} `;let r=n.split(/\s+/);return r[r.length-1]=t,`${r.join(` `)} `},V_=e=>e.trim().toLowerCase(),H_=(e,t)=>{let n=e.trim();if(!n)return`${t} `;let r=n.split(/\s+/),i=r[r.length-1]??``,a=t.includes(`:`)?t.split(`:`)[0]:null,o=i.includes(`:`)?i.split(`:`)[0]:null;return i.endsWith(`:`)&&a&&o===a?(r[r.length-1]=t,`${r.join(` `)} `):r.includes(t)?`${r.join(` `)} `:`${r.join(` `)} ${t} `},U_=(e,t)=>{let n=e.trim().split(/\s+/).filter(Boolean).filter(e=>e!==t);return n.length?`${n.join(` `)} `:``},W_=(e,t,n)=>{let r=V_(t),i=[...o_(e).filter(e=>V_(e.key??``)!==r).map(e=>e.raw),...n.map(e=>`${t}:${e}`)];return i.length?`${i.join(` `)} `:``};function G_(e,t){return t===0?0:e/t*100}function K_(e){let t=e.totalCost||0;return{input:{tokens:e.input,cost:e.inputCost||0,pct:G_(e.inputCost||0,t)},output:{tokens:e.output,cost:e.outputCost||0,pct:G_(e.outputCost||0,t)},cacheRead:{tokens:e.cacheRead,cost:e.cacheReadCost||0,pct:G_(e.cacheReadCost||0,t)},cacheWrite:{tokens:e.cacheWrite,cost:e.cacheWriteCost||0,pct:G_(e.cacheWriteCost||0,t)},totalCost:t}}function q_(e,t,r,a,o,s,c,l){if(!(e.length>0||t.length>0||r.length>0))return i;let u=r.length===1?a.find(e=>e.key===r[0]):null,d=u?(u.label||u.key).slice(0,20)+((u.label||u.key).length>20?`…`:``):r.length===1?r[0].slice(0,8)+`…`:P(`usage.filters.sessionsCount`,{count:String(r.length)}),f=u?u.label||u.key:r.length===1?r[0]:r.join(`, `),p=e.length===1?e[0]:P(`usage.filters.daysCount`,{count:String(e.length)}),m=t.length===1?`${t[0]}:00`:P(`usage.filters.hoursCount`,{count:String(t.length)});return n`
  ...
  `}function Y_(e,t){let r=K_(e),i=t===`tokens`,a=e.totalTokens||1,o={output:G_(e.output,a),input:G_(e.input,a),cacheWrite:G_(e.cacheWrite,a),cacheRead:G_(e.cacheRead,a)};return n`
  ...
  `}function Z_(e,t,r,a){let o=[`usage-insight-card`,a?.className].filter(Boolean).join(` `),s=[`usage-error-list`,a?.listClassName].filter(Boolean).join(` `);return n`
    <div class=${o}>
      <div class="usage-insight-title">${e}</div>
      ${t.length===0?n`<div class="muted">${r}</div>`:n`
              <div class=${s}>
  ...
  `}function Q_(e){let t=[`stat`,`usage-summary-card`,e.className,e.tone?`usage-summary-card--${e.tone}`:``].filter(Boolean).join(` `),r=[`stat-value`,`usage-summary-value`,e.tone??``,e.compactValue?`usage-summary-value--compact`:``].filter(Boolean).join(` `);return n`
    <div class=${t}>
  ...
  `}function $_(e,t,r,a,o,s,c){if(!e)return i;let l=t.messages.total?Math.round(e.totalTokens/t.messages.total):0,u=t.messages.total?e.totalCost/t.messages.total:0,d=e.input+e.cacheRead,f=d>0?e.cacheRead/d:0,p=d>0?`${(f*100).toFixed(1)}%`:P(`usage.common.emptyValue`),m=r.errorRate*100,h=r.throughputTokensPerMin===void 0?P(`usage.common.emptyValue`):`${Z(Math.round(r.throughputTokensPerMin))} ${P(`usage.overview.tokensPerMinute`)}`,g=r.throughputCostPerMin===void 0?P(`usage.common.emptyValue`):`${Q(r.throughputCostPerMin,4)} ${P(`usage.overview.perMinute`)}`,v=r.durationCount>0?_(r.avgDurationMs,{spaced:!0})??P(`usage.common.emptyValue`):P(`usage.common.emptyValue`),y=P(`usage.overview.cacheHint`),b=P(`usage.overview.errorHint`),x=P(`usage.overview.throughputHint`),S=P(`usage.overview.avgTokensHint`),C=P(a?`usage.overview.avgCostHintMissing`:`usage.overview.avgCostHint`),w=t.daily.filter(e=>e.messages>0&&e.errors>0).map(e=>{let t=e.errors/e.messages;return{label:O_(e.date),value:`${(t*100).toFixed(2)}%`,sub:`${e.errors} ${P(`usage.overview.errors`).toLowerCase()} · ${e.messages} ${P(`usage.overview.messagesAbbrev`)} · ${Z(e.tokens)}`,rate:t}}).toSorted((e,t)=>t.rate-e.rate).slice(0,5).map(({rate:e,...t})=>t),T=t.byModel.slice(0,5).map(e=>({label:e.model??P(`usage.common.unknown`),value:Q(e.totals.totalCost),sub:`${Z(e.totals.totalTokens)} · ${e.count} ${P(`usage.overview.messagesAbbrev`)}`})),E=t.byProvider.slice(0,5).map(e=>({label:e.provider??P(`usage.common.unknown`),value:Q(e.totals.totalCost),sub:`${Z(e.totals.totalTokens)} · ${e.count} ${P(`usage.overview.messagesAbbrev`)}`})),D=t.tools.tools.slice(0,6).map(e=>({label:e.name,value:`${e.count}`,sub:P(`usage.overview.calls`)})),ee=t.byAgent.slice(0,5).map(e=>({label:e.agentId,value:Q(e.totals.totalCost),sub:Z(e.totals.totalTokens)})),te=t.byChannel.slice(0,5).map(e=>({label:e.channel,value:Q(e.totals.totalCost),sub:Z(e.totals.totalTokens)}));return n`
    <section class="card usage-overview-card">
      ...
      <div class="usage-overview-layout">
        <div class="usage-summary-grid">
          ${Q_({title:P(`usage.overview.messages`),hint:P(`usage.overview.messagesHint`),value:t.messages.total,sub:`${t.messages.user} ${P(`usage.overview.user`).toLowerCase()} · ${t.messages.assistant} ${P(`usage.overview.assistant`).toLowerCase()}`,className:`usage-summary-card--hero`})}
          ${Q_({title:P(`usage.overview.throughput`),hint:x,value:h,sub:g,className:`usage-summary-card--hero usage-summary-card--throughput`,compactValue:!0})}
          ${Q_({title:P(`usage.overview.toolCalls`),hint:P(`usage.overview.toolCallsHint`),value:t.tools.totalCalls,sub:`${t.tools.uniqueTools} ${P(`usage.overview.toolsUsed`)}`,className:`usage-summary-card--half`})}
          ${Q_({title:P(`usage.overview.avgTokens`),hint:S,value:Z(l),sub:P(`usage.overview.acrossMessages`,{count:String(t.messages.total||0)}),className:`usage-summary-card--half`})}
          ${Q_({title:P(`usage.overview.cacheHitRate`),hint:y,value:p,sub:`${Z(e.cacheRead)} ${P(`usage.overview.cached`)} · ${Z(d)} ${P(`usage.overview.prompt`)}`,tone:f>.6?`good`:f>.3?`warn`:`bad`,className:`usage-summary-card--medium`})}
          ${Q_({title:P(`usage.overview.errorRate`),hint:b,value:`${m.toFixed(2)}%`,sub:`${t.messages.errors} ${P(`usage.overview.errors`).toLowerCase()} · ${v} ${P(`usage.overview.avgSession`)}`,tone:m>5?`bad`:m>1?`warn`:`good`,className:`usage-summary-card--medium`})}
          ${Q_({title:P(`usage.overview.avgCost`),hint:C,value:Q(u,4),sub:`${Q(e.totalCost)} ${P(`usage.breakdown.total`).toLowerCase()}`,className:`usage-summary-card--compact`})}
          ${Q_({title:P(`usage.overview.sessions`),hint:P(`usage.overview.sessionsHint`),value:s,sub:P(`usage.overview.sessionsInRange`,{count:String(c)}),className:`usage-summary-card--compact`})}
          ${Q_({title:P(`usage.overview.errors`),hint:P(`usage.overview.errorsHint`),value:t.messages.errors,sub:`${t.messages.toolResults} ${P(`usage.overview.toolResults`)}`,className:`usage-summary-card--compact`})}
        </div>
        <div class="usage-insights-grid">
          ${X_(P(`usage.overview.topModels`),T,P(`usage.overview.noModelData`))}
          ${X_(P(`usage.overview.topProviders`),E,P(`usage.overview.noProviderData`))}
          ${X_(P(`usage.overview.topTools`),D,P(`usage.overview.noToolCalls`))}
          ${X_(P(`usage.overview.topAgents`),ee,P(`usage.overview.noAgentData`))}
          ${X_(P(`usage.overview.topChannels`),te,P(`usage.overview.noChannelData`))}
          ${Z_(P(`usage.overview.peakErrorDays`),w,P(`usage.overview.noErrorData`))}
          ${Z_(P(`usage.overview.peakErrorHours`),o,P(`usage.overview.noErrorData`),{className:`usage-insight-card--wide`,listClassName:`usage-error-list--hours`})}
        </div>
      </div>
    </section>
  `}function ev(e,t,r,a,o,s,c,l,u,d,f,p,m,h,g){let v=e=>m.includes(e),y=e=>{let t=e.label||e.key;return t.startsWith(`agent:`)&&t.includes(`?token=`)?t.slice(0,t.indexOf(`?token=`)):t},b=async e=>{let t=y(e);try{await navigator.clipboard.writeText(t)}catch{}},x=e=>{let t=[];return v(`channel`)&&e.channel&&t.push(`channel:${e.channel}`),v(`agent`)&&e.agentId&&t.push(`agent:${e.agentId}`),v(`provider`)&&(e.modelProvider||e.providerOverride)&&t.push(`provider:${e.modelProvider??e.providerOverride}`),v(`model`)&&e.model&&t.push(`model:${e.model}`),v(`messages`)&&e.usage?.messageCounts&&t.push(`msgs:${e.usage.messageCounts.total}`),v(`tools`)&&e.usage?.toolUsage&&t.push(`tools:${e.usage.toolUsage.totalCalls}`),v(`errors`)&&e.usage?.messageCounts&&t.push(`errors:${e.usage.messageCounts.errors}`),v(`duration`)&&e.usage?.durationMs&&t.push(`dur:${_(e.usage.durationMs,{spaced:!0})??`—`}`),t},S=e=>{let t=e.usage;if(!t)return 0;if(r.length>0&&t.dailyBreakdown&&t.dailyBreakdown.length>0){let e=t.dailyBreakdown.filter(e=>r.includes(e.date));return a?e.reduce((e,t)=>e+t.tokens,0):e.reduce((e,t)=>e+t.cost,0)}return a?t.totalTokens??0:t.totalCost??0},C=[...e].toSorted((e,t)=>{switch(o){case`recent`:return(t.updatedAt??0)-(e.updatedAt??0);case`messages`:return(t.usage?.messageCounts?.total??0)-(e.usage?.messageCounts?.total??0);case`errors`:return(t.usage?.messageCounts?.errors??0)-(e.usage?.messageCounts?.errors??0);case`cost`:return S(t)-S(e);default:return S(t)-S(e)}}),w=s===`asc`?C.toReversed():C,T=w.reduce((e,t)=>e+S(t),0),E=w.length?T/w.length:0,D=w.reduce((e,t)=>e+(t.usage?.messageCounts?.errors??0),0),ee=(e,t)=>{let r=S(e),o=y(e),s=x(e);return n`
      <div
  ...
  `}var tv=.75,nv=.06,rv=5,iv=12,av=.7;function ov(e,t){return!t||t<=0?0:e/t*100}function sv(e){return e<0xe8d4a51000?e*1e3:e}function cv(e,t,n){let r=Math.min(t,n),i=Math.max(t,n);return e.filter(e=>{if(e.timestamp<=0)return!0;let t=sv(e.timestamp);return t>=r&&t<=i})}function lv(e,t,r){let a=t||e.usage;if(!a)return n`
      <div class="usage-empty-block">${P(`usage.details.noUsageData`)}</div>
    `;let o=e=>e?new Date(e).toLocaleString():P(`usage.common.emptyValue`),s=[];e.channel&&s.push(`channel:${e.channel}`),e.agentId&&s.push(`agent:${e.agentId}`),(e.modelProvider||e.providerOverride)&&s.push(`provider:${e.modelProvider??e.providerOverride}`),e.model&&s.push(`model:${e.model}`);let c=a.toolUsage?.tools.slice(0,6)??[],l,u,d;if(r){let e=new Map;for(let t of r){let{tools:n}=p_(t.content);for(let[t]of n)e.set(t,(e.get(t)||0)+1)}d=c.map(t=>({label:t.name,value:`${e.get(t.name)??0}`,sub:P(`usage.overview.calls`)})),l=[...e.values()].reduce((e,t)=>e+t,0),u=e.size}else d=c.map(e=>({label:e.name,value:`${e.count}`,sub:P(`usage.overview.calls`)})),l=a.toolUsage?.totalCalls??0,u=a.toolUsage?.uniqueTools??0;let f=a.modelUsage?.slice(0,6).map(e=>({label:e.model??P(`usage.common.unknown`),value:Q(e.totals.totalCost),sub:Z(e.totals.totalTokens)}))??[];return n`
    ...
    <div class="usage-insights-grid usage-insights-grid--tight">
      ${X_(P(`usage.overview.topTools`),d,P(`usage.overview.noToolCalls`))}
      ${X_(P(`usage.details.modelMix`),f,P(`usage.overview.noModelData`))}
    </div>
  `}function uv(e,t,n,r){let i=Math.min(n,r),a=Math.max(n,r),o=t.filter(e=>e.timestamp>=i&&e.timestamp<=a);if(o.length===0)return;let s=0,c=0,l=0,u=0,d=0,f=0,p=0,m=0;for(let e of o)s+=e.totalTokens||0,c+=e.cost||0,d+=e.input||0,f+=e.output||0,p+=e.cacheRead||0,m+=e.cacheWrite||0,e.output>0&&u++,e.input>0&&l++;return{...e,totalTokens:s,totalCost:c,input:d,output:f,cacheRead:p,cacheWrite:m,durationMs:o[o.length-1].timestamp-o[0].timestamp,firstActivity:o[0].timestamp,lastActivity:o[o.length-1].timestamp,messageCounts:{total:o.length,user:l,assistant:u,toolCalls:0,toolResults:0,errors:0}}}function dv(e,t,r,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D){let ee=e.label||e.key,te=ee.length>50?ee.slice(0,50)+`…`:ee,O=e.usage,k=l!==null&&u!==null,A=l!==null&&u!==null&&t?.points&&O?uv(O,t.points,l,u):void 0,ne=A?{totalTokens:A.totalTokens,totalCost:A.totalCost}:{totalTokens:O?.totalTokens??0,totalCost:O?.totalCost??0},j=A?P(`usage.details.filtered`):``;return n`
    <div class="card session-detail-panel">
      ...
      <div class="session-detail-content">
        ${lv(e,A,l!=null&&u!=null&&h?cv(h,l,u):void 0)}
        <div class="session-detail-row">
          ${fv(t,r,a,o,s,c,f,p,m,l,u,d)}
        </div>
        <div class="session-detail-bottom">
          ${mv(h,g,_,v,y,b,x,S,C,w,k?l:null,k?u:null)}
          ${pv(e.contextWeight,O,T,E)}
        </div>
      </div>
    </div>
  `}function fv(e,t,r,o,s,c,l,u,d,f,p,m){if(t)return n`
      ...
      <div class="timeseries-chart-wrapper">
        ...
        >
          ...
          ${a`
            ...
            <rect x="${L-rv/2}" y="${A.top+j/2-iv/2}" width="${rv}" height="${iv}" rx="1.5" fill="var(--accent)" class="cursor-handle" />
            <line x1="${L-av}" y1="${A.top+j/2-iv/5}" x2="${L-av}" y2="${A.top+j/2+iv/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
            <line x1="${L+av}" y1="${A.top+j/2-iv/5}" x2="${L+av}" y2="${A.top+j/2+iv/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
          `}
          <!-- Right cursor line + handle -->
          ${a`
            <line x1="${se}" y1="${A.top}" x2="${se}" y2="${A.top+j}" stroke="var(--accent)" stroke-width="0.8" opacity="0.7" />
            <rect x="${se-rv/2}" y="${A.top+j/2-iv/2}" width="${rv}" height="${iv}" rx="1.5" fill="var(--accent)" class="cursor-handle" />
            <line x1="${se-av}" y1="${A.top+j/2-iv/5}" x2="${se-av}" y2="${A.top+j/2+iv/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
            <line x1="${se+av}" y1="${A.top+j/2-iv/5}" x2="${se+av}" y2="${A.top+j/2+iv/5}" stroke="var(--bg)" stroke-width="0.4" pointer-events="none" />
          `}
        </svg>
      ...
      ${ie?n`
              <div class="timeseries-breakdown">
                ...
                <div class="cost-breakdown-bar cost-breakdown-bar--compact">
                  <div class="cost-segment output" style="width: ${ov(ee,M).toFixed(1)}%"></div>
                  <div class="cost-segment input" style="width: ${ov(te,M).toFixed(1)}%"></div>
                  <div class="cost-segment cache-write" style="width: ${ov(k,M).toFixed(1)}%"></div>
                  <div class="cost-segment cache-read" style="width: ${ov(O,M).toFixed(1)}%"></div>
                </div>
                <div class="cost-breakdown-legend">
  ...
  `}function pv(e,t,r,a){if(!e)return n`
    ...
    <div class="context-details-panel">
      ...
      <div class="context-stacked-bar">
        <div class="context-segment system" style="width: ${ov(o,u).toFixed(1)}%" title="${P(`usage.details.system`)}: ~${Z(o)}"></div>
        <div class="context-segment skills" style="width: ${ov(s,u).toFixed(1)}%" title="${P(`usage.details.skills`)}: ~${Z(s)}"></div>
        <div class="context-segment tools" style="width: ${ov(c,u).toFixed(1)}%" title="${P(`usage.details.tools`)}: ~${Z(c)}"></div>
        <div class="context-segment files" style="width: ${ov(l,u).toFixed(1)}%" title="${P(`usage.details.files`)}: ~${Z(l)}"></div>
      </div>
                    ...
                    <div class="context-breakdown-list">
                      ${g.map(e=>n`
                          <div class="context-breakdown-item">
                            ...
                            <span class="muted">~${Z(v_(e.blockChars))}</span>
                          </div>
                        `)}
                    </div>
                    ${e>0?n`
                  ...
                  <div class="context-breakdown-card">
                    ...
                    <div class="context-breakdown-list">
                      ${_.map(e=>n`
                          <div class="context-breakdown-item">
                            <span class="mono">${e.name}</span>
                            <span class="muted">~${Z(v_(e.summaryChars+e.schemaChars))}</span>
                          </div>
                        `)}
                    </div>
                    ${e>0?n`
                  ...
                  <div class="context-breakdown-card">
                    ...
                    <div class="context-breakdown-list">
                      ${v.map(e=>n`
                          <div class="context-breakdown-item">
                            <span class="mono">${e.name}</span>
                            <span class="muted">~${Z(v_(e.injectedChars))}</span>
                          </div>
                        `)}
                    </div>
                    ${e>0?n`
  ...
  `}function mv(e,t,r,a,o,s,c,l,u,d,f,p){if(t)return n`
  ...
  `}function hv(){return{input:0,output:0,cacheRead:0,cacheWrite:0,totalTokens:0,totalCost:0,inputCost:0,outputCost:0,cacheReadCost:0,cacheWriteCost:0,missingCostEntries:0}}function gv(e,t){return e.input+=t.input,e.output+=t.output,e.cacheRead+=t.cacheRead,e.cacheWrite+=t.cacheWrite,e.totalTokens+=t.totalTokens,e.totalCost+=t.totalCost,e.inputCost+=t.inputCost??0,e.outputCost+=t.outputCost??0,e.cacheReadCost+=t.cacheReadCost??0,e.cacheWriteCost+=t.cacheWriteCost??0,e.missingCostEntries+=t.missingCostEntries??0,e}function _v(e){return n`
  ...
  `}function yv(e){let{data:t,filters:r,display:a,detail:o,callbacks:s}=e,c=s.filters,l=s.display,u=s.details;if(t.loading&&!t.totals)return n`<div class="usage-page">${_v(r)}</div>`;let d=a.chartMode===`tokens`,f=r.query.trim().length>0,p=r.queryDraft.trim().length>0,m=[...t.sessions].toSorted((e,t)=>{let n=d?e.usage?.totalTokens??0:e.usage?.totalCost??0;return(d?t.usage?.totalTokens??0:t.usage?.totalCost??0)-n}),h=r.selectedDays.length>0?m.filter(e=>{if(e.usage?.activityDates?.length)return e.usage.activityDates.some(e=>r.selectedDays.includes(e));if(!e.updatedAt)return!1;let t=new Date(e.updatedAt),n=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`;return r.selectedDays.includes(n)}):m,g=(e,t)=>{if(t.length===0)return!0;let n=e.usage,i=n?.firstActivity??e.updatedAt,a=n?.lastActivity??e.updatedAt;if(!i||!a)return!1;let o=Math.min(i,a),s=Math.max(i,a),c=o;for(;c<=s;){let e=new Date(c),n=x_(e,r.timeZone);if(t.includes(n))return!0;let i=C_(e,r.timeZone);c=Math.min(i.getTime(),s)+1}return!1},_=f_(r.selectedHours.length>0?h.filter(e=>g(e,r.selectedHours)):h,r.query),v=_.sessions,y=_.warnings,b=z_(r.queryDraft,m,t.aggregates),x=o_(r.query),S=e=>{let t=V_(e);return x.filter(e=>V_(e.key??``)===t).map(e=>e.value).filter(Boolean)},C=e=>{let t=new Set;for(let n of e)n&&t.add(n);return Array.from(t)},w=C(m.map(e=>e.agentId)).slice(0,12),T=C(m.map(e=>e.channel)).slice(0,12),E=C([...m.map(e=>e.modelProvider),...m.map(e=>e.providerOverride),...t.aggregates?.byProvider.map(e=>e.provider)??[]]).slice(0,12),D=C([...m.map(e=>e.model),...t.aggregates?.byModel.map(e=>e.model)??[]]).slice(0,12),ee=C(t.aggregates?.tools.tools.map(e=>e.name)??[]).slice(0,12),te=r.selectedSessions.length===1?t.sessions.find(e=>e.key===r.selectedSessions[0])??v.find(e=>e.key===r.selectedSessions[0]):null,O=e=>e.reduce((e,t)=>t.usage?gv(e,t.usage):e,hv()),k=e=>t.costDaily.filter(t=>e.includes(t.date)).reduce((e,t)=>gv(e,t),hv()),A,ne,j=m.length;if(r.selectedSessions.length>0){let e=v.filter(e=>r.selectedSessions.includes(e.key));A=O(e),ne=e.length}else r.selectedDays.length>0&&r.selectedHours.length===0?(A=k(r.selectedDays),ne=v.length):r.selectedHours.length>0||f?(A=O(v),ne=v.length):(A=t.totals,ne=j);let re=r.selectedSessions.length>0?v.filter(e=>r.selectedSessions.includes(e.key)):f||r.selectedHours.length>0?v:r.selectedDays.length>0?h:m,ie=M_(re,t.aggregates),M=r.selectedSessions.length>0?(()=>{let e=v.filter(e=>r.selectedSessions.includes(e.key)),n=new Set;for(let t of e)for(let e of t.usage?.activityDates??[])n.add(e);return n.size>0?t.costDaily.filter(e=>n.has(e.date)):t.costDaily})():t.costDaily,ae=N_(re,A,ie),N=!t.loading&&!t.totals&&t.sessions.length===0,F=(A?.missingCostEntries??0)>0||(A?A.totalTokens>0&&A.totalCost===0&&A.input+A.output+A.cacheRead+A.cacheWrite>0:!1),I=[{label:P(`usage.presets.today`),days:1},{label:P(`usage.presets.last7d`),days:7},{label:P(`usage.presets.last30d`),days:30}],oe=e=>{let t=new Date,n=new Date;n.setDate(n.getDate()-(e-1)),c.onStartDateChange(E_(n)),c.onEndDateChange(E_(t))},L=(e,t,a)=>{if(a.length===0)return i;let o=S(e),s=new Set(o.map(e=>V_(e))),l=a.length>0&&a.every(e=>s.has(V_(e))),u=o.length;return n`
      <details
      ...
      >
        ...
        <div class="usage-filter-popover">
          <div class="usage-filter-actions">
            <button
              class="btn btn-sm"
              @click=${t=>{t.preventDefault(),t.stopPropagation(),c.onQueryDraftChange(W_(r.queryDraft,e,a))}}
              ?disabled=${l}
            >
            ...
            <button
              class="btn btn-sm"
              @click=${t=>{t.preventDefault(),t.stopPropagation(),c.onQueryDraftChange(W_(r.queryDraft,e,[]))}}
              ?disabled=${u===0}
            >
              ${P(`usage.filters.clear`)}
            </button>
            ...
            ${a.map(t=>n`
                <label class="usage-filter-option">
                  <input
                    type="checkbox"
                    .checked=${s.has(V_(t))}
                    @change=${n=>{let i=n.target,a=`${e}:${t}`;c.onQueryDraftChange(i.checked?H_(r.queryDraft,a):U_(r.queryDraft,a))}}
                  />
                  <span>${t}</span>
                </label>
              `)}
      ...
      <section class="card usage-header ${a.headerPinned?`pinned`:``}">
              ...
              <div class="usage-export-popover">
                <div class="usage-export-list">
                  <button
                    ...
                    @click=${()=>P_(`openclaw-usage-sessions-${se}.csv`,L_(v),`text/csv`)}
                    ?disabled=${v.length===0}
                  >
                  ...
                  <button
                    class="usage-export-item"
                    @click=${()=>P_(`openclaw-usage-daily-${se}.csv`,R_(M),`text/csv`)}
                    ?disabled=${M.length===0}
                  >
                  ...
                  <button
                    class="usage-export-item"
                    @click=${()=>P_(`openclaw-usage-${se}.json`,JSON.stringify({totals:A,sessions:v,daily:M,aggregates:ie},null,2),`application/json`)}
        ...
        <div class="usage-header-row">
          <div class="usage-controls">
            ${q_(r.selectedDays,r.selectedHours,r.selectedSessions,t.sessions,c.onClearDays,c.onClearHours,c.onClearSessions,c.onClearFilters)}
                  ...
                  <div class="usage-query-chips">
                    ${x.map(e=>{let t=e.raw;return n`
                        <span class="usage-query-chip">
                          ...
                          <button
                            title=${P(`usage.filters.remove`)}
                            @click=${()=>c.onQueryDraftChange(U_(r.queryDraft,t))}
                          >
                            ×
                          </button>
                        </span>
                  ...
                  <div class="usage-query-suggestions">
                    ${b.map(e=>n`
                        <button
                          ...
                          @click=${()=>c.onQueryDraftChange(B_(r.queryDraft,e.value))}
                        >
                          ${e.label}
                        </button>
                      `)}
  ...
  `}function wv(e){let t=Vv(e,e.sessionKey,e.sessionsResult),r=Nv(e);return n`
    <div class="chat-controls__session-row">
      <label class="field chat-controls__session">
        ...
        >
          ${_o(t,e=>e.id,e=>n`<optgroup label=${e.label}>
                ${_o(e.options,e=>e.key,e=>n`<option value=${e.key} title=${e.title}>
                      ${e.label}
                    </option>`)}
              </optgroup>`)}
        </select>
  ...
  `}function Tv(e){let t=e.sessionsHideCron??!0,r=t?Hv(e.sessionKey,e.sessionsResult):0,i=e.onboarding,a=e.onboarding,o=e.onboarding?!1:e.settings.chatShowThinking,s=e.onboarding?!0:e.settings.chatShowToolCalls,c=e.onboarding?!0:e.settings.chatFocusMode,l=n`
    <svg
      width="18"
      height="18"
      viewBox="0 0 24 24"
  ...
  `;return n`
    <div class="chat-controls">
      <button
        ...
        @click=${async()=>{let t=e;t.chatManualRefreshInFlight=!0,t.chatNewMessagesBelow=!1,await t.updateComplete,t.resetToolStream();try{await yg(e,{scheduleScroll:!1}),t.scrollToBottom({smooth:!0})}finally{requestAnimationFrame(()=>{t.chatManualRefreshInFlight=!1,t.chatNewMessagesBelow=!1})}}}
  ...
  `}function Ev(e){let t=Vv(e,e.sessionKey,e.sessionsResult),r=e.onboarding,i=e.onboarding,a=e.onboarding?!1:e.settings.chatShowThinking,o=e.onboarding?!0:e.settings.chatShowToolCalls,s=e.onboarding?!0:e.settings.chatFocusMode,c=n`
    <svg
      width="18"
      height="18"
      viewBox="0 0 24 24"
  ...
  `}function Dv(e,t){e.sessionKey=t,e.chatMessage=``,e.chatStream=null,e.chatQueue=[],e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:t,lastActiveSessionKey:t}),e.loadAssistantIdentity(),Zp(e,t,!0),Zh(e),Ov(e)}async function Ov(e){await ki(e,{activeMinutes:0,limit:0,includeGlobal:!0,includeUnknown:!0})}function kv(e){return e.sessionsResult?.sessions?.find(t=>t.key===e.sessionKey)}function Av(e){let t=e.chatModelOverrides[e.sessionKey];if(t)return Ym(t,e.chatModelCatalog??[]);if(t===null)return``;let n=kv(e);return n&&typeof n.model==`string`&&n.model.trim()?Xm(n.model,n.modelProvider):``}function jv(e){let t=e.sessionsResult?.defaults;return Xm(t?.model,t?.modelProvider)}function Mv(e,t,n){let r=new Set,i=[],a=(e,t)=>{let n=e.trim();if(!n)return;let a=n.toLowerCase();r.has(a)||(r.add(a),i.push({value:n,label:t??n}))};for(let t of e){let e=Qm(t);a(e.value,e.label)}return t&&a(t),n&&a(n),i}function Nv(e){let t=Av(e),r=jv(e),i=Mv(e.chatModelCatalog??[],t,r),a=Zm(r),o=r?`Default (${a})`:`Default model`,s=e.chatLoading||e.chatSending||!!e.chatRunId||e.chatStream!==null;return n`
    <label class="field chat-controls__session chat-controls__model">
      <select
        data-chat-model-select="true"
        aria-label="Chat model"
        ?disabled=${!e.connected||s||e.chatModelsLoading&&i.length===0||!e.client}
        @change=${async t=>{await Pv(e,t.target.value.trim())}}
      >
        <option value="" ?selected=${t===``}>${o}</option>
        ${_o(i,e=>e.value,e=>n`<option value=${e.value} ?selected=${e.value===t}>
              ${e.label}
            </option>`)}
      </select>
    </label>
  `}async function Pv(e,t){if(!e.client||!e.connected||Av(e)===t)return;let n=e.sessionKey,r=e.chatModelOverrides[n];e.lastError=null,e.chatModelOverrides={...e.chatModelOverrides,[n]:Jm(t)};try{await e.client.request(`sessions.patch`,{key:n,model:t||null}),await Ov(e)}catch(t){e.chatModelOverrides={...e.chatModelOverrides,[n]:r},e.lastError=`Failed to set model: ${String(t)}`}}var Fv={bluebubbles:`iMessage`,telegram:`Telegram`,discord:`Discord`,signal:`Signal`,slack:`Slack`,whatsapp:`WhatsApp`,matrix:`Matrix`,email:`Email`,sms:`SMS`},Iv=Object.keys(Fv);function Lv(e){return e.charAt(0).toUpperCase()+e.slice(1)}function Rv(e){let t=e.toLowerCase();if(e===`main`||e===`agent:main:main`)return{prefix:``,fallbackName:`Main Session`};if(e.includes(`:subagent:`))return{prefix:`Subagent:`,fallbackName:`Subagent:`};if(t.startsWith(`cron:`)||e.includes(`:cron:`))return{prefix:`Cron:`,fallbackName:`Cron Job:`};let n=e.match(/^agent:[^:]+:([^:]+):direct:(.+)$/);if(n){let e=n[1],t=n[2];return{prefix:``,fallbackName:`${Fv[e]??Lv(e)} · ${t}`}}let r=e.match(/^agent:[^:]+:([^:]+):group:(.+)$/);if(r){let e=r[1];return{prefix:``,fallbackName:`${Fv[e]??Lv(e)} Group`}}for(let t of Iv)if(e===t||e.startsWith(`${t}:`))return{prefix:``,fallbackName:`${Fv[t]} Session`};return{prefix:``,fallbackName:e}}function zv(e,t){let n=t?.label?.trim()||``,r=t?.displayName?.trim()||``,{prefix:i,fallbackName:a}=Rv(e),o=e=>i?RegExp(`^${i.replace(/[.*+?^${}()|[\\]\\]/g,`\\$&`)}\\s*`,`i`).test(e)?e:`${i} ${e}`:e;return n&&n!==e?o(n):r&&r!==e?o(r):a}function Bv(e){let t=e.trim().toLowerCase();if(!t)return!1;if(t.startsWith(`cron:`))return!0;if(!t.startsWith(`agent:`))return!1;let n=t.split(`:`).filter(Boolean);return n.length<3?!1:n.slice(2).join(`:`).startsWith(`cron:`)}function Vv(e,t,n){let r=n?.sessions??[],i=e.sessionsHideCron??!0,a=new Map;for(let e of r)a.set(e.key,e);let o=new Set,s=new Map,c=(e,t)=>{let n=s.get(e);if(n)return n;let r={id:e,label:t,options:[]};return s.set(e,r),r},l=t=>{if(!t||o.has(t))return;o.add(t);let n=a.get(t),r=st(t),i=r?c(`agent:${r.agentId.toLowerCase()}`,Uv(e,r.agentId)):c(`other`,`Other Sessions`),s=r?.rest?.trim()||t,l=Wv(t,n,r?.rest);i.options.push({key:t,label:l,scopeLabel:s,title:t})};for(let e of r)e.key!==t&&(e.kind===`global`||e.kind===`unknown`)||i&&e.key!==t&&Bv(e.key)||l(e.key);l(t);for(let e of s.values()){let t=new Map;for(let n of e.options)t.set(n.label,(t.get(n.label)??0)+1);for(let n of e.options)(t.get(n.label)??0)>1&&n.scopeLabel!==n.label&&(n.label=`${n.label} · ${n.scopeLabel}`)}let u=Array.from(s.values()).flatMap(e=>e.options.map(t=>({groupLabel:e.label,option:t}))),d=new Map(u.map(({option:e})=>[e,e.label])),f=()=>{let e=new Map;for(let{option:t}of u){let n=d.get(t)??t.label;e.set(n,(e.get(n)??0)+1)}return e},p=(e,t)=>{let n=t.trim();return n?e===n||e.endsWith(` · ${n}`)||e.endsWith(` / ${n}`):!1},m=f();for(let{groupLabel:e,option:t}of u){let n=d.get(t)??t.label;if((m.get(n)??0)<=1)continue;let r=`${e} / `;n.startsWith(r)||d.set(t,`${e} / ${n}`)}let h=f();for(let{option:e}of u){let t=d.get(e)??e.label;(h.get(t)??0)<=1||p(t,e.scopeLabel)||d.set(e,`${t} · ${e.scopeLabel}`)}let g=f();for(let{option:e}of u){let t=d.get(e)??e.label;(g.get(t)??0)<=1||d.set(e,`${t} · ${e.key}`)}for(let{option:e}of u)e.label=d.get(e)??e.label;return Array.from(s.values())}function Hv(e,t){return t?.sessions?t.sessions.filter(t=>Bv(t.key)&&t.key!==e).length:0}function Uv(e,t){let n=t.trim().toLowerCase(),r=(e.agentsList?.agents??[]).find(e=>e.id.trim().toLowerCase()===n),i=r?.identity?.name?.trim()||r?.name?.trim()||``;return i&&i!==t?`${i} (${t})`:t}function Wv(e,t,n){let r=n?.trim()||e;if(!t)return r;let i=t.label?.trim()||``,a=t.displayName?.trim()||``;return i&&i!==e||a&&a!==e?zv(e,t):r}var Gv=[{id:`system`,label:`System`,short:`SYS`},{id:`light`,label:`Light`,short:`LIGHT`},{id:`dark`,label:`Dark`,short:`DARK`}];function Kv(e){let t=e=>e===`system`?W.monitor:e===`light`?W.sun:W.moon,r=(t,n)=>{t!==e.themeMode&&e.setThemeMode(t,{element:n.currentTarget})};return n`
  ...
  `}function qv(e){let t=e.connected?P(`common.online`):P(`common.offline`);return n`
    <span
    ...
    ></span>
  `}function Jv(e,t){if(!e)return e;let n=e.files.some(e=>e.name===t.name)?e.files.map(e=>e.name===t.name?t:e):[...e.files,t];return{...e,files:n}}async function Yv(e,t){if(!(!e.client||!e.connected||e.agentFilesLoading)){e.agentFilesLoading=!0,e.agentFilesError=null;try{let n=await e.client.request(`agents.files.list`,{agentId:t});n&&(e.agentFilesList=n,e.agentFileActive&&!n.files.some(t=>t.name===e.agentFileActive)&&(e.agentFileActive=null))}catch(t){e.agentFilesError=String(t)}finally{e.agentFilesLoading=!1}}}async function Xv(e,t,n,r){if(!(!e.client||!e.connected||e.agentFilesLoading)&&!(!r?.force&&Object.hasOwn(e.agentFileContents,n))){e.agentFilesLoading=!0,e.agentFilesError=null;try{let i=await e.client.request(`agents.files.get`,{agentId:t,name:n});if(i?.file){let t=i.file.content??``,a=e.agentFileContents[n]??``,o=e.agentFileDrafts[n],s=r?.preserveDraft??!0;e.agentFilesList=Jv(e.agentFilesList,i.file),e.agentFileContents={...e.agentFileContents,[n]:t},(!s||!Object.hasOwn(e.agentFileDrafts,n)||o===a)&&(e.agentFileDrafts={...e.agentFileDrafts,[n]:t})}}catch(t){e.agentFilesError=String(t)}finally{e.agentFilesLoading=!1}}}async function Zv(e,t,n,r){if(!(!e.client||!e.connected||e.agentFileSaving)){e.agentFileSaving=!0,e.agentFilesError=null;try{let i=await e.client.request(`agents.files.set`,{agentId:t,name:n,content:r});i?.file&&(e.agentFilesList=Jv(e.agentFilesList,i.file),e.agentFileContents={...e.agentFileContents,[n]:r},e.agentFileDrafts={...e.agentFileDrafts,[n]:r})}catch(t){e.agentFilesError=String(t)}finally{e.agentFileSaving=!1}}}var Qv=class extends c{constructor(...e){super(...e),this.tab=`overview`}createRenderRoot(){return this}render(){return n`
      <div class="dashboard-header">
        <div class="dashboard-header__breadcrumb">
          ...
          <span class="dashboard-header__breadcrumb-current">${va(this.tab)}</span>
        </div>
        <div class="dashboard-header__actions">
          <slot></slot>
        </div>
      </div>
    `}};J([x()],Qv.prototype,`tab`,void 0),Qv=J([v(`dashboard-header`)],Qv);var $v=[...Rf.map(e=>({id:`slash:${e.name}`,label:`/${e.name}`,icon:e.icon??`terminal`,category:`search`,action:`/${e.name}`,description:e.description})),{id:`nav-overview`,label:`Overview`,icon:`barChart`,category:`navigation`,action:`nav:overview`},{id:`nav-sessions`,label:`Sessions`,icon:`fileText`,category:`navigation`,action:`nav:sessions`},{id:`nav-cron`,label:`Scheduled`,icon:`scrollText`,category:`navigation`,action:`nav:cron`},{id:`nav-skills`,label:`Skills`,icon:`zap`,category:`navigation`,action:`nav:skills`},{id:`nav-config`,label:`Settings`,icon:`settings`,category:`navigation`,action:`nav:config`},{id:`nav-agents`,label:`Agents`,icon:`folder`,category:`navigation`,action:`nav:agents`},{id:`skill-shell`,label:`Shell Command`,icon:`monitor`,category:`skills`,action:`/skill shell`,description:`Run shell`},{id:`skill-debug`,label:`Debug Mode`,icon:`bug`,category:`skills`,action:`/verbose full`,description:`Toggle debug`}];function ey(e){if(!e)return $v;let t=e.toLowerCase();return $v.filter(e=>e.label.toLowerCase().includes(t)||(e.description?.toLowerCase().includes(t)??!1))}function ty(e){let t=new Map;for(let n of e){let e=t.get(n.category)??[];e.push(n),t.set(n.category,e)}return[...t.entries()]}var ny=null;function ry(){ny=document.activeElement}function iy(){ny&&ny instanceof HTMLElement&&requestAnimationFrame(()=>ny&&ny.focus()),ny=null}function ay(e,t){e.action.startsWith(`nav:`)?t.onNavigate(e.action.slice(4)):t.onSlashCommand(e.action),t.onToggle(),iy()}function oy(){requestAnimationFrame(()=>{document.querySelector(`.cmd-palette__item--active`)?.scrollIntoView({block:`nearest`})})}function sy(e,t){let n=ey(t.query);if(!(n.length===0&&(e.key===`ArrowDown`||e.key===`ArrowUp`||e.key===`Enter`)))switch(e.key){case`ArrowDown`:e.preventDefault(),t.onActiveIndexChange((t.activeIndex+1)%n.length),oy();break;case`ArrowUp`:e.preventDefault(),t.onActiveIndexChange((t.activeIndex-1+n.length)%n.length),oy();break;case`Enter`:e.preventDefault(),n[t.activeIndex]&&ay(n[t.activeIndex],t);break;case`Escape`:e.preventDefault(),t.onToggle(),iy();break}}var cy={search:`Search`,navigation:`Navigation`,skills:`Skills`};function ly(e){e&&(ry(),requestAnimationFrame(()=>e.focus()))}function uy(e){if(!e.open)return i;let t=ey(e.query),r=ty(t);return n`
    <div class="cmd-palette-overlay" @click=${()=>{e.onToggle(),iy()}}>
      <div
        class="cmd-palette"
  ...
  `}var dy=new Set([`title`,`description`,`default`,`nullable`,`tags`,`x-tags`]);function fy(e){return Object.keys(e??{}).filter(e=>!dy.has(e)).length===0}function py(e){if(e===void 0)return``;try{return JSON.stringify(e,null,2)??``}catch{return``}}var my={chevronDown:n`
    <svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
  ...
  `};function hy(e){let t=be(e.value,e.path,e.hints),n=t&&(e.revealSensitive||(e.isSensitivePathRevealed?.(e.path)??!1));return{isSensitive:t,isRedacted:t&&!n,isRevealed:n,canReveal:t}}function gy(e){let{state:t}=e;return!t.isSensitive||!e.onToggleSensitivePath?i:n`
    <button
      type="button"
  ...
  `}function _y(e){return!!(e&&(e.text.length>0||e.tags.length>0))}function vy(e){let t=[],n=new Set;return{text:e.trim().replace(/(^|\s)tag:([^\s]+)/gi,(e,r,i)=>{let a=i.trim().toLowerCase();return a&&!n.has(a)&&(n.add(a),t.push(a)),r}).trim().toLowerCase(),tags:t}}function yy(e){if(!Array.isArray(e))return[];let t=new Set,n=[];for(let r of e){if(typeof r!=`string`)continue;let e=r.trim();if(!e)continue;let i=e.toLowerCase();t.has(i)||(t.add(i),n.push(e))}return n}function by(e,t,n){let r=ue(e,n),i=r?.label??t.title??de(String(e.at(-1))),a=r?.help??t.description,o=yy(t[`x-tags`]??t.tags),s=yy(r?.tags);return{label:i,help:a,tags:s.length>0?s:o}}function xy(e,t){if(!e)return!0;for(let n of t)if(n&&n.toLowerCase().includes(e))return!0;return!1}function Sy(e,t){if(e.length===0)return!0;let n=new Set(t.map(e=>e.toLowerCase()));return e.every(e=>n.has(e))}function Cy(e){let{schema:t,path:n,hints:r,criteria:i}=e;if(!_y(i))return!0;let{label:a,help:o,tags:s}=by(n,t,r);if(!Sy(i.tags,s))return!1;if(!i.text)return!0;let c=n.filter(e=>typeof e==`string`).join(`.`),l=t.enum&&t.enum.length>0?t.enum.map(e=>String(e)).join(` `):``;return xy(i.text,[a,o,t.title,t.description,c,l])}function wy(e){let{schema:t,value:n,path:r,hints:i,criteria:a}=e;if(!_y(a)||Cy({schema:t,path:r,hints:i,criteria:a}))return!0;let o=R(t);if(o===`object`){let e=n??t.default,o=e&&typeof e==`object`&&!Array.isArray(e)?e:{},s=t.properties??{};for(let[e,t]of Object.entries(s))if(wy({schema:t,value:o[e],path:[...r,e],hints:i,criteria:a}))return!0;let c=t.additionalProperties;if(c&&typeof c==`object`){let e=new Set(Object.keys(s));for(let[t,n]of Object.entries(o))if(!e.has(t)&&wy({schema:c,value:n,path:[...r,t],hints:i,criteria:a}))return!0}return!1}if(o===`array`){let e=Array.isArray(t.items)?t.items[0]:t.items;if(!e)return!1;let o=Array.isArray(n)?n:Array.isArray(t.default)?t.default:[];if(o.length===0)return!1;for(let t=0;t<o.length;t+=1)if(wy({schema:e,value:o[t],path:[...r,t],hints:i,criteria:a}))return!0}return!1}function Ty(e){return e.length===0?i:n`
    <div class="cfg-tags">
      ${e.map(e=>n`<span class="cfg-tag">${e}</span>`)}
    </div>
  `}function Ey(e){let{schema:t,value:r,path:a,hints:o,unsupported:s,disabled:c,onPatch:l}=e,u=e.showLabel??!0,d=R(t),{label:f,help:p,tags:m}=by(a,t,o),h=le(a),g=e.searchCriteria;if(s.has(h))return n`<div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${f}</div>
      <div class="cfg-field__error">Unsupported schema node. Use Raw mode.</div>
    </div>`;if(g&&_y(g)&&!wy({schema:t,value:r,path:a,hints:o,criteria:g}))return i;if(t.anyOf||t.oneOf){let s=(t.anyOf??t.oneOf??[]).filter(e=>!(e.type===`null`||Array.isArray(e.type)&&e.type.includes(`null`)));if(s.length===1)return Ey({...e,schema:s[0]});let d=s.map(e=>{if(e.const!==void 0)return e.const;if(e.enum&&e.enum.length===1)return e.enum[0]}),h=d.every(e=>e!==void 0);if(h&&d.length>0&&d.length<=5){let e=r??t.default;return n`
        <div class="cfg-field">
      ...
      `}if(h&&d.length>5)return ky({...e,options:d,value:r??t.default});let g=new Set(s.map(e=>R(e)).filter(Boolean)),_=new Set([...g].map(e=>e===`integer`?`number`:e));if([..._].every(e=>[`string`,`number`,`boolean`].includes(e))){let n=_.has(`string`),r=_.has(`number`);if(_.has(`boolean`)&&_.size===1)return Ey({...e,schema:{...t,type:`boolean`,anyOf:void 0,oneOf:void 0}});if(n||r)return Dy({...e,inputType:r&&!n?`number`:`text`})}return Ay({schema:t,value:r,path:a,hints:o,disabled:c,showLabel:u,revealSensitive:e.revealSensitive??!1,isSensitivePathRevealed:e.isSensitivePathRevealed,onToggleSensitivePath:e.onToggleSensitivePath,onPatch:l})}if(t.enum){let o=t.enum;if(o.length<=5){let e=r??t.default;return n`
        <div class="cfg-field">
          ${u?n`<label class="cfg-field__label">${f}</label>`:i}
          ${p?n`<div class="cfg-field__help">${p}</div>`:i}
          ${Ty(m)}
      ...
      `}return ky({...e,options:o,value:r??t.default})}if(d===`object`)return jy(e);if(d===`array`)return My(e);if(d===`boolean`){let e=typeof r==`boolean`?r:typeof t.default==`boolean`?t.default:!1;return n`
    ...
    `}return d===`number`||d===`integer`?Oy(e):d===`string`?Dy({...e,inputType:`text`}):n`
    <div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${f}</div>
      <div class="cfg-field__error">Unsupported type: ${d}. Use Raw mode.</div>
    </div>
  `}function Dy(e){let{schema:t,value:r,path:a,hints:o,disabled:s,onPatch:c,inputType:l}=e,u=e.showLabel??!0,d=ue(a,o),{label:f,help:p,tags:m}=by(a,t,o),h=hy({path:a,value:r,hints:o,revealSensitive:e.revealSensitive??!1,isSensitivePathRevealed:e.isSensitivePathRevealed}),g=h.isRedacted?he:d?.placeholder??(t.default===void 0?``:`Default: ${String(t.default)}`),_=h.isRedacted?``:r??``,v=h.isSensitive&&!h.isRedacted?`text`:l;return n`
    <div class="cfg-field">
      ${u?n`<label class="cfg-field__label">${f}</label>`:i}
      ${p?n`<div class="cfg-field__help">${p}</div>`:i}
      ${Ty(m)}
      <div class="cfg-input-wrap">
        ...
        />
        ${gy({path:a,state:h,disabled:s,onToggleSensitivePath:e.onToggleSensitivePath})}
  ...
  `}function Oy(e){let{schema:t,value:r,path:a,hints:o,disabled:s,onPatch:c}=e,l=e.showLabel??!0,{label:u,help:d,tags:f}=by(a,t,o),p=r??t.default??``,m=typeof p==`number`?p:0;return n`
    <div class="cfg-field">
  ...
  `}function ky(e){let{schema:t,value:r,path:a,hints:o,disabled:s,options:c,onPatch:l}=e,u=e.showLabel??!0,{label:d,help:f,tags:p}=by(a,t,o),m=r??t.default,h=c.findIndex(e=>e===m||String(e)===String(m)),g=`__unset__`;return n`
    <div class="cfg-field">
  ...
  `}function Ay(e){let{schema:t,value:r,path:a,hints:o,disabled:s,onPatch:c}=e,l=e.showLabel??!0,{label:u,help:d,tags:f}=by(a,t,o),p=py(r),m=hy({path:a,value:r,hints:o,revealSensitive:e.revealSensitive??!1,isSensitivePathRevealed:e.isSensitivePathRevealed}),h=m.isRedacted?``:p;return n`
    <div class="cfg-field">
      ${l?n`<label class="cfg-field__label">${u}</label>`:i}
      ${d?n`<div class="cfg-field__help">${d}</div>`:i}
      ${Ty(f)}
      <div class="cfg-input-wrap">
        ...
        ></textarea>
        ${gy({path:a,state:m,disabled:s,onToggleSensitivePath:e.onToggleSensitivePath})}
      </div>
    </div>
  `}function jy(e){let{schema:t,value:r,path:a,hints:o,unsupported:s,disabled:c,onPatch:l,searchCriteria:u,revealSensitive:d,isSensitivePathRevealed:f,onToggleSensitivePath:p}=e,m=e.showLabel??!0,{label:h,help:g,tags:_}=by(a,t,o),v=u&&_y(u)&&Cy({schema:t,path:a,hints:o,criteria:u})?void 0:u,y=r??t.default,b=y&&typeof y==`object`&&!Array.isArray(y)?y:{},x=t.properties??{},S=Object.entries(x).toSorted((e,t)=>{let n=ue([...a,e[0]],o)?.order??0,r=ue([...a,t[0]],o)?.order??0;return n===r?e[0].localeCompare(t[0]):n-r}),C=new Set(Object.keys(x)),w=t.additionalProperties,T=!!w&&typeof w==`object`,E=n`
    ${S.map(([e,t])=>Ey({schema:t,value:b[e],path:[...a,e],hints:o,unsupported:s,disabled:c,searchCriteria:v,revealSensitive:d,isSensitivePathRevealed:f,onToggleSensitivePath:p,onPatch:l}))}
    ${T?Ny({schema:w,value:b,path:a,hints:o,unsupported:s,disabled:c,reservedKeys:C,searchCriteria:v,revealSensitive:d,isSensitivePathRevealed:f,onToggleSensitivePath:p,onPatch:l}):i}
  `;return a.length===1?n`
    ...
    <details class="cfg-object" ?open=${a.length<=2}>
      <summary class="cfg-object__header">
        ...
        <span class="cfg-object__chevron">${my.chevronDown}</span>
      </summary>
  ...
  `:n`
    ...
    `}function My(e){let{schema:t,value:r,path:a,hints:o,unsupported:s,disabled:c,onPatch:l,searchCriteria:u,revealSensitive:d,isSensitivePathRevealed:f,onToggleSensitivePath:p}=e,m=e.showLabel??!0,{label:h,help:g,tags:_}=by(a,t,o),v=u&&_y(u)&&Cy({schema:t,path:a,hints:o,criteria:u})?void 0:u,y=Array.isArray(t.items)?t.items[0]:t.items;if(!y)return n`
      <div class="cfg-field cfg-field--error">
    ...
    <div class="cfg-array">
      <div class="cfg-array__header">
        ...
        <button
          ...
          @click=${()=>{l(a,[...b,ce(y)])}}
        >
          <span class="cfg-array__add-icon">${my.plus}</span>
          Add
        </button>
      </div>
          ...
          ${b.map((e,t)=>n`
            <div class="cfg-array__item">
              ...
              <div class="cfg-array__item-content">
                ${Ey({schema:y,value:e,path:[...a,t],hints:o,unsupported:s,disabled:c,searchCriteria:v,showLabel:!1,revealSensitive:d,isSensitivePathRevealed:f,onToggleSensitivePath:p,onPatch:l})}
              </div>
            </div>
          `)}
        </div>
  ...
  `}function Ny(e){let{schema:t,value:r,path:i,hints:a,unsupported:o,disabled:s,reservedKeys:c,onPatch:l,searchCriteria:u,revealSensitive:d,isSensitivePathRevealed:f,onToggleSensitivePath:p}=e,m=fy(t),h=Object.entries(r??{}).filter(([e])=>!c.has(e)),g=u&&_y(u)?h.filter(([e,n])=>wy({schema:t,value:n,path:[...i,e],hints:a,criteria:u})):h;return n`
    <div class="cfg-map">
      <div class="cfg-map__header">
        ...
        >
          <span class="cfg-map__add-icon">${my.plus}</span>
          Add Entry
        </button>
      </div>
      ...
      ${g.length===0?n`
        ...
        <div class="cfg-map__items">
          ${g.map(([e,c])=>{let h=[...i,e],g=py(c),_=hy({path:h,value:c,hints:a,revealSensitive:d??!1,isSensitivePathRevealed:f});return n`
                ...
                <div class="cfg-map__item-value">
                  ${m?n`
                        <div class="cfg-input-wrap">
                          ...
                          ></textarea>
                          ${gy({path:h,state:_,disabled:s,onToggleSensitivePath:p})}
                        </div>
                      `:Ey({schema:t,value:c,path:h,hints:a,unsupported:o,disabled:s,searchCriteria:u,showLabel:!1,revealSensitive:d,isSensitivePathRevealed:f,onToggleSensitivePath:p,onPatch:l})}
                </div>
              </div>
            `})}
        </div>
      ...
      ${f?(()=>{let{sectionKey:t,subsectionKey:o,schema:s}=f,l=ue([t,o],e.uiHints),u=l?.label??s.title??de(o),d=l?.help??s.description??``,p=r[t],m=p&&typeof p==`object`?p[o]:void 0;return n`
              <section class="config-section-card" id=${`config-section-${t}-${o}`}>
                <div class="config-section-card__header">
                  <span class="config-section-card__icon">${Iy(t)}</span>
                ...
                <div class="config-section-card__content">
                  ${Ey({schema:s,value:m,path:[t,o],hints:e.uiHints,unsupported:a,disabled:e.disabled??!1,showLabel:!1,searchCriteria:c,revealSensitive:e.revealSensitive??!1,isSensitivePathRevealed:e.isSensitivePathRevealed,onToggleSensitivePath:e.onToggleSensitivePath,onPatch:e.onPatch})}
                </div>
              </section>
            `})():d.map(([t,o])=>{let s=Fy[t]??{label:t.charAt(0).toUpperCase()+t.slice(1),description:o.description??``};return n`
              <section class="config-section-card" id="config-section-${t}">
                ...
                <div class="config-section-card__content">
                  ${Ey({schema:o,value:r[t],path:[t],hints:e.uiHints,unsupported:a,disabled:e.disabled??!1,showLabel:!1,searchCriteria:c,revealSensitive:e.revealSensitive??!1,isSensitivePathRevealed:e.isSensitivePathRevealed,onToggleSensitivePath:e.onToggleSensitivePath,onPatch:e.onPatch})}
                </div>
              </section>
            `})}
    </div>
  `}var zy=new Set([`title`,`description`,`default`,`nullable`]);function By(e){return Object.keys(e??{}).filter(e=>!zy.has(e)).length===0}function Vy(e){let t=e.filter(e=>e!=null),n=t.length!==e.length,r=[];for(let e of t)r.some(t=>Object.is(t,e))||r.push(e);return{enumValues:r,nullable:n}}function Hy(e){return!e||typeof e!=`object`?{schema:null,unsupportedPaths:[`<root>`]}:Uy(e,[])}function Uy(e,t){let n=new Set,r={...e},i=le(t)||`<root>`;if(e.anyOf||e.oneOf||e.allOf)return qy(e,t)||{schema:e,unsupportedPaths:[i]};let a=Array.isArray(e.type)&&e.type.includes(`null`),o=R(e)??(e.properties||e.additionalProperties?`object`:void 0);if(r.type=o??e.type,r.nullable=a||e.nullable,r.enum){let{enumValues:e,nullable:t}=Vy(r.enum);r.enum=e,t&&(r.nullable=!0),e.length===0&&n.add(i)}if(o===`object`){let a=e.properties??{},o={};for(let[e,r]of Object.entries(a)){let i=Uy(r,[...t,e]);i.schema&&(o[e]=i.schema);for(let e of i.unsupportedPaths)n.add(e)}if(r.properties=o,e.additionalProperties===!0)r.additionalProperties={};else if(e.additionalProperties===!1)r.additionalProperties=!1;else if(e.additionalProperties&&typeof e.additionalProperties==`object`&&!By(e.additionalProperties)){let a=Uy(e.additionalProperties,[...t,`*`]);r.additionalProperties=a.schema??e.additionalProperties,a.unsupportedPaths.length>0&&n.add(i)}}else if(o===`array`){let a=Array.isArray(e.items)?e.items[0]:e.items;if(!a)n.add(i);else{let e=Uy(a,[...t,`*`]);r.items=e.schema??a,e.unsupportedPaths.length>0&&n.add(i)}}else o!==`string`&&o!==`number`&&o!==`integer`&&o!==`boolean`&&!r.enum&&n.add(i);return{schema:r,unsupportedPaths:Array.from(n)}}function Wy(e){if(R(e)!==`object`)return!1;let t=e.properties?.source,n=e.properties?.provider,r=e.properties?.id;return!t||!n||!r?!1:typeof t.const==`string`&&R(n)===`string`&&R(r)===`string`}function Gy(e){let t=e.oneOf??e.anyOf;return!t||t.length===0?!1:t.every(e=>Wy(e))}function Ky(e,t,n,r){let i=n.findIndex(e=>R(e)===`string`);if(i<0)return null;let a=n.filter((e,t)=>t!==i);return a.length!==1||!Gy(a[0])?null:Uy({...e,...n[i],nullable:r,anyOf:void 0,oneOf:void 0,allOf:void 0},t)}function qy(e,t){if(e.allOf)return null;let n=e.anyOf??e.oneOf;if(!n)return null;let r=[],i=[],a=!1;for(let e of n){if(!e||typeof e!=`object`)return null;if(Array.isArray(e.enum)){let{enumValues:t,nullable:n}=Vy(e.enum);r.push(...t),n&&(a=!0);continue}if(`const`in e){if(e.const==null){a=!0;continue}r.push(e.const);continue}if(R(e)===`null`){a=!0;continue}i.push(e)}let o=Ky(e,t,i,a);if(o)return o;if(r.length>0&&i.length===0){let t=[];for(let e of r)t.some(t=>Object.is(t,e))||t.push(e);return{schema:{...e,enum:t,nullable:a,anyOf:void 0,oneOf:void 0,allOf:void 0},unsupportedPaths:[]}}if(i.length===1){let e=Uy(i[0],t);return e.schema&&(e.schema.nullable=a||e.schema.nullable),e}let s=new Set([`string`,`number`,`integer`,`boolean`,`object`,`array`]);return i.length>0&&r.length===0&&i.every(e=>{let t=R(e);return!!t&&s.has(String(t))})?{schema:{...e,nullable:a},unsupportedPaths:[]}:null}var Jy={all:n`
  ...
  `},Yy=[{id:`core`,label:`Core`,sections:[{key:`env`,label:`Environment`},{key:`auth`,label:`Authentication`},{key:`update`,label:`Updates`},{key:`meta`,label:`Meta`},{key:`logging`,label:`Logging`}]},{id:`ai`,label:`AI & Agents`,sections:[{key:`agents`,label:`Agents`},{key:`models`,label:`Models`},{key:`skills`,label:`Skills`},{key:`tools`,label:`Tools`},{key:`memory`,label:`Memory`},{key:`session`,label:`Session`}]},{id:`communication`,label:`Communication`,sections:[{key:`channels`,label:`Channels`},{key:`messages`,label:`Messages`},{key:`broadcast`,label:`Broadcast`},{key:`talk`,label:`Talk`},{key:`audio`,label:`Audio`}]},{id:`automation`,label:`Automation`,sections:[{key:`commands`,label:`Commands`},{key:`hooks`,label:`Hooks`},{key:`bindings`,label:`Bindings`},{key:`cron`,label:`Cron`},{key:`approvals`,label:`Approvals`},{key:`plugins`,label:`Plugins`}]},{id:`infrastructure`,label:`Infrastructure`,sections:[{key:`gateway`,label:`Gateway`},{key:`web`,label:`Web`},{key:`browser`,label:`Browser`},{key:`nodeHost`,label:`NodeHost`},{key:`canvasHost`,label:`CanvasHost`},{key:`discovery`,label:`Discovery`},{key:`media`,label:`Media`}]},{id:`appearance`,label:`Appearance`,sections:[{key:`__appearance__`,label:`Appearance`},{key:`ui`,label:`UI`},{key:`wizard`,label:`Setup Wizard`}]}],Xy=new Set(Yy.flatMap(e=>e.sections.map(e=>e.key)));function Zy(e){return Jy[e]??Jy.default}function Qy(e,t){if(!e||R(e)!==`object`||!e.properties)return e;let n=t.include,r=t.exclude,i={};for(let[t,a]of Object.entries(e.properties))n&&n.size>0&&!n.has(t)||r&&r.size>0&&r.has(t)||(i[t]=a);return{...e,properties:i}}function $y(e,t){let n=t.include,r=t.exclude;return(!n||n.size===0)&&(!r||r.size===0)?e:e.filter(e=>{if(e===`<root>`)return!0;let[t]=e.split(`.`);return n&&n.size>0?n.has(t):r&&r.size>0?!r.has(t):!0})}function eb(e,t){return Fy[e]||{label:t?.title??de(e),description:t?.description??``}}function tb(e,t){if(!e||!t)return[];let n=[];function r(e,t,i){if(e===t)return;if(typeof e!=typeof t){n.push({path:i,from:e,to:t});return}if(typeof e!=`object`||!e||t===null){e!==t&&n.push({path:i,from:e,to:t});return}if(Array.isArray(e)&&Array.isArray(t)){JSON.stringify(e)!==JSON.stringify(t)&&n.push({path:i,from:e,to:t});return}let a=e,o=t,s=new Set([...Object.keys(a),...Object.keys(o)]);for(let e of s)r(a[e],o[e],i?`${i}.${e}`:e)}return r(e,t,``),n}function nb(e,t=40){let n;try{n=JSON.stringify(e)??String(e)}catch{n=String(e)}return n.length<=t?n:n.slice(0,t-3)+`...`}function rb(e,t,n){return nb(t)}var ib=[{id:`claw`,label:`Claw`,description:`Chroma family`,icon:W.zap},{id:`knot`,label:`Knot`,description:`Blue contrast`,icon:W.link},{id:`dash`,label:`Dash`,description:`Chocolate blueprint`,icon:W.barChart}];function ab(e){return n`
  ...
  `}function ob(){return{rawRevealed:!1,envRevealed:!1,validityDismissed:!1,revealedSensitivePaths:new Set}}var sb=ob();function cb(e){let t=le(e);return t?sb.revealedSensitivePaths.has(t):!1}function lb(e){let t=le(e);t&&(sb.revealedSensitivePaths.has(t)?sb.revealedSensitivePaths.delete(t):sb.revealedSensitivePaths.add(t))}function ub(e){let t=e.showModeToggle??!1,r=e.valid==null?`unknown`:e.valid?`valid`:`invalid`,a=e.includeVirtualSections??!0,o=e.includeSections?.length?new Set(e.includeSections):null,s=e.excludeSections?.length?new Set(e.excludeSections):null,c=Hy(e.schema),l={schema:Qy(c.schema,{include:o,exclude:s}),unsupportedPaths:$y(c.unsupportedPaths,{include:o,exclude:s})},u=l.schema?l.unsupportedPaths.length>0:!1,d=t?e.formMode:`form`,f=sb.envRevealed,p=e.onRequestUpdate??(()=>e.onRawChange(e.raw)),m=l.schema?.properties??{},h=new Set([`__appearance__`]),g=Yy.map(e=>({...e,sections:e.sections.filter(e=>a&&h.has(e.key)||e.key in m)})).filter(e=>e.sections.length>0),_=Object.keys(m).filter(e=>!Xy.has(e)).map(e=>({key:e,label:e.charAt(0).toUpperCase()+e.slice(1)})),v=_.length>0?{id:`other`,label:`Other`,sections:_}:null,y=a&&e.activeSection!=null&&h.has(e.activeSection),b=e.activeSection&&!y&&l.schema&&R(l.schema)===`object`?l.schema.properties?.[e.activeSection]:void 0,x=e.activeSection&&!y?eb(e.activeSection,b):null,S=[{key:null,label:e.navRootLabel??`Settings`},...[...g,...v?[v]:[]].flatMap(e=>e.sections.map(e=>({key:e.key,label:e.label})))],C=d===`form`?tb(e.originalValue,e.formValue):[],w=d===`raw`&&e.raw!==e.originalRaw,T=d===`form`?C.length>0:w,E=!!e.formValue&&!e.loading&&!!l.schema,D=e.connected&&!e.saving&&T&&(d===`raw`?!0:E),ee=e.connected&&!e.applying&&!e.updating&&T&&(d===`raw`?!0:E),te=e.connected&&!e.applying&&!e.updating,O=a&&d===`form`&&e.activeSection===null&&!!o?.has(`__appearance__`);return n`
    <div class="config-layout">
      <main class="config-main">
        ...
        ${r===`invalid`&&!sb.validityDismissed?n`
              <div class="config-validity-warning">
                ...
                <button
                  class="btn btn--sm"
                  @click=${()=>{sb.validityDismissed=!0,p()}}
                      ...
                      <div class="config-diff__item">
                        ...
                        <div class="config-diff__values">
                          <span class="config-diff__from"
                            >${rb(t.path,t.from,e.uiHints)}</span
                          >
                          <span class="config-diff__arrow">→</span>
                          <span class="config-diff__to"
                            >${rb(t.path,t.to,e.uiHints)}</span
                          >
                        </div>
                      </div>
                    `)}
	        ...
	        ${x&&d===`form`?n`
                ...
                ${e.activeSection===`env`?n`
                      <button
                        ...
                        @click=${()=>{sb.envRevealed=!sb.envRevealed,p()}}
                      >
        ...
        <div class="config-content">
          ${e.activeSection===`__appearance__`?a?ab(e):i:d===`form`?n`
                ${O?ab(e):i}
                ${e.schemaLoading?n`
                      ...
                      `:Ry({schema:l.schema,uiHints:e.uiHints,value:e.formValue,disabled:e.loading||!e.formValue,unsupportedPaths:l.unsupportedPaths,onPatch:e.onFormPatch,searchQuery:e.searchQuery,activeSection:e.activeSection,activeSubsection:null,revealSensitive:e.activeSection===`env`?f:!1,isSensitivePathRevealed:cb,onToggleSensitivePath:e=>{lb(e),p()}})}
              `:(()=>{let t=xe(e.formValue,[],e.uiHints),r=t>0&&!sb.rawRevealed;return n`
                    ${u?n`
                      ...
                      <span style="display:flex;align-items:center;gap:8px;">
                        ...
                        ${t>0?n`
                              ...
                              <button
                                ...
                                aria-pressed=${!r}
                                @click=${()=>{sb.rawRevealed=!sb.rawRevealed,p()}}
                              >
                                ${r?W.eyeOff:W.eye}
                              </button>
                            `:i}
...
${JSON.stringify(e.issues,null,2)}</pre
  ...
  `}function db(e){let t=Math.floor(Math.max(0,e)/1e3);if(t<60)return`${t}s`;let n=Math.floor(t/60);return n<60?`${n}m`:`${Math.floor(n/60)}h`}function fb(e,t){return t?n`<div class="exec-approval-meta-row"><span>${e}</span><span>${t}</span></div>`:i}function pb(e){let t=e.execApprovalQueue[0];if(!t)return i;let r=t.request,a=t.expiresAtMs-Date.now(),o=a>0?`expires in ${db(a)}`:`expired`,s=e.execApprovalQueue.length;return n`
    <div class="exec-approval-overlay" role="dialog" aria-live="polite">
      <div class="exec-approval-card">
        ...
        <div class="exec-approval-meta">
          ${fb(`Host`,r.host)}
          ${fb(`Agent`,r.agentId)}
          ${fb(`Session`,r.sessionKey)}
          ${fb(`CWD`,r.cwd)}
          ${fb(`Resolved`,r.resolvedPath)}
          ${fb(`Security`,r.security)}
          ${fb(`Ask`,r.ask)}
        </div>
  ...
  `}function mb(e){let{pendingGatewayUrl:t}=e;return t?n`
  ...
  `:i}function hb(e){return n`
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${mu(ua(e.basePath??``))} alt="OpenClaw" />
  ...
  `}var gb=[`noopener`,`noreferrer`],_b=`_blank`;function vb(e){let t=[],n=new Set(gb);for(let r of(e??``).split(/\s+/)){let e=r.trim().toLowerCase();!e||n.has(e)||(n.add(e),t.push(e))}return[...gb,...t].join(` `)}function yb(e){return e===`error`?`danger`:e===`warning`?`warn`:``}function bb(e){return e in W?W[e]:W.radio}function xb(e){return e.items.length===0?i:n`
    <section class="card ov-attention">
      <div class="card-title">${P(`overview.attention.title`)}</div>
      <div class="ov-attention-list">
        ${e.items.map(e=>n`
            <div class="ov-attention-item ${yb(e.severity)}">
              <span class="ov-attention-icon">${bb(e.icon)}</span>
  ...
  `}function Sb(e){let t=e.ts??null;return t?p(t):`n/a`}function Cb(e){return e?`${new Date(e).toLocaleDateString(void 0,{weekday:`short`})}, ${f(e)} (${p(e)})`:`n/a`}function wb(e){if(e.totalTokens==null)return`n/a`;let t=e.totalTokens??0,n=e.contextTokens??0;return n?`${t} / ${n}`:String(t)}function Tb(e){if(e==null)return``;try{return JSON.stringify(e,null,2)}catch{return String(e)}}function Eb(e){let t=e.state??{},n=t.nextRunAtMs?f(t.nextRunAtMs):`n/a`,r=t.lastRunAtMs?f(t.lastRunAtMs):`n/a`;return`${t.lastStatus??`n/a`} · next ${n} · last ${r}`}function Db(e){let t=e.schedule;if(t.kind===`at`){let e=Date.parse(t.at);return Number.isFinite(e)?`At ${f(e)}`:`At ${t.at}`}return t.kind===`every`?`Every ${d(t.everyMs)}`:`Cron ${t.expr}${t.tz?` (${t.tz})`:``}`}function Ob(e){let t=e.payload;if(t.kind===`systemEvent`)return`System: ${t.text}`;let n=`Agent: ${t.message}`,r=e.delivery;if(r&&r.mode!==`none`){let e=r.mode===`webhook`?r.to?` (${r.to})`:``:r.channel||r.to?` (${r.channel??`last`}${r.to?` -> ${r.to}`:``})`:``;return`${n} · ${r.mode}${e}`}return n}var kb=/\d{3,}/g;function Ab(e){return n`${Go(e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(kb,e=>`<span class="blur-digits">${e}</span>`))}`}function jb(e,t){return n`
  ...
  `}function Nb(e){if(!(e.usageResult!=null||e.sessionsResult!=null||e.skillsReport!=null))return Mb();let t=e.usageResult?.totals,r=m(t?.totalCost),a=l(t?.totalTokens),o=t?String(e.usageResult?.aggregates?.messages?.total??0):`0`,s=e.sessionsResult?.count??null,c=e.skillsReport?.skills??[],u=c.filter(e=>!e.disabled).length,d=c.filter(e=>e.blockedByAllowlist).length,f=c.length,h=e.cronStatus?.enabled??null,g=e.cronStatus?.nextWakeAtMs??null,_=e.cronJobs.length,v=e.cronJobs.filter(e=>e.state?.lastStatus===`error`).length,y=h==null?P(`common.na`):h?`${_} jobs`:P(`common.disabled`),b=v>0?n`<span class="danger">${v} failed</span>`:g?P(`overview.stats.cronNext`,{time:Cb(g)}):``,x=[{kind:`cost`,tab:`usage`,label:P(`overview.cards.cost`),value:r,hint:`${a} tokens · ${o} msgs`},{kind:`sessions`,tab:`sessions`,label:P(`overview.stats.sessions`),value:String(s??P(`common.na`)),hint:P(`overview.stats.sessionsHint`)},{kind:`skills`,tab:`skills`,label:P(`overview.cards.skills`),value:`${u}/${f}`,hint:d>0?`${d} blocked`:`${u} active`},{kind:`cron`,tab:`cron`,label:P(`overview.stats.cron`),value:y,hint:b}],S=e.sessionsResult?.sessions.slice(0,5)??[];return n`
    ...
    ${S.length>0?n`
          ...
          <ul class="ov-recent__list">
            ${S.map(e=>n`
                <li class="ov-recent__row">
                  <span class="ov-recent__key">${Ab(e.displayName||e.label||e.key)}</span>
      ...
      `:i}
  `}function Pb(e){if(e.events.length===0)return i;let t=e.events.slice(0,20);return n`
      ...
      <div class="ov-event-log-list">
        ${t.map(e=>n`
            <div class="ov-event-log-entry">
              ...
              ${e.payload?n`<span class="ov-event-log-payload muted">${Tb(e.payload).slice(0,120)}</span>`:i}
            </div>
          `)}
      </div>
    </details>
  `}var Fb=new Set([X.AUTH_REQUIRED,X.AUTH_TOKEN_MISSING,X.AUTH_PASSWORD_MISSING,X.AUTH_TOKEN_NOT_CONFIGURED,X.AUTH_PASSWORD_NOT_CONFIGURED]),Ib=new Set([...Fb,X.AUTH_UNAUTHORIZED,X.AUTH_TOKEN_MISMATCH,X.AUTH_PASSWORD_MISMATCH,X.AUTH_DEVICE_TOKEN_MISMATCH,X.AUTH_RATE_LIMITED,X.AUTH_TAILSCALE_IDENTITY_MISSING,X.AUTH_TAILSCALE_PROXY_MISSING,X.AUTH_TAILSCALE_WHOIS_FAILED,X.AUTH_TAILSCALE_IDENTITY_MISMATCH]),Lb=new Set([X.CONTROL_UI_DEVICE_IDENTITY_REQUIRED,X.DEVICE_IDENTITY_REQUIRED]);function Rb(e,t,n){return e||!t?!1:n===X.PAIRING_REQUIRED?!0:t.toLowerCase().includes(`pairing required`)}function zb(e){return e.connected||!e.lastError?null:e.lastErrorCode?Ib.has(e.lastErrorCode)?Fb.has(e.lastErrorCode)?`required`:`failed`:null:e.lastError.toLowerCase().includes(`unauthorized`)?!e.hasToken&&!e.hasPassword?`required`:`failed`:null}function Bb(e,t,n){if(e||!t)return!1;if(n)return Lb.has(n);let r=t.toLowerCase();return r.includes(`secure context`)||r.includes(`device identity required`)}function Vb(e){return e.replace(/\x1b\]8;;.*?\x1b\\|\x1b\]8;;\x1b\\/g,``).replace(/\x1b\[[0-9;]*m/g,``)}function Hb(e){if(e.lines.length===0)return i;let t=e.lines.slice(-50).map(e=>Vb(e)).join(`
`);return n`
  ...
  `}function Ub(e){let t=e.hello?.snapshot,r=t?.uptimeMs?d(t.uptimeMs):P(`common.na`),a=e.hello?.policy?.tickIntervalMs,o=a?`${(a/1e3).toFixed(a%1e3==0?0:1)}s`:P(`common.na`),s=t?.authMode===`trusted-proxy`,c=Rb(e.connected,e.lastError,e.lastErrorCode)?n`
    ...
    `:null,l=(()=>{let t=zb({connected:e.connected,lastError:e.lastError,lastErrorCode:e.lastErrorCode,hasToken:!!e.settings.token.trim(),hasPassword:!!e.password.trim()});return t==null?null:t===`required`?n`
        <div class="muted" style="margin-top: 8px">
    ...
    `})(),u=e.connected||!e.lastError||!(typeof window<`u`)||window.isSecureContext||!Bb(e.connected,e.lastError,e.lastErrorCode)?null:n`
      <div class="muted" style="margin-top: 8px">
    ...
    ${Nb({usageResult:e.usageResult,sessionsResult:e.sessionsResult,skillsReport:e.skillsReport,cronJobs:e.cronJobs,cronStatus:e.cronStatus,presenceCount:e.presenceCount,onNavigate:e.onNavigate})}

    ${xb({items:e.attentionItems})}

    <div class="ov-section-divider"></div>

    <div class="ov-bottom-grid">
      ${Pb({events:e.eventLog})}

      ${Hb({lines:e.overviewLogLines,onRefreshLogs:e.onRefreshLogs})}
    </div>

  `}var Wb;function Gb(e){let t={mod:null,promise:null};return()=>t.mod?t.mod:(t.promise||=e().then(e=>(t.mod=e,Wb?.(),e)),null)}var Kb=Gb(()=>k(()=>import(`./agents-o0XlosnJ.js`),__vite__mapDeps([0,1,2,3,4]),import.meta.url)),qb=Gb(()=>k(()=>import(`./activity-feed-BaoReQDN.js`),__vite__mapDeps([5,2]),import.meta.url)),Jb=Gb(()=>k(()=>import(`./graph-C9FY0FKZ.js`),__vite__mapDeps([6,2]),import.meta.url)),Yb=Gb(()=>k(()=>import(`./connections-n_12KK8F.js`),__vite__mapDeps([7,2]),import.meta.url)),AF_LAZY=Gb(()=>k(()=>import(`./appflowy-embed-CjDc9_rO.js`),[],import.meta.url)),Xb=Gb(()=>k(()=>import(`./channels-BY9pxe1L.js`),__vite__mapDeps([8,1,2,3]),import.meta.url)),Zb=Gb(()=>k(()=>import(`./cron-CpuFn1O_.js`),__vite__mapDeps([9,1,2]),import.meta.url)),Qb=Gb(()=>k(()=>import(`./debug-L_kVlYAn.js`),__vite__mapDeps([10,2]),import.meta.url)),$b=Gb(()=>k(()=>import(`./instances-WnGbwLPo.js`),__vite__mapDeps([11,2]),import.meta.url)),ex=Gb(()=>k(()=>import(`./logs-Cqf1DrUQ.js`),__vite__mapDeps([12,2]),import.meta.url)),tx=Gb(()=>k(()=>import(`./nodes-DoWLg7bI.js`),__vite__mapDeps([13,1,2]),import.meta.url)),nx=Gb(()=>k(()=>import(`./sessions-9yJTXCGu.js`),__vite__mapDeps([14,1,2]),import.meta.url)),rx=Gb(()=>k(()=>import(`./skills-DVgscwN4.js`),__vite__mapDeps([15,1,2,4]),import.meta.url));function ix(e,t){let n=e();return n?t(n):i}function ax(e){return e===`tasks`?`activity`:e===`automations`?`cron`:e}function ox(e,t,r){let a=ax(t),o=fa(t,e.basePath),s=e.tab===t||e.tab===a,c=r?.collapsed??e.settings.navCollapsed;return n`
    <a
      href=${o}
      class="nav-item ${s?`nav-item--active`:``}"
      @click=${n=>{if(!(n.defaultPrevented||n.button!==0||n.metaKey||n.ctrlKey||n.shiftKey||n.altKey)){if(t===`tasks`||t===`appflowy`){window.location.href=`/tasks`;return}if(n.preventDefault(),t===`chat`){let t=e.hello?.snapshot,n=t?.sessionDefaults?.mainSessionKey?.trim()||t?.sessionDefaults?.mainKey?.trim()||`main`;e.sessionKey!==n&&(e.sessionKey=n,e.chatMessage=``,e.chatStream=null,e.chatRunId=null,e.applySettings({...e.settings,sessionKey:n,lastActiveSessionKey:n}))}e.setTab(a)}}}
      title=${_a(t)}
    >
      <span class="nav-item__icon" aria-hidden="true">${W[ha(t)]}</span>
      ${c?i:n`<span class="nav-item__text">${_a(t)}</span>`}
    </a>
  `}var sx=`openclaw:control-ui:update-banner-dismissed:v1`,cx=[`off`,`minimal`,`low`,`medium`,`high`],lx=[`UTC`,`America/Los_Angeles`,`America/Denver`,`America/Chicago`,`America/New_York`,`Europe/London`,`Europe/Berlin`,`Asia/Tokyo`];function ux(e){return/^https?:\/\//i.test(e.trim())}function dx(e){return typeof e==`string`?e.trim():``}function fx(e){let t=new Set,n=[];for(let r of e){let e=r.trim();if(!e)continue;let i=e.toLowerCase();t.has(i)||(t.add(i),n.push(e))}return n}function px(){try{let e=E()?.getItem(sx);if(!e)return null;let t=JSON.parse(e);return!t||typeof t.latestVersion!=`string`?null:{latestVersion:t.latestVersion,channel:typeof t.channel==`string`?t.channel:null,dismissedAtMs:typeof t.dismissedAtMs==`number`?t.dismissedAtMs:Date.now()}}catch{return null}}function mx(e){let t=px();if(!t)return!1;let n=e,r=n&&typeof n.latestVersion==`string`?n.latestVersion:null,i=n&&typeof n.channel==`string`?n.channel:null;return!!(r&&t.latestVersion===r&&t.channel===i)}function hx(e){let t=e,n=t&&typeof t.latestVersion==`string`?t.latestVersion:null;if(!n)return;let r={latestVersion:n,channel:t&&typeof t.channel==`string`?t.channel:null,dismissedAtMs:Date.now()};try{E()?.setItem(sx,JSON.stringify(r))}catch{}}var gx=/^data:/i,_x=/^https?:\/\//i,vx=[`channels`,`messages`,`broadcast`,`talk`,`audio`],yx=[`__appearance__`,`ui`,`wizard`],bx=[`commands`,`hooks`,`bindings`,`cron`,`approvals`,`plugins`],xx=[`gateway`,`web`,`browser`,`nodeHost`,`canvasHost`,`discovery`,`media`],Sx=[`agents`,`models`,`skills`,`tools`,`memory`,`session`];function Cx(e){let t=e.agentsList?.agents??[],n=st(e.sessionKey)?.agentId??e.agentsList?.defaultId??`main`,r=t.find(e=>e.id===n)?.identity,i=r?.avatarUrl??r?.avatar;if(i)return gx.test(i)||_x.test(i)?i:r?.avatarUrl}function wx(e){let t=e,r=typeof t.requestUpdate==`function`?()=>t.requestUpdate?.():void 0;if(Wb=r,!e.connected)return n`
      ${hb(e)}
      ${mb(e)}
    `;let a=e.presenceEntries.length,o=e.sessionsResult?.count??null,s=e.cronStatus?.nextWakeAtMs??null,c=e.connected?null:P(`chat.disconnected`),l=e.tab===`chat`,u=l&&(e.settings.chatFocusMode||e.onboarding),d=!!(e.navDrawerOpen&&!u&&!e.onboarding),f=!!(e.settings.navCollapsed&&!d),p=e.onboarding?!1:e.settings.chatShowThinking,m=e.onboarding?!0:e.settings.chatShowToolCalls,h=Cx(e),g=e.chatAvatarUrl??h??null,_=e.configForm??e.configSnapshot?.config;ua(e.basePath??``);let v=e.agentsSelectedId??e.agentsList?.defaultId??e.agentsList?.agents?.[0]?.id??null,y=()=>e.configForm??e.configSnapshot?.config,b=e=>ze(y(),e),x=t=>Be(e,t),S=Eu(new Set([...e.agentsList?.agents?.map(e=>e.id.trim())??[],...e.cronJobs.map(e=>typeof e.agentId==`string`?e.agentId.trim():``).filter(Boolean)].filter(Boolean))),C=Eu(new Set([...e.cronModelSuggestions,...Du(_),...e.cronJobs.map(e=>e.payload.kind!==`agentTurn`||typeof e.payload.model!=`string`?``:e.payload.model.trim()).filter(Boolean)].filter(Boolean))),w=cn(e),T=e.cronForm.deliveryChannel&&e.cronForm.deliveryChannel.trim()?e.cronForm.deliveryChannel.trim():`last`,E=e.cronJobs.map(e=>dx(e.delivery?.to)).filter(Boolean),D=(T===`last`?Object.values(e.channelsSnapshot?.channelAccounts??{}).flat():e.channelsSnapshot?.channelAccounts?.[T]??[]).flatMap(e=>[dx(e.accountId),dx(e.name)]).filter(Boolean),ee=fx([...E,...D]),te=fx(D),O=e.cronForm.deliveryMode===`webhook`?ee.filter(e=>ux(e)):ee;return n`
    ${uy({open:e.paletteOpen,query:e.paletteQuery,activeIndex:e.paletteActiveIndex,onToggle:()=>{e.paletteOpen=!e.paletteOpen},onQueryChange:t=>{e.paletteQuery=t},onActiveIndexChange:t=>{e.paletteActiveIndex=t},onNavigate:t=>{e.setTab(t)},onSlashCommand:t=>{e.setTab(`chat`),e.chatMessage=t.endsWith(` `)?t:`${t} `}})}
    <div
    ...
    >
          ...
          <div class="sidebar-shell">
            ...
            <div class="sidebar-shell__body">
              <nav class="sidebar-nav">
                ...
                ${(()=>{let t=e.settings.navGroupsCollapsed.advanced??!0,r=sa.some(t=>t===e.tab),a=f||r||!t;return n`
                    <section class="nav-section ${a?``:`nav-section--collapsed`}">
                      ${f?i:n`
                              <button
                                class="nav-section__label"
                                @click=${()=>{let n={...e.settings.navGroupsCollapsed};n.advanced=!t,e.applySettings({...e.settings,navGroupsCollapsed:n})}}
                                aria-expanded=${a}
                              >
      ...
      <main class="content ${l?`content--chat`:``}">
        ${e.updateAvailable&&e.updateAvailable.latestVersion!==e.updateAvailable.currentVersion&&!mx(e.updateAvailable)?n`<div class="update-banner callout danger" role="alert">
              ...
              <button
                ...
                @click=${()=>{hx(e.updateAvailable),e.updateAvailable=null}}
              >
                ${W.x}
              </button>
            </div>`:i}
        ${e.tab===`config`?i:n`<section class="content-header">
              <div>
                ${l?wv(e):n`<div class="page-title">${va(e.tab)}</div>`}
                ${l?i:n`<div class="page-sub">${ya(e.tab)}</div>`}
              </div>
              <div class="page-meta">
