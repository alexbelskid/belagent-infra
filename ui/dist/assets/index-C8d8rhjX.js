const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./agents-mlUQebe7.js","./format-DeRVtGzv.js","./lit-BZwq2xLD.js","./channel-config-extras-ClZgd1ad.js","./skills-shared-DMlqIU2G.js","./activity-feed-BaoReQDN.js","./graph-DCqVS9Rx.js","./connections-n_12KK8F.js","./channels-CUZzlB5v.js","./cron-DM_UJh0U.js","./debug-B5GZbuU-.js","./instances-Xt-OTkdG.js","./logs-Cqf1DrUQ.js","./nodes-DoWLg7bI.js","./sessions-BL2QS0rY.js","./skills-DVgscwN4.js"])))=>i.map(i=>d[i]);
    ...
    >
      ...
      <main class="content ${l?`content--chat`:``}">
        ...
        ${e.tab===`config`?i:n`<section class="content-header">
              <div>
                ${l?i:n`<div class="page-title">${va(e.tab)}</div>`}
...
//# sourceMappingURL=index-C8d8rhjX.js.map