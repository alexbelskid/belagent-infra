...
`);return n`
  ...
  `}var Gb;function Kb(e){let t={mod:null,promise:null};return()=>t.mod?t.mod:(t.promise||=e().then(e=>(t.mod=e,Gb?.(),e)),null)}var qb=Kb(()=>k(()=>import(`./agents-Jg0XrQGr.js`),__vite__mapDeps([0,1,2,3,4]),import.meta.url)),Jb=Kb(()=>k(()=>import(`./activity-feed-BaoReQDN.js`),__vite__mapDeps([5,1]),import.meta.url)),Yb=Kb(()=>k(()=>import(`./graph-UtynTRU0.js`),__vite__mapDeps([6,1]),import.meta.url)),Xb=Kb(()=>k(()=>import(`./connections-n_12KK8F.js`),__vite__mapDeps([7,1]),import.meta.url)),Zb=Kb(()=>k(()=>import(`./kanban-BhSG5YQz.js`),__vite__mapDeps([8,1]),import.meta.url)),Qb=Kb(()=>k(()=>import(`./channels-DklrT_Oy.js`),__vite__mapDeps([9,1,2,3]),import.meta.url)),$b=Kb(()=>k(()=>import(`./cron-CxnXlcml.js`),__vite__mapDeps([10,1,2]),import.meta.url)),ex=Kb(()=>k(()=>import(`./debug-ABADg6V2.js`),__vite__mapDeps([11,1]),import.meta.url)),tx=Kb(()=>k(()=>import(`./instances-CwspGuVC.js`),__vite__mapDeps([12,1]),import.meta.url)),nx=Kb(()=>k(()=>import(`./logs-tMLIWylQ.js`),__vite__mapDeps([13,1]),import.meta.url)),rx=Kb(()=>k(()=>import(`./nodes-D6GBdHku.js`),__vite__mapDeps([14,1,2]),import.meta.url)),ix=Kb(()=>k(()=>import(`./sessions-BOtfCPre.js`),__vite__mapDeps([15,1,2]),import.meta.url)),ax=Kb(()=>k(()=>import(`./skills-CAlEAXFI.js`),__vite__mapDeps([16,1,2,4]),import.meta.url));function ox(e,t){let n=e();return n?t(n):i}var sx=`openclaw:control-ui:update-banner-dismissed:v1`,cx=[`off`,`minimal`,`low`,`medium`,`high`],lx=[`UTC`,`America/Los_Angeles`,`America/Denver`,`America/Chicago`,`America/New_York`,`Europe/London`,`Europe/Berlin`,`Asia/Tokyo`];function ux(e){return/^https?:\/\//i.test(e.trim())}function dx(e){return typeof e==`string`?e.trim():``}function fx(e){let t=new Set,n=[];for(let r of e){let e=r.trim();if(!e)continue;let i=e.toLowerCase();t.has(i)||(t.add(i),n.push(e))}return n}function px(){try{let e=E()?.getItem(sx);if(!e)return null;let t=JSON.parse(e);return!t||typeof t.latestVersion!=`string`?null:{latestVersion:t.latestVersion,channel:typeof t.channel==`string`?t.channel:null,dismissedAtMs:typeof t.dismissedAtMs==`number`?t.dismissedAtMs:Date.now()}}catch{return null}}function mx(e){let t=px();if(!t)return!1;let n=e,r=n&&typeof n.latestVersion==`string`?n.latestVersion:null,i=n&&typeof n.channel==`string`?n.channel:null;return!!(r&&t.latestVersion===r&&t.channel===i)}function hx(e){let t=e,n=t&&typeof t.latestVersion==`string`?t.latestVersion:null;if(!n)return;let r={latestVersion:n,channel:t&&typeof t.channel==`string`?t.channel:null,dismissedAtMs:Date.now()};try{E()?.setItem(sx,JSON.stringify(r))}catch{}}var gx=/^data:/i,_x=/^https?:\/\//i,vx=[`channels`,`messages`,`broadcast`,`talk`,`audio`],yx=[`__appearance__`,`ui`,`wizard`],bx=[`commands`,`hooks`,`bindings`,`cron`,`approvals`,`plugins`],xx=[`gateway`,`web`,`browser`,`nodeHost`,`canvasHost`,`discovery`,`media`],Sx=[`agents`,`models`,`skills`,`tools`,`memory`,`session`];function Cx(e){let t=e.agentsList?.agents??[],n=st(e.sessionKey)?.agentId??e.agentsList?.defaultId??`main`,r=t.find(e=>e.id===n)?.identity,i=r?.avatarUrl??r?.avatar;if(i)return gx.test(i)||_x.test(i)?i:r?.avatarUrl}function wx(e){let t=e,r=typeof t.requestUpdate==`function`?()=>t.requestUpdate?.():void 0;if(Gb=r,!e.connected)return n`
      ${yb(e)}
      ${vb(e)}
    `;let a=e.presenceEntries.length,o=e.sessionsResult?.count??null,s=e.cronStatus?.nextWakeAtMs??null,c=e.connected?null:P(`chat.disconnected`),l=e.tab===`chat`,u=l&&(e.settings.chatFocusMode||e.onboarding),d=!!(e.navDrawerOpen&&!u&&!e.onboarding),f=!!(e.settings.navCollapsed&&!d),p=e.onboarding?!1:e.settings.chatShowThinking,m=e.onboarding?!0:e.settings.chatShowToolCalls,h=Cx(e),g=e.chatAvatarUrl??h??null,_=e.configForm??e.configSnapshot?.config,v=la(e.basePath??``),y=e.agentsSelectedId??e.agentsList?.defaultId??e.agentsList?.agents?.[0]?.id??null,b=()=>e.configForm??e.configSnapshot?.config,x=e=>ze(b(),e),S=t=>Be(e,t),C=wu(new Set([...e.agentsList?.agents?.map(e=>e.id.trim())??[],...e.cronJobs.map(e=>typeof e.agentId==`string`?e.agentId.trim():``).filter(Boolean)].filter(Boolean))),w=wu(new Set([...e.cronModelSuggestions,...Tu(_),...e.cronJobs.map(e=>e.payload.kind!==`agentTurn`||typeof e.payload.model!=`string`?``:e.payload.model.trim()).filter(Boolean)].filter(Boolean))),T=cn(e),E=e.cronForm.deliveryChannel&&e.cronForm.deliveryChannel.trim()?e.cronForm.deliveryChannel.trim():`last`,D=e.cronJobs.map(e=>dx(e.delivery?.to)).filter(Boolean),ee=(E===`last`?Object.values(e.channelsSnapshot?.channelAccounts??{}).flat():e.channelsSnapshot?.channelAccounts?.[E]??[]).flatMap(e=>[dx(e.accountId),dx(e.name)]).filter(Boolean),te=fx([...D,...ee]),O=fx(ee),k=e.cronForm.deliveryMode===`webhook`?te.filter(e=>ux(e)):te;return n`
...
//# sourceMappingURL=index-gPAi8-J1.js.map