import{i as e,n as t}from"./lit-BZwq2xLD.js";import{d as n,l as r}from"./format-DeRVtGzv.js";import{N as i,P as a,c as o,l as s}from"./index-NZYBCqsB.js";import{n as c,t as l}from"./channel-config-extras-ClZgd1ad.js";function u(e,t){let n=e;for(let e of t){if(!n)return null;let t=a(n);if(t===`object`){let t=n.properties??{};if(typeof e==`string`&&t[e]){n=t[e];continue}let r=n.additionalProperties;if(typeof e==`string`&&r&&typeof r==`object`){n=r;continue}return null}if(t===`array`){if(typeof e!=`number`)return null;n=(Array.isArray(n.items)?n.items[0]:n.items)??null;continue}return null}return n}function d(e,t){return c(e,t)??{}}var f=[`groupPolicy`,`streamMode`,`dmPolicy`];function p(t){let n=f.flatMap(e=>e in t?[[e,t[e]]]:[]);return n.length===0?null:e`
  ...
  `}function m(t){let n=o(t.schema),r=n.schema;if(!r)return e`
      <div class="callout danger">Schema unavailable. Use Raw.</div>
    `;let i=u(r,[`channels`,t.channelId]);if(!i)return e`
      <div class="callout danger">Channel config schema unavailable.</div>
    `;let a=d(t.configValue??{},t.channelId);return e`
  ...
  `}function y(e){return e?e.length<=20?e:`${e.slice(0,8)}...${e.slice(-8)}`:`n/a`}function b(n){let{props:a,nostr:o,nostrAccounts:s,accountCountLabel:c,profileFormState:l,profileFormCallbacks:u,onEditProfile:d}=n,f=s[0],p=o?.configured??f?.configured??!1,m=o?.running??f?.running??!1,g=o?.publicKey??f?.publicKey,_=o?.lastStartAt??f?.lastStartAt??null,v=o?.lastError??f?.lastError??null,b=s.length>1,x=l!=null,S=n=>{let i=n.publicKey,a=n.profile;return e`
    ...
    <div class="card">
      ...
      ${(()=>{if(x&&u)return i({state:l,callbacks:u,accountId:s[0]?.accountId??`default`});let{name:n,displayName:r,about:a,picture:c,nip05:m}=f?.profile??o?.profile??{},h=n||r||a||c||m;return e`
      <div style="margin-top: 16px; padding: 12px; background: var(--bg-secondary); border-radius: 8px;">
        ...
        ${h?e`
              <div class="status-list">
                ...
                ${a?e`<div><span class="label">About</span><span style="max-width: 300px; overflow: hidden; text-overflow: ellipsis;">${a}</span></div>`:t}
...
//# sourceMappingURL=channels-CANa63v1.js.map