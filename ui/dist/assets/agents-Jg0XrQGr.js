import{i as e,n as t}from"./lit-BZwq2xLD.js";import{l as n}from"./format-DeRVtGzv.js";import{A as r,C as i,D as a,E as o,O as s,S as c,T as l,_ as u,a as d,b as f,d as p,f as m,g as h,h as g,j as _,m as v,n as y,p as b,r as x,t as S,v as C,w,x as T,y as E}from"./index-gPAi8-J1.js";import{r as D}from"./channel-config-extras-ClZgd1ad.js";import{i as O,n as k,r as A,t as j}from"./skills-shared-DMlqIU2G.js";function M(n){let{agent:r,configForm:a,agentFilesList:o,configLoading:s,configSaving:l,configDirty:u,onConfigReload:d,onConfigSave:p,onModelChange:m,onModelFallbacksChange:h,onSelectPanel:g}=n,_=f(a,r.id),v=(o&&o.agentId===r.id?o.workspace:null)||_.entry?.workspace||_.defaults?.workspace||`default`,y=_.entry?.model?c(_.entry?.model):c(_.defaults?.model),x=c(_.defaults?.model),S=i(_.entry?.model),w=i(_.defaults?.model)||(x===`-`?null:C(x)),D=S??w??null,O=T(_.entry?.model)??[],k=Array.isArray(_.entry?.skills)?_.entry?.skills:null,A=k?.length??null,j=!!(n.defaultId&&r.id===n.defaultId),M=!a||s||l,N=e=>{let t=O.filter((t,n)=>n!==e);h(r.id,t)};return e`
    <section class="card">
          ...
          <div class="field">
            ...
            <div class="agent-chip-input" @click=${e=>{let t=e.currentTarget.querySelector(`input`);t&&t.focus()}}>
              ...
              <input
                ...
                @keydown=${e=>{let t=e.target;if(e.key===`Enter`||e.key===`,`){e.preventDefault();let n=E(t.value);n.length>0&&(h(r.id,[...O,...n]),t.value=``)}}}
                @blur=${e=>{let t=e.target,n=E(t.value);n.length>0&&(h(r.id,[...O,...n]),t.value=``)}}
              />
            </div>
          </div>
        </div>
        <div class="agent-model-actions">
          <button type="button" class="btn btn--sm" ?disabled=${s} @click=${d}>
            Reload Config
          </button>
          <button
            type="button"
      ...
      <section class="card">
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            ...
            <div class="stat-value">${d(n.status?.nextWakeAtMs??null)}</div>
          </div>
        </div>
  ...
  `}function B(n){let i=n.agentFilesList?.agentId===n.agentId?n.agentFilesList:null,a=i?.files??[],o=n.agentFileActive??null,c=o?a.find(e=>e.name===o)??null:null,l=o?n.agentFileContents[o]??``:``,u=o?n.agentFileDrafts[o]??l:``,d=o?u!==l:!1;return e`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
      ...
      ${i?e`<div class="muted mono" style="margin-top: 8px;">Workspace: ${i.workspace}</div>`:t}
              ...
              <div class="agent-files-grid" style="margin-top: 16px;">
                <div class="agent-files-list">
                  ${a.length===0?e`
                        ...
                        `:a.map(e=>V(e,o,()=>n.onSelectFile(e.name)))}
                </div>
  ...
  `}function V(r,i,a){let o=r.missing?`Missing`:`${v(r.size)} · ${n(r.updatedAtMs??null)}`;return e`
    <button
      type="button"
  ...
  `}function U(n){let r=f(n.configForm,n.agentId),i=r.entry?.tools??{},s=r.globalTools??{},c=i.profile??s.profile??`full`,u=l(n.toolsCatalogResult),d=o(n.toolsCatalogResult),p=i.profile?`agent override`:s.profile?`global default`:`default`,m=Array.isArray(i.allow)&&i.allow.length>0,_=Array.isArray(s.allow)&&s.allow.length>0,v=!!n.configForm&&!n.configLoading&&!n.configSaving&&!m&&!(n.toolsCatalogLoading&&!n.toolsCatalogResult&&!n.toolsCatalogError),y=m?[]:Array.isArray(i.alsoAllow)?i.alsoAllow:[],b=m?[]:Array.isArray(i.deny)?i.deny:[],x=m?{allow:i.allow??[],deny:i.deny??[]}:w(c)??void 0,S=d.flatMap(e=>e.tools.map(e=>e.id)),C=e=>{let t=g(e,x),n=h(e,y),r=h(e,b);return{allowed:(t||n)&&!r,baseAllowed:t,denied:r}},T=S.filter(e=>C(e).allowed).length,E=(e,t)=>{let r=new Set(y.map(e=>a(e)).filter(e=>e.length>0)),i=new Set(b.map(e=>a(e)).filter(e=>e.length>0)),o=C(e).baseAllowed,s=a(e);t?(i.delete(s),o||r.add(s)):(r.delete(s),i.add(s)),n.onOverridesChange(n.agentId,[...r],[...i])},D=e=>{let t=new Set(y.map(e=>a(e)).filter(e=>e.length>0)),r=new Set(b.map(e=>a(e)).filter(e=>e.length>0));for(let n of S){let i=C(n).baseAllowed,o=a(n);e?(r.delete(o),i||t.add(o)):(t.delete(o),r.add(o))}n.onOverridesChange(n.agentId,[...t],[...r])};return e`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          ...
          <div class="card-sub">
            ...
            <span class="mono">${T}/${S.length}</span> enabled.
          </div>
        </div>
  ...
  `}function W(n){let r=!!n.configForm&&!n.configLoading&&!n.configSaving,i=f(n.configForm,n.agentId),a=Array.isArray(i.entry?.skills)?i.entry?.skills:void 0,o=new Set((a??[]).map(e=>e.trim()).filter(Boolean)),s=a!==void 0,c=!!(n.report&&n.activeAgentId===n.agentId),l=c?n.report?.skills??[]:[],u=n.filter.trim().toLowerCase(),d=u?l.filter(e=>[e.name,e.description,e.source].join(` `).toLowerCase().includes(u)):l,p=O(d),m=s?l.filter(e=>o.has(e.name)).length:l.length,h=l.length;return e`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
      ...
      ${d.length===0?e`
            ...
            `:e`
              <div class="agent-skills-groups" style="margin-top: 16px;">
                ${p.map(e=>G(e,{agentId:n.agentId,allowSet:o,usingAllowlist:s,editable:r,onToggle:n.onToggle}))}
              </div>
            `}
    </section>
  ...
  `}function q(n){let r=n.agentsList?.agents??[],i=n.agentsList?.defaultId??null,a=n.selectedAgentId??i??r[0]?.id??null,o=a?r.find(e=>e.id===a)??null:null,s=a&&n.agentSkills.agentId===a?n.agentSkills.report?.skills?.length??null:null,c=n.channels.snapshot?Object.keys(n.channels.snapshot.channelAccounts??{}).length:null,l=a?n.cron.jobs.filter(e=>e.agentId===a).length:null,d={files:n.agentFiles.list?.files?.length??null,skills:s,channels:c,cron:l||null};return e`
    <div class="agents-layout">
      ...
      <section class="agents-main">
        ${o?e`
                ${Y(n.activePanel,e=>n.onSelectPanel(e),d)}
                ...
                ${n.activePanel===`channels`?R({context:m(o,n.config.form,n.agentFiles.list,i,n.agentIdentityById[o.id]??null),configForm:n.config.form,snapshot:n.channels.snapshot,loading:n.channels.loading,error:n.channels.error,lastSuccess:n.channels.lastSuccess,onRefresh:n.onChannelsRefresh}):t}
                ${n.activePanel===`cron`?z({context:m(o,n.config.form,n.agentFiles.list,i,n.agentIdentityById[o.id]??null),agentId:o.id,jobs:n.cron.jobs,status:n.cron.status,loading:n.cron.loading,error:n.cron.error,onRefresh:n.onCronRefresh,onRunNow:n.onCronRunNow}):t}
              `:e`
                <div class="card">
...
//# sourceMappingURL=agents-Jg0XrQGr.js.map